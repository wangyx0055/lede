...
extern INT Set_P2pCli_Enable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pPeer  GASIntialReqAction = %d, \n", Elem->MsgLen));
	COPY_MAC_ADDR(Addr2, pFrame->Hdr.Addr2);
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("From Addr2 = %02x:%02x:%02x:%02x:%02x:%02x.\n", PRINT_MAC(Addr2)));
#ifdef WFD_SUPPORT
	os_alloc_mem(pAd, &ServiceDiscQuery, MAX_VIE_LEN);

	if (ServiceDiscQuery == NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s:: Allocate memory size(=1024) failed\n", __FUNCTION__));
		return;
	}
#endif /* WFD_SUPPORT */
	...
	if (p2pindex < MAX_P2P_GROUP_SIZE)
	{
			...
			for (iLen = ServiceDiscQueryLen - 3; iLen > 0; iLen--)
			{
				...
				{						
					case SUBID_WFD_DEVICE_INFO:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_device_info_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_DEVICE_INFO\n", __FUNCTION__));
						break;
					case SUBID_WFD_ASSOCIATED_BSSID:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_associate_bssid_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_ASSOCIATED_BSSID\n", __FUNCTION__));
						break;
					case SUBID_WFD_AUDIO_FORMATS:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_audio_format_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_AUDIO_FORMATS\n", __FUNCTION__));
						break;
					case SUBID_WFD_VIDEO_FORMATS:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_video_format_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_VIDEO_FORMATS\n", __FUNCTION__));
						break;
					case SUBID_WFD_3D_VIDEO_FORMATS:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_3d_video_format_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_3D_VIDEO_FORMATS\n", __FUNCTION__));
						break;
					case SUBID_WFD_CONTENT_PROTECTION:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_content_proctection = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_CONTENT_PROTECTION\n", __FUNCTION__));
						break;
					case SUBID_WFD_COUPLED_SINK_INFO:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_couple_sink_info_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_COUPLED_SINK_INFO\n", __FUNCTION__));
						break;
					case SUBID_WFD_EXTENDED_CAP:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_extent_capability_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_EXTENDED_CAP\n", __FUNCTION__));
						break;
					case SUBID_WFD_LOCAL_IP_ADDR:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_local_ip_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_LOCAL_IP_ADDR\n", __FUNCTION__));
						break;
					case SUBID_WFD_SESSION_INFO:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_session_info_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_SESSION_INFO\n", __FUNCTION__));
						break;
					case SUBID_WFD_ALTERNATE_MAC_ADDR:
						pP2pEntry->WfdEntryInfo.wfd_serv_disc_query_info.bWfd_alternate_mac_addr_ie = TRUE;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_ALTERNATE_MAC_ADDR\n", __FUNCTION__));
						break;
					default:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" SUBID_WFD_ unknown	Eid = %x \n", *pWfdEid));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" = %02x:%02x:%02x:%02x:%02x:%02x.\n",  PRINT_MAC(P2PActReq.Addr)));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	pFrame = (PFRAME_802_11)Elem->Msg;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pPeer  PeerGASIntialRspAction = %d.\n", Elem->MsgLen));
#ifdef WFD_SUPPORT
		os_alloc_mem(pAd, &ServiceDiscQuery, MAX_VIE_LEN);
	...
	if (p2pindex < MAX_P2P_GROUP_SIZE)
	{
		...
		if ((ServiceDiscQueryLen > 3))
		{
			...
			while (AttriLen <= (ServiceDiscQueryLen - 2))
			{
				...
				{
					case SUBID_WFD_DEVICE_INFO:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_DEVICE_INFO(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_ASSOCIATED_BSSID:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_ASSOCIATED_BSSID(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_AUDIO_FORMATS:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_AUDIO_FORMATS(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_VIDEO_FORMATS:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_VIDEO_FORMATS(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_3D_VIDEO_FORMATS:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_3D_VIDEO_FORMATS(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_CONTENT_PROTECTION:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_CONTENT_PROTECTION(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_COUPLED_SINK_INFO:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_COUPLED_SINK_INFO(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_EXTENDED_CAP:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_EXTENDED_CAP(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_LOCAL_IP_ADDR:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_LOCAL_IP_ADDR(%d)\n", __FUNCTION__, AttriLen));
						...
						break;
					case SUBID_WFD_SESSION_INFO:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_SESSION_INFO(%d)\n", __FUNCTION__, AttriLen));
						hex_dump("SUBID_WFD_SESSION_INFO", pWfdEid->Octet, AttriLen);
						break;
					case SUBID_WFD_ALTERNATE_MAC_ADDR:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::SUBID_WFD_ALTERNATE_MAC_ADDR(%d)\n", __FUNCTION__, AttriLen));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	pFrame = (PFRAME_802_11)Elem->Msg;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("p2p  PeerGASComebackReqAction = %d, \n", Elem->MsgLen));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("p2p  PeerGASComebackRspAction = %d, \n", Elem->MsgLen));
	if (p2pindex < MAX_P2P_GROUP_SIZE)
	{
		pP2pEntry = &pAd->P2pTable.Client[p2pindex];
	...
	OUT UINT	*ServiceDiscQueryLen)
{
	...
	do 
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("GASIntialReq = Not Public action. Return \n"));
			return FALSE;
		}
		if (*(pData+1) != ACTION_GAS_INITIAL_REQ)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("GASIntialReq = Not GAS Initial Req. Return \n"));
			return FALSE;
		}
		...
		*DialogToken = *(pData + 2);
		...
		if (*pData != 0x6c)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("GASIntialReq = wrong Advertisement protocol information element Return \n"));
			return FALSE;
		}
		pData += 4;
		pData += 2;
		if (*pData != 0xdd)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("GASIntialReq = wrong   Return \n"));
			return FALSE;
		}
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("GASIntialReq = wrong OUI Return \n"));
			return FALSE;
		}
#ifdef WFD_SUPPORT
		pData += 10;
		for (i = 0; i < WFD_DEVICE_TYPE_END; i++)
		{
			if (RemainQueryLen > 0)
			{
				*ServiceDiscQueryLen = cpu2le16(*((PUSHORT)pData));
				if (*ServiceDiscQueryLen > 3)
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query Service Discovery Len = %d. QueryType = %d.\n", *ServiceDiscQueryLen, *(pData + 2)));
					*ServiceTransaction = *(pData + 3);
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("ServiceTransac is %d. \n", *ServiceTransaction));
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Requested Device Role is 0x%02x. \n", *(pData + 4)));
					if (pAd->StaCfg.WfdCfg.DeviceType == *(pData + 4))
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("My Device Type is 0x%02x. \n", *(pData + 4)));
						if ((*ServiceDiscQueryLen - 3))
	...
	OUT UINT	*ServiceDiscQueryLen)
{
	...
	do 
	{
		if (*pData != CATEGORY_PUBLIC)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("P2PParseServiceDiscoRsp = Not Public action. Return \n"));
			return FALSE;
		}
		if (*(pData+1) != ACTION_GAS_INITIAL_RSP)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("P2PParseServiceDiscoRsp = Not GAS Initial RSP. Return \n"));
			return FALSE;
		}
		
		if (*(PUSHORT)(pData+3) != 0)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("P2PParseServiceDiscoRsp = Status is 0x%x.  Return \n", *(PUSHORT)(pData+3)));
			return FALSE;
		}
		...
		if (*pData != 0x6c)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseServiceDiscoRsp = wrong Advertisement protocol information element Return \n"));
			return FALSE;
		}
		pData += 4;
		pData += 2;
		if (*pData != 0xdd)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseServiceDiscoRsp = wrong   Return \n"));
			return FALSE;
		}
		if (!RTMPEqualMemory((pData + 4), P2POUIBYTE, 4))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseServiceDiscoRsp = wrong OUI Return \n"));
			return FALSE;
		}

		*ServiceDiscQueryLen = cpu2le16(*((PUSHORT)(pData + 10)));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Query Service Discovery Len = %d. QueryType = %d.\n", *ServiceDiscQueryLen, *(pData + 12)));
		*ServiceTransaction = *(pData+13);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("ServiceTransac = %d. \n", *ServiceTransaction));
		if ((*ServiceDiscQueryLen - 3))
	...
	OUT UCHAR		*DialogToken) 
{
	...
	do 
	{
		if (*pData != CATEGORY_PUBLIC)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackReq = Not Public action. Return \n"));
			return FALSE;
		}
		if (*(pData+1) != ACTION_GAS_COMEBACK_REQ)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackReq = Not GAS_COMEBACK_REQ Return \n"));
			return FALSE;
		}
	...
	IN UCHAR		*ServiceTransaction) 
{
	...
	do 
	{
		if (*pData != CATEGORY_PUBLIC)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackRsp = Not Public action. Return \n"));
			return FALSE;
		}
		if (*(pData+1) != ACTION_GAS_COMEBACK_RSP)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackRsp = Not GAS_COMEBACK_REQ Return \n"));
			return FALSE;
		}
		// +2 : Token
		// +3, +4 : Status
		// +5 : More Frag
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackRsp = More Frag = %d. \n", *(pData+5)));
		if ((*(pData+5) &0x80) == 0x80 )
		{
			pP2pEntry->P2pClientState = P2PSTATE_SERVICE_COMEBACK_COMMAND;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("P2PParseComebackRsp = More Frag set to one. \n"));
...
VOID P2PPublicAction(
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("!!!!! Should not in here !!!!!\n"));
}
	...
	*(pDest + 2) = 0; 		/* Set length to 0 first.  Need to update to real length in the end of this function. */
	...
	for (i = 0;i < MAX_P2P_GROUP_SIZE;i++)
	{
		...
		if (pClient->P2pClientState == P2PSTATE_CLIENT_WPS_DONE)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("  -- InsertP2PGroupInfoTlv( ) (Mac  %02x:%02x:%02x:%02x:%02x:%02x.\n", PRINT_MAC(pClient->addr)));
			...
			*((PUSHORT) (pContent + 2)) = cpu2be16(pClient->DeviceNameLen);	
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (" ----- InsertP2PGroupInfoTlv(%d) (Total Len now = %d) DevNameLen = %ld.\n", i, Length, pClient->DeviceNameLen));
		}
	}
	...
	IN PUCHAR		pOutBuffer)
{
		...
		UCHAR WiDiWpsSecondary[] = {0x00, 0x07, 0x00, 0x17, 0x35, 0x20, 0x00, 0x02};
		...
		*pDest = SubId;
		...
		switch(SubId)
		{
...
#else
				if (P2P_GO_ON(pAd))
					RTMPMoveMemory(pDest + 10, AP_Wsc_Pri_Dev_Type, 8);
				else
					RTMPMoveMemory(pDest + 10, STA_Wsc_Pri_Dev_Type, 8);
#endif
			...
			case SUBID_P2P_GROUP_ID:	/* 15 */
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" -----Insert SUBID_P2P_GROUP_ID (Len = %ld) \n", Length));
				break;
	...
	OUT PUCHAR 	pDest)
{
	...
	*ChannelListLen = pos;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s:: Channel List ==> output length is %ld \n", __FUNCTION__, *ChannelListLen));
	for (i = 0; i <*ChannelListLen; )
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (": %x %x %x %x %x %x %x %x %x \n", *(pDest+i), *(pDest+i+1), *(pDest+i+2), 
			...
			while ((Length + 3 + AttriLen) <= pEid->Len)    
			{
				switch(pP2pEid->Eid)
				{
					case SUBID_P2P_GROUP_INFO:
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SUBID_P2P_GROUP_INFO - Go index=%d\n",  P2pindex));
						...
						{	
							...
							{
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Error parsing P2P IE group info attribute. This Client -%d/%ld\n", ThisDescLen, GroupInfoLen));
								break;
							}
								...
								&& (pAd->P2pTable.Client[idx].P2pClientState != P2PSTATE_CLIENT_DISCO_COMMAND))
							{
								...
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("!P2P topology changed[P2pClientState = %d] when parsing P2P IE group info attribute. Delete from index : %d\n", pAd->P2pTable.Client[idx].P2pClientState, SmallerP2Pidx ));
								...
								for (i = (SmallerP2Pidx); i < MAX_P2P_GROUP_SIZE;i++)
							{
									...
									{
										MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("!break right away because we have another connect command to continue. update topology is not so important to do right now.\n" ));
										break;
									}
									else
									{
								...
								&& (!RTMPEqualMemory(pClient->DevAddr, pAd->P2pCfg.CurrentAddress, MAC_ADDR_LEN)))
							{
								...
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Insert a P2P Client to P2P table [%d]  .\n", idx));
	...
	IN UINT32 Sequence)
{
					...
					case SUBID_P2P_NOA:
						{
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("Get NoA Attr: %x %x %x %x %x %x %x %x %x \n", *(pData+0), *(pData+1), *(pData+2), 
	...
	if (bNoAAttriExist == FALSE)
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Beacon and no NoA Attribute! \n"));
			P2pStopOpPS(pAd);
		}
		if ((pAd->MacTab.Content[wcidindex].P2pInfo.NoADesc[0].bValid == TRUE))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Beacon and no NoA Attribute!Stop active NoA [%d]\n", Sequence));
				...
				switch(pP2pEid->Eid)
				{
					case SUBID_P2P_EXT_LISTEN_TIMING:
						if (AttriLen == 4)
						{
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("  - (Ext Listen Period %x = %d)  \n", ExtTime, ExtTime));
							if (ExtTime > 0)
								pP2PCtrl->ExtListenPeriod = ExtTime;
							ExtTime = *(PUSHORT)&pP2pEid->Octet[2];
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("  - (Ext Listen Interval  %x = %d)  \n", ExtTime, ExtTime));
							if (ExtTime > 0)
	...
	OUT UCHAR *pMinorReason)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pParseManageSubElmt  MsgLen = %ld.  \n", MsgLen));
	...
	while ((ULONG)(pEid->Len + 2) <= LeftLength)
	{
		if (pEid->Eid == IE_CHANNEL_USAGE)
		{
			*pChannel = pEid->Octet[2];
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IE_CHANNEL_USAGE  = %x %x %x %x [ch=]%x.  \n", pEid->Eid, pEid->Len, pEid->Octet[0], pEid->Octet[1], pEid->Octet[2]));
		}
		/* might contains P2P IE and WPS IE.  So use if else if enough for locate  P2P IE. */
		if (RTMPEqualMemory(&pEid->Octet[0], WIFIDIRECT_OUI, 4))
		{
			...
			while ((Length + 3 + AttriLen) <= pEid->Len)    
			{
				switch(pP2pEid->Eid)
				{
					case SUBID_P2P_MINOR_REASON:
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("SYNC -  Has P2P SUBID_P2P_MINOR_REASON IE Minor Reason = %d.\n", pP2pEid->Octet[0]));
						if (pTotalNumOfP2pAttribute != NULL)
					...
					case SUBID_P2P_MANAGEABILITY:
						...
						{
							*pTotalNumOfP2pAttribute = *pTotalNumOfP2pAttribute+1;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("SYNC -Ap Has P2P Manageability IE . Total P2P IE count is %d \n", *pTotalNumOfP2pAttribute));
						}
					...
					{						
						...
						case SUBID_P2P_GROUP_ID:
							if ((pSsid != NULL) && (pP2pEid->Len[0]) > 6 && (pP2pEid->Len[0] <= 38))
							{
								...
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (" SUBID_P2P_GROUP_ID - SSID ( Len %d)= %c %c %c %c %c %c %c %c %c.. \n",  *pSsidLen, pSsid[0], pSsid[1],pSsid[2],pSsid[3],pSsid[4],pSsid[5],pSsid[6],pSsid[7],pSsid[8]));
							}
							}
							break;
							...
							if ((WscType == WSC_ID_DEVICE_NAME) && (WscLen <= 32))
							{
								if ((pDeviceName != NULL))
								{
									*pDeviceNameLen = (UCHAR)WscLen;
									...
									MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SUBID_P2P_DEVICE_INFO Device Name= %c %c %c %c %c %c \n",  pDeviceName[0], pDeviceName[1],pDeviceName[2],pDeviceName[3],pDeviceName[4],pDeviceName[5]));
								}
							}
						...
						case SUBID_P2P_STATUS:
							if (pStatusCode != NULL)
							{
								*pStatusCode = pP2pEid->Octet[0];
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (" SUBID_P2P_STATUS    Eid = %x \n", *pStatusCode));
							}
						...
						default:
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" SUBID_P2P_ unknown  Eid = %x \n", pP2pEid->Eid));
							break;
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Recieve Confirm Confirm Confirm. -> From %02x:%02x:%02x:%02x:%02x:%02x.\n", PRINT_MAC(pFrame->p80211Header.Addr2)));
	...
	P2pParseSubElmt(pAd, &pFrame->ElementID, (Elem->MsgLen + 7 - sizeof(P2P_PUBLIC_FRAME)), 
		...
		&SsidLen, (PUCHAR)&Ssid, &ConfigMethod, NULL, DevType, &Channel, &OpChannel, ChannelList, &Intent, &StatusCode, NULL,
#ifdef WFD_SUPPORT
		NULL, NULL,
#endif /* WFD_SUPPORT */
		NULL);
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" DevAddr = %02x:%02x:%02x:%02x:%02x:%02x.  \n",  PRINT_MAC(DevAddr)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" OpChannel = %d.   \n",  OpChannel));
	
	/* Check StatusCode. */
	if (StatusCode != 0)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Ignore Go Negociation Confirm Status Code not Success. \n"));
#ifdef RT_P2P_SPECIFIC_WIRELESS_EVENT
#ifdef HE_SUPPORT
		...
		if (index < MAX_P2P_GROUP_SIZE)
		{
			...
			pP2pEntry->StatusCode = StatusCode;
			P2pSendWirelessEvent(pAd, RT_P2P_GO_NEGO_FAIL_RECV_CONFIRM, pP2pEntry, DevAddr);
		}
#endif /* HE_SUPPORT */
#endif /* RT_P2P_SPECIFIC_WIRELESS_EVENT */
#ifdef DPA_S
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Recieve Confirm Confirm Confirm Success. \n"));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Ignore Go Negociation Confirm from Unknown device. \n"));
	...
	else 
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Existing peer stay in another state. = %d. return.\n", pAd->P2pTable.Client[index].P2pClientState));
			return;
		}
	}
	...
	if (index < MAX_P2P_GROUP_SIZE)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" pP2pEntry[%d]->rule = %s. GoIntent = %d. My intent is %d. \n",  index, decodeMyRule(pP2pEntry->Rule), pP2pEntry->GoIntent, pP2PCtrl->GoIntentIdx));
		/*MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("---->P2P pP2PCtrl->SsidLength = %d. [%x %x %x..]\n", pP2PCtrl->SSIDLen, 
		...
		{	
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I become ENROLLEE!GOGO Go's SsidLen = %d.!!\n", pP2pEntry->SsidLen));
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I become ENROLLEE!GOGO Go's Ssid[%d] = ", pP2pEntry->SsidLen));	
			for (i=0; i<pP2pEntry->SsidLen; i++)
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%c ", pP2pEntry->Ssid[i]));
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("\n"));
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I become ENROLLEE!!GOGO Go's Bssid = %02x:%02x:%02x:%02x:%02x:%02x!!\n", PRINT_MAC(pP2PCtrl->Bssid)));
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I become ENROLLEE!!GOGO Go's SSID[%d] = %s!!\n", pP2PCtrl->SSIDLen, pP2PCtrl->SSID));
#ifdef WIDI_SUPPORT
			/*
				Send Notification to user space that GO Negotiation is done
			*/
			WidiUpdateStateToDaemon(pAd, MIN_NET_DEVICE_FOR_P2P_CLI, WIDI_MSG_TYPE_ASSOC_STATUS, pP2PCtrl->Bssid, pP2pEntry->Ssid, pP2pEntry->SsidLen, WIDI_P2P_GO_CONFIRM_RECEIVED);
#endif /* WIDI_SUPPORT */
		...
		else
		{
			...
			P2pGoNegoDone(pAd,  pP2pEntry);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I become Internal REGISTRA!!    REGISTRA. !! GOGOGO\n"));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	UCHAR       AllZero[MAC_ADDR_LEN] = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0};
	UCHAR		ChannelList[MAX_NUM_OF_CHANNELS];
	INT iPeerChannelIndex,i;
	PCHANNELINFO pChannelInfo = pAd->pChannelInfo;
	INT ibest_ch = -1;
	UINT32 min_dirty = 0xffffffff;
	UCHAR NoSocialChs = TRUE;

	RTMPZeroMemory(ChannelList, MAX_NUM_OF_CHANNELS);
	
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -  GOGOGO Recieve Response.Response MsgLen = %ld.\n", Elem->MsgLen));
	...
	P2pParseSubElmt(pAd, &pFrame->ElementID, (Elem->MsgLen - LENGTH_802_11 - 8),  
		...
		&Channel, &OpChannel, ChannelList, &TempIntent, &StatusCode, NULL,
#ifdef WFD_SUPPORT
		NULL, NULL,
#endif /* WFD_SUPPORT */
		NULL);
	...
	Intent = TempIntent >>1;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" Dev Addr = %02x:%02x:%02x:%02x:%02x:%02x. Intent = %d. My Intent = %d. \n",  PRINT_MAC(DevAddr), Intent, pP2PCtrl->GoIntentIdx));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" interface addr = %02x:%02x:%02x:%02x:%02x:%02x  \n",  PRINT_MAC(IfAddr)));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P -StatusCode = %d. PeerIntent = %d . OpChannel = %d. My Intent = %d.\n", StatusCode, Intent, OpChannel, pP2PCtrl->GoIntentIdx));
	
	/* Check StatusCode. */
	if (StatusCode == P2PSTATUS_BOTH_INTENT15)
	{
		pP2PCtrl->P2pCounter.DisableRetryGrpFormCounter = 1200;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - Receive Status Code that both Go Intent Value is 15.  = %x \n", StatusCode));
#ifdef RT_P2P_SPECIFIC_WIRELESS_EVENT
#ifdef HE_SUPPORT
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -Go Negociation Response Status Code PASSED or being rejected  = %d \n", StatusCode));
		index = P2pGroupTabSearch(pAd, DevAddr);
		if (index < MAX_P2P_GROUP_SIZE)
		{
...
#else
			/* For GO Nego State Machime command ID use. */
			pAd->P2pTable.Client[index].P2pClientState = P2PSTATE_CONNECT_COMMAND;
			/* Re-send GO Nego Req 5sec later. */
			pAd->P2pTable.Client[index].StateCount = 100;
			pAd->P2pTable.Client[index].bValid= TRUE;
			/* Update P2PConnectState. */
			if ((pAd->P2pCfg.P2PConnectState == P2P_ANY_IN_FORMATION_AS_CLIENT)||(pAd->P2pCfg.P2PConnectState == P2P_ANY_IN_FORMATION_AS_GO))
				pAd->P2pCfg.P2PConnectState = P2P_CONNECT_IDLE;
#endif
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P -  = %s \n", decodeP2PState(pAd->P2pCfg.P2PConnectState)));
		}
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Ignore Go Negociation Response Status Code not Success.  = %d \n", StatusCode));
#ifdef RT_P2P_SPECIFIC_WIRELESS_EVENT
#ifdef HE_SUPPORT
		index = P2pGroupTabSearch(pAd, DevAddr);
		if (index < MAX_P2P_GROUP_SIZE)
		{
			...
			pP2pEntry->StatusCode = StatusCode;
			P2pSendWirelessEvent(pAd, RT_P2P_GO_NEGO_FAIL_RECV_RESP, pP2pEntry, DevAddr);
		}
#endif /* HE_SUPPORT */
#endif /* RT_P2P_SPECIFIC_WIRELESS_EVENT */
#ifdef DPA_S
	...
	if (index == P2P_NOT_FOUND)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Ignore Go Negociation Response from Unknown device. \n"));
		return;
	}
	else 
	{
	...
	if (index < MAX_P2P_GROUP_SIZE)
	{
		...
		pP2pEntry->bSupport5G = FALSE;
		pP2pEntry->bSCCChannel=FALSE;
		pP2pEntry->bGoUsePeerChannel = FALSE;

                // reset min dirty value
                min_dirty = 0xffffffff;

		// check if peer do not support social channels
		NoSocialChs = TRUE;
		for (iPeerChannelIndex = 0;iPeerChannelIndex < MAX_NUM_OF_CHANNELS;iPeerChannelIndex++)
		{
			if (ChannelList[iPeerChannelIndex] == 0)
			{
			 	break;
			}
					 
			if ((ChannelList[iPeerChannelIndex] == 1) || \
				(ChannelList[iPeerChannelIndex] == 6) || \
				(ChannelList[iPeerChannelIndex] == 11))
			{
				NoSocialChs = FALSE;
				break;
			}
		...
		for (iPeerChannelIndex = 0;iPeerChannelIndex < MAX_NUM_OF_CHANNELS;iPeerChannelIndex++)
		{
			...
			if (ChannelList[iPeerChannelIndex] > 14 )
				pP2pEntry->bSupport5G = TRUE;
                     
			if ((INFRA_ON(pAd)) &&(pAd->CommonCfg.Channel == ChannelList[iPeerChannelIndex]) )
			{
				pP2pEntry->bSCCChannel=TRUE;
				break;
			}

			if((pP2PCtrl->bAutoChannel == TRUE) &&
				( !(INFRA_ON(pAd) || P2P_GO_ON(pAd) || P2P_CLI_ON(pAd))))
			{
	      
			    for (i=0;i<pAd->ChannelListNum;i++)
			    {
                                // limited to social channels only for better interoperbility
                                if (!((pAd->ChannelList[i].Channel == 1) || \
                                      (pAd->ChannelList[i].Channel == 6) || \
                                      (pAd->ChannelList[i].Channel == 11)) &&  \
                                      (pP2PCtrl->bAutoChOnSocial == TRUE) && \
                                      (NoSocialChs == FALSE) && \
                                      (pP2pEntry->bSupport5G == FALSE))
                                        continue;

                                // search for matching channels
				if ( ( pAd->ChannelList[i].Channel == ChannelList[iPeerChannelIndex]))
				{                 
                                    // find a best channel from matching channels
					if ((min_dirty > pChannelInfo->dirtyness[i]))
					{
						min_dirty = pChannelInfo->dirtyness[i];
						pP2PCtrl->GroupChannel  = pAd->ChannelList[i].Channel;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s min_dirty = %d, PeerChannelListNum = %d\n", \
		                            			__FUNCTION__, pChannelInfo->dirtyness[i], pAd->ChannelList[i].Channel));
					}
				}
			    }
			}
			/*
			When receive GO-NEGO-REQ or GO-NEGO-RESP frame:
			If not GO on and
			(use peer channel policy is 1 and no connection to AP or
			use peer channel policy is 2) and
			(peer channel list number is 1 and
			peer channel is in my channel list,
			or channle is 5G	)
			use peer channel.
			*/
			else if (!(P2P_GO_ON(pAd)) &&
				(((pP2PCtrl->CheckPeerChannelPolicy == CHECK_PEER_CHANNEL_IF_NO_CONNECTION) && !(INFRA_ON(pAd))) || 
				(pP2PCtrl->CheckPeerChannelPolicy == CHECK_PEER_CHANNEL_EVEN_IF_CONNECTION)) &&
				(((iPeerChannelIndex == 0) && (ChannelList[1] == 0)) || (pP2pEntry->bSupport5G == TRUE)))
			{
				for (i=0;i<pAd->ChannelListNum;i++)
				{
					if ( ( pAd->ChannelList[i].Channel == ChannelList[iPeerChannelIndex]))				   
					{
						pP2PCtrl->GroupChannel = ChannelList[iPeerChannelIndex];
						pP2pEntry->bGoUsePeerChannel = TRUE;
						break;
					}
				}
			}
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s GroupChannel = %d \n", __FUNCTION__, pP2PCtrl->GroupChannel));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CheckPeerChannelPolicy = %d. bGoUsePeerChannel = %d. INFRA_ON = %d. P2P_GO_ON = %d. P2P_CLI_ON = %d. PeerChannelListNum = %d. PeerChannelIs5GBand = %d\n", 
			pP2PCtrl->CheckPeerChannelPolicy, pP2pEntry->bGoUsePeerChannel, INFRA_ON(pAd), P2P_GO_ON(pAd), P2P_CLI_ON(pAd), iPeerChannelIndex, pP2pEntry->bSupport5G));
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P provisioned -dpid= %x. ConfigMethod = %s.\n", Dpid, decodeConfigMethod(pP2pEntry->ConfigMethod)));
			switch(pP2pEntry->ConfigMethod)
			{
				case WSC_CONFMET_DISPLAY:
					if ((Dpid != DEV_PASS_ID_REG) && (Dpid != DEV_PASS_ID_PIN))
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -1 Ignore Go Negociation Response with wrong dpid \n"));
						return;
					}
					break;
				case WSC_CONFMET_KEYPAD:
					...
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -3 Ignore Go Negociation Response with wrong dpid \n"));
						return;
					}
					break;
				default:
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -  Existing peer stay in another state. = %d. \n", pAd->P2pTable.Client[index].P2pClientState));
			return;
		}
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
		...
		*/
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("GOGOGOGO P2P - receive Go Neg Request. MsgLen = %ld \n", Elem->MsgLen));
#ifdef WFD_SUPPORT
		os_alloc_mem(pAd, &WfdSubelement, MAX_VIE_LEN);
		if (WfdSubelement == NULL)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s::Allocate memory size(=%d) failed\n", __FUNCTION__, MAX_VIE_LEN));
			return;
		}
#endif /* WFD_SUPPORT */
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s: ConnState - %s.\n", __FUNCTION__, decodeP2PState(pP2PCtrl->P2PConnectState)));
		...
		Intent = TempIntent >>1;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("    DevAddr in P2P IE = %02x %02x %02x %02x %02x %02x  \n",  PRINT_MAC(DevAddr)));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("    Addr2 = %02x %02x %02x %02x %02x %02x  \n",  PRINT_MAC(pFrame->p80211Header.Addr2)));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("    its bssid = %02x %02x %02x %02x %02x %02x  \n",  PRINT_MAC(BssidAddr)));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("    Dpid = %x ,%s \n", Dpid, decodeDpid(Dpid)));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P -Peer[%d] Intent = %x . OpChannel = %x. My Intent = %x. TempIntent = %x\n", index, Intent, Channel, pP2PCtrl->GoIntentIdx, TempIntent));
		if (index == P2P_NOT_FOUND)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P -1  insert\n"));
			...
			if (index < MAX_P2P_GROUP_SIZE)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("From a unknown peer. Pop up setting windows. %d\n", pP2PCtrl->PopUpIndex));
		...
		if (index < MAX_P2P_GROUP_SIZE)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s GroupChannel = %d \n", __FUNCTION__, pP2PCtrl->GroupChannel));
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("bConfirmByUI = %d, CheckPeerChannelPolicy = %d. bGoUsePeerChannel = %d. INFRA_ON = %d. P2P_GO_ON = %d. P2P_CLI_ON = %d. PeerChannelListNum = %d. PeerChannelIs5GBand = %d\n", 
				pP2PCtrl->bConfirmByUI, pP2PCtrl->CheckPeerChannelPolicy, pP2pEntry->bGoUsePeerChannel, INFRA_ON(pAd), P2P_GO_ON(pAd), P2P_CLI_ON(pAd), iPeerChannelIndex, pP2pEntry->bSupport5G));
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("My P2P Dpid = %x.    State = %s. \n", pP2PCtrl->Dpid, decodeP2PClientState(pP2pEntry->P2pClientState)));
			if (IS_P2P_PEER_CLIENT_OP(pP2pEntry) || IS_P2P_PEER_WPAPSK(pP2pEntry) || IS_P2P_PEER_PROVISIONING(pP2pEntry))
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - Existing peer  state is %d. %s,.	Delete it.\n", pP2pEntry->P2pClientState, decodeP2PClientState(pP2pEntry->P2pClientState)));
	
				goto CleanUp;
			}
			if (pP2pEntry->P2pClientState > P2PSTATE_GO_DONE)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - Existing peer  state is %d . %s,. return.\n", pP2pEntry->P2pClientState, decodeP2PClientState(pP2pEntry->P2pClientState)));
				goto CleanUp;
			}
			else if (pP2pEntry->P2pClientState == P2PSTATE_SENT_GO_NEG_REQ)
			{
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - Dual GO Req. Existing peer  state is %s. \n", decodeP2PClientState(pP2pEntry->P2pClientState)));
					goto CleanUp;
				}
			}
			if (P2P_GO_ON(pAd))
		...
		if ((Intent == pP2PCtrl->GoIntentIdx) && (Intent == 15))
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2pReceGoNegoReqAction -Receive a peer that has the same Go Intent index as mine. \n"));
#ifdef RT_P2P_SPECIFIC_WIRELESS_EVENT
#ifdef HE_SUPPORT
			P2pSendWirelessEvent(pAd, RT_P2P_GO_NEGO_FAIL_INTENT, NULL, DevAddr);
#endif /* HE_SUPPORT */
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" MlmeAllocateMemory	fail -  . \n"));
			goto CleanUp;
		}
		...
		if (P2P_TEST_FLAG(pP2pEntry, P2PFLAG_PROVISIONED))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P -	Go Negociation Responce to provisioned	\n"));
		...
		else
		{
			...
			else if  (Dpid == DEV_PASS_ID_REG)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Peer Go Nego Req DPID = %x\n", Dpid));
		}
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - ReceDpid = %x. SentDpid %x \n", (Dpid), (SentDpid)));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - ReceDpid = %s. SentDpid %s \n", decodeDpid(Dpid), decodeDpid(SentDpid)));
		P2PMakeGoNegoRsp(pAd, DevAddr, SentDpid, pFrame->Token, TempIntent, OpChannel, RspStatus, pOutBuffer, pP2pEntry, &TempLen);
		FrameLen = TempLen;
		pDest += TempLen;
		/* : copy req to rsp first. */
	
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - Make Go Negociation Responce Length = %ld.RspStatus = %d \n", FrameLen, RspStatus));
		...
		if (RspStatus == P2PSTATUS_SUCCESS)
		{
			WidiUpdateStateToDaemon(pAd, MIN_NET_DEVICE_FOR_P2P_CLI, WIDI_MSG_TYPE_ASSOC_STATUS, DevAddr, NULL, 0, WIDI_P2P_GO_REQ_RECIVED);
		}
#endif /* WIDI_SUPPORT */
...
#ifdef RELEASE_EXCLUDE
			/* Carter's comment */
			/* for Android 4.0, there is no Display PIN UI, 
			   so I make Display case will goahead further operation */

			/* but in case of different project requirement, 
			   They can decide which kind of case will be blocked.
			   for instance, Samsung make all case need to handled by UI. */

			/* If GO-Neg-Rsp status == 1 (PASSED), we will set GoFormCurrentState back to IDLE */

			/* Summarize above conditions, we move the ConfigMethod checking to P2pSendPassedAction() */
#endif
			//if (pP2PCtrl->ConfigMethod == WSC_CONFMET_DISPLAY)
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2pReceDevDisReqAction = %ld\n", Elem->MsgLen));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - ask for p2p client[%d] = %02x:%02x:%02x:%02x:%02x:%02x.\n", p2pClientIndex, PRINT_MAC(devAddr)));

	if (((pMacEntry != NULL) && (pEntry != NULL)
#ifdef RELEASE_EXCLUDE
		/*
			Report from Windows.
			In WiFi-Lab Atheros CLIENT won't transmit Dis-Assoc or De-Auth to GO and just leaving.
		*/
/*		|| ((pP2PCtrl->bSigmaEnabled == TRUE) && (DevDiscCnt == 0))*/
#endif /* RELEASE_EXCLUDE */
		&& (pEntry->P2pClientState == P2PSTATE_CLIENT_WPS_DONE)))
	{
		...
		NdisZeroMemory(&P2PActReq, sizeof(P2PActReq));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("to interface Addr = %02x:%02x:%02x:%02x:%02x:%02x.\n",  
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s:: P2P -can't find p2p client .Status fail\n", __FUNCTION__));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("GOGO  P2P - P2pReceDevDisRspAction MsgLen = %ld ", Elem->MsgLen));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceDevDisRspAction %s.\n ", decodeP2PClientState(pP2pEntry->P2pClientState)));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2pReceInviteReqAction ==> %s \n", decodeP2PState(pP2PCtrl->P2PConnectState)));
#endif /* RELEASE_EXCLUDE */
	RTMPZeroMemory(ChannelList, MAX_NUM_OF_CHANNELS);
	RTMPZeroMemory(Ssid, MAX_LEN_OF_SSID);
	/* Get Request content capability */
	P2pParseSubElmt(pAd, &pFrame->ElementID, (Elem->MsgLen - LENGTH_802_11 - 8), 
		FALSE, NULL, &GroupCap, &DeviceCap, DeviceName, &DeviceNameLen, DevAddr, InfAddr, 
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceInviteReqAction ==>InviteFlag = %d.  %s \n", 
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("OpChannel = %d.    \n",  OpChannel));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("BssidAddr = %02x:%02x:%02x:%02x:%02x:%02x  \n",  PRINT_MAC(BssidAddr)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("DevAddr = %02x:%02x:%02x:%02x:%02x:%02x  \n",  PRINT_MAC(DevAddr)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Ssid[%d] = %s.  \n",  SsidLen, Ssid));
	p2pindex = P2pGroupTabSearch(pAd, DevAddr);
	{
		p2pindex = P2pGroupTabInsert(pAd, DevAddr, P2PSTATE_DISCOVERY_CLIENT, Ssid, SsidLen, DeviceCap, GroupCap);
	}
	index = P2pPerstTabSearch(pAd, DevAddr, BssidAddr, InfAddr);
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("perst index = %d. p2pindex = %d. \n", index, p2pindex));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("My Dpid = %d.    Dpid = %s.\n", pP2PCtrl->Dpid, decodeDpid(pP2PCtrl->Dpid)));
	...
	else
	{
		...
		{
			/*Note: In order to enhance the compatibility. We do not update the session_avail bit
				carried in invite req, we backup its original value, and then set it back.
			*/
			UCHAR session_avail_backup=pP2pEntry->WfdEntryInfo.session_avail;
			WfdParseSubElmt(pAd, 
							&pP2pEntry->WfdEntryInfo,
        ...
        if (P2P_GO_ON(pAd))
	{
		if(!pP2PCtrl->bP2pGoAcceptInvitationReq)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: Reject invitation request while being P2P GO\n"));
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceInviteReqAction ==>P2PGetEntryCnt = %d\n", P2PEntryCnt));
	...
	if (bReinvoke == TRUE)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: reinvoke.  \n"));
		...
		if (RspStatus == P2PSTATUS_SUCCESS)
		{
			...
			if (pAd->P2pTable.PerstEntry[index].MyRule == P2P_IS_GO)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: Decide to use OpChannel = %d for group \n", OpChannel));
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: reach my limit. Send back RspStatus = %d.  \n", RspStatus));
			...
			else
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: Reinvoke as client for group \n"));
	...
	else if ((InviteFlag & P2P_INVITE_FLAG_REINVOKE) == P2P_INVITE_FLAG_REINVOKE)
	{
		...
		*/
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite:  Can't find Credential.    \n"));
	}
	...
	else
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite Req carry allzero Bssid, \n"));
		}
		else if (IS_P2P_CONNECT_IDLE(pAd) || (pAd->P2pCfg.P2PConnectState == P2P_INVITE))
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Invite: Got invitation from P2P Client . RspStatus = %d \n", RspStatus));
			if (RspStatus == P2PSTATUS_SUCCESS)
			{
...
#endif /* RT_P2P_SPECIFIC_WIRELESS_EVENT */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2p Send Invite Rsp RspStatus = %d.  \n", RspStatus));
#ifdef WIDI_SUPPORT
...
#ifdef WIDI_SUPPORT
			WidiUpdateStateToDaemon(pAd, MIN_NET_DEVICE_FOR_P2P_CLI, WIDI_MSG_TYPE_ASSOC_STATUS,
								pFrame->p80211Header.Addr2, Ssid, SsidLen, WIDI_P2P_INVITE_RSP_SENT);
#endif /* WIDI_SUPPORT */
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pReceInviteRspAction ==> \n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("TA = %02x:%02x:%02x:%02x:%02x:%02x  \n",  
				PRINT_MAC(pFrame->p80211Header.Addr2)));
	...
	if ((StatusCode == P2PSTATUS_SUCCESS) || (StatusCode == P2PSTATUS_PASSED))
	{
			...
			&& (IS_PERSISTENT_ON(pAd)))
		{
			...
			if (pAd->P2pTable.PerstEntry[index].MyRule == P2P_IS_GO)
			{
				...
				pP2PCtrl->GroupOpChannel = OpChannel;
				P2pCopyPerstParmToCfg(pAd, index);
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Decide to use OpChannel = %d for group \n", OpChannel));
			...
			else
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Reinvoke as client for group. OpChannel= %d\n", OpChannel));
				pP2PCtrl->P2PConnectState = P2P_DO_WPS_ENROLLEE;
		...
		else
		{
			...
			if (index < MAX_P2P_GROUP_SIZE)
			{
				if (P2P_GO_ON(pAd))
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceInviteRspAction Success.  I am GO. \n"));
				}
				else if (P2P_CLI_ON(pAd))
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceInviteRspAction Success.  I am client. \n"));
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pRece Provision ReqAction ==> \n"));
#ifdef WFD_SUPPORT
		os_alloc_mem(pAd, &WfdSubelement, MAX_VIE_LEN);
		if (WfdSubelement == NULL)
		{
...
if (P2P_GO_ON(pAd))
	{
		...
		if ( (pP2PCtrl->p2pMaxEntry!= 0 ) && (P2PEntryCnt >= pP2PCtrl->p2pMaxEntry) )
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pRece Provision ReqAction ==>P2PGetEntryCnt = %d\n", P2PEntryCnt));
			P2PSendProvisionRsp(pAd, 0, pFrame->Token, pFrame->p80211Header.Addr2, &FrameLen);
			goto CleanUp;
		}
	}
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pRece Provision ReqAction ==>ConfigMethod = %x %s\n", WpsConfigMethod, decodeConfigMethod(WpsConfigMethod)));
	...
	*/
	...
	else
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pRece Provision ReqAction ==> Ignore this provision request here\n"));
			return;
		}
	}
		...
		|| (WpsConfigMethod == 0x188))
	{
		...
		if (p2pindex < MAX_P2P_GROUP_SIZE)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Update My Config Method to  %s (%d)\n", decodeConfigMethod(pP2PCtrl->ConfigMethod ), pP2PCtrl->ConfigMethod));			
			...
			if ( pP2PCtrl->bProvAutoRsp == TRUE)
			{
				...
				{
					if (INFRA_ON(pAd))
						pP2PCtrl->bWaitGoNego = TRUE;
				}
			
#ifdef WIDI_SUPPORT
				WidiUpdateStateToDaemon(pAd, MIN_NET_DEVICE_FOR_P2P_CLI, WIDI_MSG_TYPE_ASSOC_STATUS,
						pFrame->p80211Header.Addr2, NULL, 0, WIDI_P2P_PROVISION_REQ_RECV);
#endif /* WIDI_SUPPORT */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Accept Provision Req ==>ConfigMethod = %s \n", decodeConfigMethod(WpsConfigMethod)));
			}
			else
			{
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	if (p2pindex >= MAX_P2P_GROUP_SIZE)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceProvisionRspAction from unknown device ==> \n"));
		return;
	}
	...
	pP2pEntry = &pAd->P2pTable.Client[p2pindex];
	pP2pEntry->bValid = FALSE;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pReceProvisionRspAction from P2P_Tab[%d] = %02x:%02x:%02x:%02x:%02x:%02x ==> \n", p2pindex, PRINT_MAC(pP2pEntry->addr)));
	/* point to OUI2 */
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pRece Provision RspAction ==>ConfigMethod = %04x. %s.\n", ConfigMethod, decodeConfigMethod(ConfigMethod)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("pAd->P2pCfg.Dpid = %d. %s.\n", pAd->P2pCfg.Dpid, decodeDpid(pAd->P2pCfg.Dpid)));
	/* Set Event to GUI to display PIN digit. */
	if (ConfigMethod == WSC_CONFMET_KEYPAD)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2pKeSetEvent 13. Show PIN now\n"));
	}
		...
		|| (ConfigMethod == WSC_CONFMET_PBC))
	{
		...
		if ((ConfigMethod == WSC_CONFMET_DISPLAY)
			&& (pP2pEntry->Rule != P2P_IS_GO))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Need setting first. Pop up setting windows. %d\n", pAd->P2pCfg.PopUpIndex));
			pP2pEntry->P2pClientState = P2PSTATE_DISCOVERY;
		}

		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Peer %d ConfigMethod = %s \n", p2pindex, decodeConfigMethod(ConfigMethod)));
		if (pP2pEntry->Rule == P2P_IS_GO)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Decide to Join P2p group? when I am %s \n", decodeP2PState(pAd->P2pCfg.P2PConnectState)));
			if (pAd->P2pCfg.P2PConnectState == P2P_CONNECT_IDLE)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2p :connecting to GO with Bssid   %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(pAd->P2pTable.Client[p2pindex].bssid)));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2p : its GroupCapability= %x.  DevCapability= %x. \n", pAd->P2pTable.Client[p2pindex].GroupCapability, pAd->P2pTable.Client[p2pindex].DevCapability));
				pP2PCtrl->P2PConnectState = P2P_ANY_IN_FORMATION_AS_CLIENT;
				pP2pEntry->P2pClientState = P2PSTATE_GO_WPS;
				RTMPMoveMemory(pP2PCtrl->Bssid, pAd->P2pTable.Client[p2pindex].bssid, MAC_ADDR_LEN);
				RTMPMoveMemory(pAd->P2pCfg.Bssid, pP2pEntry->bssid, MAC_ADDR_LEN);
				...
				pP2PCtrl->SSIDLen = pP2pEntry->SsidLen;
				pP2PCtrl->GroupOpChannel = pP2pEntry->OpChannel;
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Peer %d pP2pEntry->OpChannel = %d \n", p2pindex, pP2pEntry->OpChannel));
				P2pGoNegoDone(pAd, pP2pEntry);
			}
		}
		else
		{
			if (P2P_GO_ON(pAd))
			{
				...
				P2pSetWps(pAd, pP2pEntry);
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - I am Internal REGISTRA!!    REGISTRA. !! GOGOGO\n"));
			}
			else
			{
				if ((pP2PCtrl->ConfigMethod == WSC_CONFMET_KEYPAD) || 
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s:: recv Provision Rsp. Condif Method = %04x.\n", __FUNCTION__, ConfigMethod));
				}
				else
				{
	...
	IN PUCHAR		Addr1)
{
	...
	if (pP2pEntry->Rule == P2P_IS_CLIENT)
	{
			if (INFRA_ON(pAd) && (pP2pEntry->bGoUsePeerChannel == FALSE))
			Channel = pAd->CommonCfg.Channel;
		else
			Channel = pP2PCtrl->GroupChannel;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s:: P2P - I become Internal REGISTRA!!	  REGISTRA. !! GOGOGO\n", __FUNCTION__));
	...
	else
	{
		...
		pDest += TempLen;
		P2pLen +=TempLen;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s:: P2P - I become ENROLLEE!!	ENROLLEE.!!\n", __FUNCTION__));
/*
...
*/	
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s:: P2P - Opchannel is %d \n", __FUNCTION__, Channel));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P - P2PSendDevDisReq  TO %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(Addr1)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P - P2PSendDevDisReq  Bssid %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(Bssid)));
	...
	*pTotalFrameLen += Length;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P - P2PSendDevice Discovery Req  . TO %02x:%02x:%02x:%02x:%02x:%02x.  *pTotalFrameLen = %ld. \n", PRINT_MAC(Addr1), *pTotalFrameLen));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PSendDevDisRsp TO %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(Addr1)));
	pFrame->Category = CATEGORY_PUBLIC;
	pFrame->Action = ACTION_WIFI_DIRECT;
	/* point to OUI */
	Ptr += (sizeof(HEADER_802_11) + 2);
	...
	*pTotalFrameLen += Length;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PSendDevice Discovery Response. TO %02x:%02x:%02x:%02x:%02x:%02x.   \n", PRINT_MAC(Addr1)));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PMakeProvisionReq  . TO %02x:%02x:%02x:%02x:%02x:%02x.  ConfigMethod = %s \n", PRINT_MAC(Addr1), decodeConfigMethod(ConfigMethod)));
	pFrame = (PP2P_PUBLIC_FRAME)pOutBuffer;
	Ptr = (PUCHAR) pFrame;
	...
	*pTotalFrameLen += Length;
	...
	if (index != P2P_NOT_FOUND)
	{
		UCHAR tmpGroupID[40]; // 2 (Length) + 6 (MAC Address ) + 32 (SSID)	
		pP2pEntry = &pAd->P2pTable.Client[index];
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P - P2PMakeProvisionReq   MyRule=%s, PeerRule=%d \n", decodeMyRule(pP2PCtrl->Rule), pP2pEntry->Rule));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PMakeProvisionRsp  . TO %02x:%02x:%02x:%02x:%02x:%02x.  ConfigMethod = %x(%s) \n", PRINT_MAC(Addr1), ConfigMethod, decodeConfigMethod(ConfigMethod)));
	pFrame = (PP2P_PUBLIC_FRAME)pOutBuffer;
	Ptr = (PUCHAR) pFrame;
	ActHeaderInit(pAd, &pFrame->p80211Header, Addr1, pP2PCtrl->CurrentAddress, Addr1);
	pFrame->Category = CATEGORY_PUBLIC;
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = sizeof(P2P_PUBLIC_FRAME) - 1;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: P2P - Status %d \n", __FUNCTION__, Status));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" %s - P2PMakeGoNegoReq  TO %02x:%02x:%02x:%02x:%02x:%02x. \n", __FUNCTION__, Addr1[0], Addr1[1], Addr1[2],Addr1[3],Addr1[4],Addr1[5]));
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	Ptr = (PUCHAR) pFrame;
	ActHeaderInit(pAd, &pFrame->p80211Header, Addr1, pP2PCtrl->CurrentAddress, Bssid);
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PMakeInviteReq  TO %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(Addr1)));
	pFrame->Category = CATEGORY_PUBLIC;
	pFrame->Action = ACTION_WIFI_DIRECT;
	/* point to OUI */
	Ptr += (sizeof(HEADER_802_11) + 2);
	...
	OUT PULONG		pTotalFrameLen)
{
	...
	*pTotalFrameLen = 0;
	...
	if (MyRule == P2P_IS_CLIENT)
		...
		ActHeaderInit(pAd, &pFrame->p80211Header, Addr1, pP2PCtrl->CurrentAddress, Bssid);
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - P2PMakeInviteRsp MyRule = %s. TO %02x:%02x:%02x:%02x:%02x:%02x. \n", decodeMyRule(MyRule), PRINT_MAC(Addr1)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2P - Bssid %02x:%02x:%02x:%02x:%02x:%02x. \n", PRINT_MAC(Bssid)));
	pFrame->Category = CATEGORY_PUBLIC;
	pFrame->Action = ACTION_WIFI_DIRECT;
	/* point to OUI */
	Ptr += (sizeof(HEADER_802_11) + 2);
	...
	*pTotalFrameLen += Length;
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" P2P - OpChannel =  %d \n", pP2PCtrl->GroupChannel));
		if (INFRA_ON(pAd))
			Length = InsertP2PSubelmtTlv(pAd, SUBID_P2P_OP_CHANNEL, &pAd->CommonCfg.Channel, pDest);
		else
	...
	OUT PUCHAR pWpsIE)
{
	...
	*Peerip = 0;
		...
		switch(pEid->Eid)
		{
			...
			case IE_VENDOR_SPECIFIC:
...
#ifdef WIDI_SUPPORT
				/* Abhijeet: Here check the WiDi Specific P2POUIBYTE--- replace with WIDIOUI*/
#endif /* WIDI_SUPPORT */
				if (NdisEqualMemory(pEid->Octet, WPS_OUI, 4) && (pEid->Len > 4))
				{
#ifdef WIDI_SUPPORT
					if (pP2PCtrl->bWIDI && !(OPSTATUS_TEST_FLAG(pAd, fOP_STATUS_MEDIA_STATE_CONNECTED)))
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Found WIDI WPS IE in P2P Probe Request\n"));
						brc_notify = WidiNotifyP2pProbeIeToDaemon(pAd, (pEid->Octet+4), (pEid->Len-4), pAddr2, 1, Ssid, *pSsidLen);
					}
#endif /* WIDI_SUPPORT */
				...
				if (NdisEqualMemory(pEid->Octet, P2POUIBYTE, 4) && (pEid->Len > 4))
				{
					...
					else if (*P2PSubelementLen > 0)
					{
						...
						*P2PSubelementLen += (pEid->Len+2);
						...
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: ERROR!! 111 Sum of P2PSubelementLen= %lu, > MAX_VIE_LEN !!\n", __FUNCTION__ ,((*P2PSubelementLen) + (pEid->Len+2))));
							return FALSE;
						}

					}

					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (" !FIND!!!!!!===>P2P - PeerP2pProbeReq P2P IE Len = %ld.   %s\n", *P2PSubelementLen, decodeP2PState(pP2PCtrl->P2PConnectState)));
				}
#ifdef WFD_SUPPORT
					...
					NdisEqualMemory(pEid->Octet, WIFIDISPLAY_OUI, 4) && (pEid->Len >= 4))
				{
					...
					RTMPMoveMemory(pWfdSubelement, &pEid->Eid, pEid->Len +2);
					*pWfdSubelementLen = pEid->Len + 2;
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" !FIND!!!!!!===>WFD - PeerP2pProbeReq WFD IE Len = %ld.\n", *pWfdSubelementLen));
				}
#endif /* WFD_SUPPORT */
	...
	{
		brc = FALSE;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Ignore Probe Request that is 11b-only.\n"));
	}
	/* Check P2P's Probe Response validatity. */
	if (*P2PSubelementLen <= 4)
	{
		brc = FALSE;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Ignore Probe Request that doesn't have P2P IE.\n"));
	}
#if 0
	/*
		Samsung G2 send probe request with NULL SSID in 802.11 scan.
	*/
	if (!(NdisEqualMemory(Ssid, &WILDP2PSSID[0], WILDP2PSSIDLEN)))
	{
		brc = FALSE;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Ignore Probe Request that had invalid SSID Name.\n"));
	}
#endif

#if 0 //def WIDI_SUPPORT
	if (brc_notify == FALSE)
	{
		brc = FALSE;	
	}
...
#ifdef WIDI_SUPPORT
					WidiNotifyP2pIPToDaemon(pAd, (pEid->Octet + 4), (pEid->Len - 4), pAddr2, 1, Ssid, *pSsidLen);
#endif /* WIDI_SUPPORT */
				}
					...
					if (bFirstP2pOUI == TRUE)
					{
						...
						else if (*P2PSubelementLen > 0)
						{
							...
							*P2PSubelementLen += (pEid->Len+2);
							...
							{
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: ERROR!! 222 Sum of P2PSubelementLen= %lu, > MAX_VIE_LEN !!\n", __FUNCTION__, ((*P2PSubelementLen) + (pEid->Len+2))));
								return FALSE;
							}
						}
						bFirstP2pOUI = FALSE;
					...
					else
					{
						...
						if ((*P2PSubelementLen > 0) && (pEid->Len > 4))
						{
							...
							*P2PSubelementLen += (pEid->Len+2);
							...
							{
								MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: ERROR!! 333 Sum of P2PSubelementLen= %lu, > MAX_VIE_LEN !!\n", __FUNCTION__, ((*P2PSubelementLen) + (pEid->Len+2))));
								return FALSE;
							}
						}
					}
	...
	*Peerip = 0;
		...
		{			
			...
			case IE_VENDOR_SPECIFIC:
				...
				else if (NdisEqualMemory(pEid->Octet, P2POUIBYTE, 4) && (pEid->Len >= 4))
				{
					...
					if (bFirstP2pOUI == TRUE)
					{
						...
						if (*P2PSubelementLen == 0)
						{
							...
							*P2PSubelementLen = (pEid->Len + 3);
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC -1-1 P2PIeConLen  = %ld\n", P2PIeConLen));
						}
						else if (*P2PSubelementLen > 0)
						{
							...
							*P2PSubelementLen += (pEid->Len+3);
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (" -1-2 P2PIeConLen  = %ld\n", P2PIeConLen));
						}
							else
							{
					...
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("SYNC - Wrong P2P IE !!!!!! P2PIeConLen  = %d\n", P2PIeConLen));
					}
#endif
				}
#ifdef WFD_SUPPORT
	...
	if ((P2PIeConLen != 0) && (pP2PIeConLen != NULL))
	{
		...
		*(pP2PIeConLen+1) = (UCHAR)(P2PIeConLen/256);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("  - 3 P2PIeConLen  = %ld. /256 = %ld. *P2PSubelementLen = %ld \n", P2PIeConLen, (P2PIeConLen/256), *P2PSubelementLen));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("  -  %x %x \n", *pP2PIeConLen,  *(pP2PIeConLen+1) ));
		for (idx = 0; idx < (*P2PSubelementLen);)
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("%x-%x-%x-%x-%x-%x-%x-%x-%x-%x-%x-%x-", 
	...
	IN PUCHAR		Bssid) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2pParseManageSubElmt  TotalNumOfP2pAttribute = %d.  \n", TotalNumOfP2pAttribute));
	/* If this AP carries Managed Attribute. Update to our ManageAPBSsid */
	if (P2pManageability != 0xff)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC - Receive desired BEACON with valid P2pManageability= %x\n", P2pManageability));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC -NumOfOtherP2pAttri %d . Channel = %d. \n", NumOfOtherP2pAttri, Channel));
	...
	/* If this is a manged AP. update to the ManageAPBSsid. */
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC -I am connecting to a Managed AP. Save this Bssid. %x %x %x \n", Bssid[3],Bssid[4],Bssid[5]));
		}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC - BEACON P2pManageability= %x. TotalNumOfP2pAttribute = %d. OtherP2pAttri = %d\n", P2pManageability, TotalNumOfP2pAttribute, NumOfOtherP2pAttri));
...
/*	IN UCHAR	WorkingChannel) */
{
	...
	/*	if ((INFRA_ON(pAd) || ADHOC_ON(pAd)) && (pAd->OpMode == OPMODE_STA))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("1 PeerP2pBeaconProbeRspAtScan:: %s \n", decodeP2PState(pP2PCtrl->P2PDiscoProvState)));
			return;
		}
	*/
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("<---- %s\n", __FUNCTION__));
#endif /* RELEASE_EXLCUDE */
...
#endif /* WFD_SUPPORT */
		{
			...
			if (!(NdisEqualMemory(Ssid, &WILDP2PSSID[0], WILDP2PSSIDLEN)))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("PeerP2pBeaconProbeRspAtScan: Len = %ld.: \n", P2PSubelementLen));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("= %02x:%02x:%02x:%02x:%02x:%02x	\n",  PRINT_MAC(Addr2)));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("= %c %c %c %c %c %c%c \n",  Ssid[0], Ssid[1],Ssid[2],Ssid[3],Ssid[4],Ssid[5],Ssid[6]));
				goto CleanUp;
			}
			else
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("!! %s = %02x:%02x:%02x:%02x:%02x:%02x!!\n",  __FUNCTION__, PRINT_MAC(Addr2)));
			...
			if (P2P_CLI_ON(pAd))
			{
				index = P2pGroupTabSearch(pAd, pP2PCtrl->Bssid);
				if ((index == P2P_NOT_FOUND) && (!RTMPEqualMemory(pP2PCtrl->Bssid, Addr2, MAC_ADDR_LEN)))
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("1 From Addr2 = %02x:%02x:%02x:%02x:%02x:%02x  \n",  PRINT_MAC(Addr2)));
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("1 pAd->P2pCfg.Bssid = %02x:%02x:%02x:%02x:%02x:%02x	return\n", PRINT_MAC(pAd->P2pCfg.Bssid)));
					goto CleanUp;
				}
			}
#endif
			...
			if (index == P2P_NOT_FOUND)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("2 New From Addr2 = %02x:%02x:%02x:%02x:%02x:%02x. bBeacon = %d . GroupCap = %x \n",	PRINT_MAC(Addr2), bBeacon, GroupCap));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("2 New From DevAddr = %02x:%02x:%02x:%02x:%02x:%02x. bBeacon = %d . GroupCap = %x \n",  PRINT_MAC(DevAddr), bBeacon, GroupCap));
#ifdef DPA_S
				bNewFound = TRUE;
#endif /* DPA_S */
			...
			{
				pP2pEntry = &pAd->P2pTable.Client[index];
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s:: got ProbeResp.index = %d. statue = %s\n", __FUNCTION__, index, decodeP2PClientState(pAd->P2pTable.Client[index].P2pClientState)));
					...
					((pP2pEntry->P2pClientState == P2PSTATE_DISCOVERY_CLIENT) || (pP2pEntry->P2pClientState == P2PSTATE_DISCOVERY)))
				{
						...
						pP2pEntry->Rule = P2P_IS_GO;
						pP2pEntry->P2pClientState = P2PSTATE_DISCOVERY_GO;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("3 From DevAddr = %02x:%02x:%02x:%02x:%02x:%02x.	Change rule to GO GroupCap = %x \n",  PRINT_MAC(DevAddr), GroupCap));
				}
					...
					&& ((GroupCap&GRPCAP_OWNER) != GRPCAP_OWNER))
				{
					...
					pP2pEntry->Rule = P2P_IS_CLIENT;
					pP2pEntry->P2pClientState = P2PSTATE_DISCOVERY;
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("4 From DevAddr = %02x:%02x:%02x:%02x:%02x:%02x.	Change rule to Device. GroupCap = %x \n",  PRINT_MAC(DevAddr), GroupCap));
				}
				...
				if (bBeacon == TRUE)
				{
					...
					{
						/* Print for debug. */
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("P2p : One P2P device[%d] send out Beacon. But group owner %x bit not set ? \n", index, GroupCap));
					}
				}
				...
				if ((pP2pEntry->P2pClientState <= P2PSTATE_GO_DONE))
				{
					...
					if (pP2pEntry->P2pClientState != P2PSTATE_DISCOVERY)
					{
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2p : DevAddr[%02x:%02x:%02x:%02x:%02x:%02x] State = %s.\n", 
								PRINT_MAC(DevAddr), decodeP2PClientState(pP2pEntry->P2pClientState)));
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2p : GrpCap=%x. DevCap=%x. ConfigMethod= %x.\n", 
					...
					if (pAd->P2pCfg.ConnectingIndex < MAX_P2P_GROUP_SIZE)
					{
						...
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("    From : %02x:%02x:%02x:%02x:%02x:%02x, state = %s\n", PRINT_MAC(Addr2), decodeP2PClientState(pP2pEntry->P2pClientState)));
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("    P2PTab[%d] Addr : %02x:%02x:%02x:%02x:%02x:%02x\n", index, PRINT_MAC(pP2pEntry->addr)));
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("    ConenctIdx = %d, Addr : %02x:%02x:%02x:%02x:%02x:%02x\n", pAd->P2pCfg.ConnectingIndex, PRINT_MAC(pAd->P2pCfg.ConnectingMAC)));
	...
	IN LARGE_INTEGER   TimeStamp) 
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("1 PeerP2pBeaconProbeRspAtScan failed :  wcid = %d. not ValidAsP2P. Bug!please check. \n", Elem->Wcid));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pMacEntry Addr = %02x:%02x:%02x:%02x:%02x:%02x.\n", PRINT_MAC(pMacEntry->Addr)));
		return;
	}
	...
	if (P2pSubelement == NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("3 PeerP2pBeaconProbeRspAtScan::1Allocate memory size(=1024) failed\n"));
		goto CleanUp;
	}
									...
									P2pSubelement))
	{
		...
		if (P2P_TEST_BIT(pAd->P2pCfg.CTWindows, P2P_OPPS_BIT))
		{
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s::  set P2P CTWindows timer.\n", __FUNCTION__));
...
{
#ifdef RELEASE_EXCLUDE
		/* RTMP_PORT is using fixed PortNumber, if STA/P2P only one interface will recv Probe Req. */
		/* If STA+P2P, on GO will recv Probe Req. and the interface is PortNumber(P2P). */
#endif /* RELEASE_EXCLUDE */
		PRT_P2P_CONFIG	pP2PCtrl = &pAd->P2pCfg;
...
#ifdef RESPOND_P2P_PROBE_REQ_WHEN_INFRA_CONNECTED
        /*  Fix problem: When infra is connected on non-social channel, P2P peer cannot find us.
            According to P2P spec_v1.1, 3.1.2.1:
                A P2P Device shall not respond to Probe Request frames unless it is:
                    - a P2P Device associated with an infrastructure AP on the channel
                      on which the Probe Request was sent -- in which case the P2P Device may
                      respond provided it is not already a member of a P2P Group.
            And spec 3.1.2.6:
                A P2P Device assicuated with an infrastructure AP receiving a Probe Request 
                frame with a P2P IE and either a wildcard SSID or a P2P wildcard SSID may
                respond with a Probe Response frame with a P2P IE.
         */
        if (INFRA_ON(pAd))
        {
            /* If this probe req was sent from infra channel, we shall respond with probe rsp */
            if ((pAd->CommonCfg.BBPCurrentBW == BW_20 && Channel == pAd->CommonCfg.Channel)
                 ||(pAd->CommonCfg.BBPCurrentBW == BW_40 && Channel == pAd->CommonCfg.CentralChannel))
            {
                bSendRsp = TRUE;
                /* Patch for IOT with Xperia TX phone.
                   This makes the DSPS (DS parameter Set) IE in P2P Probe Response be set 
                   to Ctrl Channel instead of Central Channel when in HT40.
                   PS. Because the 'Channel' passed in this function is the Central channel when 
                       in HT40 mode.
                */
                Channel = pAd->CommonCfg.Channel;
            }
        }
#endif /* RESPOND_P2P_PROBE_REQ_WHEN_INFRA_CONNECTED */
									...
									WpsIE))
		{
			if (FALSE == P2PDeviceMatch(pAd, Addr2, NULL, 0))
				goto CleanUp;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2P Peer Probe Req from %02x %02x %02x %02x %02x %02x	\n", PRINT_MAC(Addr2)));
...
//QQ TBD, p2p widi need insert p2p entry in probe req. due to p2p0 only in listen state
				...
				if (index < MAX_P2P_GROUP_SIZE)
				{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s / %s\n", 
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("(%d) P2P Peer Probe Req from %02x %02x %02x %02x %02x %02x	\n", 
...
#ifdef WIDI_SUPPORT
				pAd->gP2pSendingProbeResponse = 1;
#endif /* WIDI_SUPPORT */
...
#ifdef WIDI_SUPPORT
				pAd->gP2pSendingProbeResponse = 0;
#endif /* WIDI_SUPPORT */
				
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Got P2P Peer %d Probe Req . Send probe response back  len=%ld \n", index, FrameLen));
				MlmeFreeMemory(pAd, pOutBuffer);
			}
			...
			if (index < MAX_P2P_GROUP_SIZE)
			{
				...
				if (pAd->P2pTable.Client[index].P2pClientState == P2PSTATE_CONNECT_COMMAND)
				{
					P2P_CMD_STRUCT	P2pCmd;
					UCHAR ClientState = pAd->P2pTable.Client[index].P2pClientState;
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("<< %s: Start Group Form!\n", __FUNCTION__));
					COPY_MAC_ADDR(&P2pCmd.Addr[0], pAd->P2pTable.Client[index].addr);
					P2pCmd.Idx = index;
#if 0 //Fix Sigma 5.1.22 case, remove this entry point, use P2pGroupMaintain() entry point					
					MlmeEnqueue(pAd, P2P_GO_FORM_STATE_MACHINE, P2P_START_COMMUNICATE_CMD_EVT, sizeof(P2P_CMD_STRUCT), &P2pCmd, ClientState);
#endif
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("<< %s: Invite!\n", __FUNCTION__));
	...
	IN	PMLME_QUEUE_ELEM	pElem)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pReceiveEapNack : WscState = %d. %s \n", pAd->StaCfg.WscControl.WscState, decodeP2PState(pP2PCtrl->P2PConnectState)));			
	
	pHeader_802_11 = (PHEADER_802_11)&pElem->Msg[0];
	RTMPMoveMemory(addr, pHeader_802_11->Addr2, MAC_ADDR_LEN);

	if (IS_P2P_REGISTRA(pAd) || IS_P2P_ENROLLEE(pAd))
	{
		LinkDown(pAd, FALSE);
	...
	OUT	PULONG			pIeLen)
{
...
#ifdef INTEL_WFD_SUPPORT 	
	/* 
		Secodory Device IE. Right now version is 0x20
		0x00 0x07: Category ID is 7
		0x00:17:35:20: OUI + Version : 0x20 = 20 RDS Version
		0x102 RDS Sink
	*/
	UCHAR WiDiWpsSecondary[] = {0x00, 0x07, 0x00, 0x17, 0x35, 0x20, 0x01, 0x02};

	/* 
		0x00 0x01 0x57: Intel SMI
		0x02 : RDS Sink
		0x00 0x03 EDID
		0x00 0x0B EDID Data Length
	*/
	UCHAR WiDiWpsVendorExt[] = {0x00, 0x01, 0x57, 0x02, 0x00, 0x03, 0x00, 0x0B};
#endif /* INTEL_WFD_SUPPORT  */
	...
	*(pData + 4) = (pAd->P2pCfg.bConfiguredAP ? WSC_SCSTATE_CONFIGURED : WSC_SCSTATE_UNCONFIGURED);
	...
	if (pP2PCtrl->bWIDI)
	{
		/* Fix this: Need to check if host is widi only and then send the probe response with WSC_ID_SEC_DEV_TYPE_LIST*/
		*((PUSHORT) pData) = cpu2be16(WSC_ID_SEC_DEV_TYPE_LIST);
		*((PUSHORT) (pData + 2)) = cpu2be16(0x0008);
		NdisMoveMemory((pData + 4), WiDiWpsSecondary, 8);
		pData += 12;
		Len   += 12;
		/* Vendor Extension sub element in the WPS IE will include information related to EDID and EDID_DATA*/
		/* Fixme: Edid data is 0. Need to read it from L3 and should be passed to pAd somehow*/
		*((PUSHORT) pData) = cpu2be16(WSC_ID_VENDOR_EXT);
		*((PUSHORT) (pData + 2)) = cpu2be16(0x0013);
		NdisMoveMemory((pData + 4), WiDiWpsVendorExt, 8);
		*((PUSHORT) (pData + 12)) = cpu2be16(pAd->mfg_code);
		*((PUSHORT) (pData + 14)) = cpu2be16(pAd->prod_code);
		*((PUSHORT) (pData + 16)) = cpu2be32(pAd->serial_num);
		*((PUSHORT) (pData + 20)) = pAd->cap_flag;
		*((PUSHORT) (pData + 21)) = pAd->hori_size;	
		*((PUSHORT) (pData + 22)) = pAd->vert_size;
		pData += 23;
		Len   += 23;
	}
#endif /* INTEL_WFD_SUPPORT */
		...
		if ((pAd->ApCfg.MBSSID[BSS0].WscControl.WscSelReg) && (pAd->P2pCfg.Dpid == DEV_PASS_ID_PBC))
		{
			if (P2P_GO_ON(pAd))
			{
				...
				*((PUSHORT) (pData + 4)) = cpu2be16(0x18c); /* Support All : PBC, Keypad, Label, Display */
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2pMakeProbeRspWSCIE: SelReg=1 \n"));
			}
		}	
	...
	*((PUSHORT) (pData + 4)) = cpu2be16(pP2PCtrl->ConfigMethod);
	...
	if (1)
	{
		/* 5. Wi-Fi Protected Setup State */
		*((PUSHORT) pData) = cpu2be16(WSC_ID_SC_STATE);
		*((PUSHORT) (pData + 2)) = cpu2be16(0x0001);
		*(pData + 4) = (pP2PCtrl->bConfiguredAP ? WSC_SCSTATE_CONFIGURED : WSC_SCSTATE_UNCONFIGURED);
		pData += 5;
		Len   += 5;
...
/*
		...
		*((PUSHORT) (pData + 2)) = cpu2be16(Wsc_Manufacture_Len);	
		NdisMoveMemory((pData + 4), pDevInfo->Manufacturer, Wsc_Manufacture_Len); //64
		pData += (4+Wsc_Manufacture_Len);
		Len   +=  (4+Wsc_Manufacture_Len);

		// 9. Model Name
		*((PUSHORT) pData) = cpu2be16(WSC_IE_MODEL_NAME);
		*((PUSHORT) (pData + 2)) = cpu2be16(sizeof(Wsc_Model_Name_Len));	
		NdisMoveMemory((pData + 4), pDevInfo->ModelName, sizeof(Wsc_Model_Name_Len) ); //32 
		pData +=  (4+sizeof(Wsc_Model_Name_Len));
		Len   += (4+sizeof(Wsc_Model_Name_Len));
		
		// 10. Model Number
		*((PUSHORT) pData) = cpu2be16(WSC_IE_MODEL_NO);
		*((PUSHORT) (pData + 2)) = cpu2be16( sizeof(Wsc_Model_Number_Len)); 
		NdisMoveMemory((pData + 4), pDevInfo->ModelNumber, sizeof(Wsc_Model_Number_Len)); //32
		pData +=  (4+sizeof(Wsc_Model_Number_Len));
		Len   +=  (4+sizeof(Wsc_Model_Number_Len));
		
		// 11. Serial Number
		*((PUSHORT) pData) = cpu2be16(WSC_IE_SERIAL);
		*((PUSHORT) (pData + 2)) = cpu2be16( sizeof(Wsc_Model_Serial_Len)); 
		NdisMoveMemory((pData + 4), pDevInfo->SerialNumber, sizeof(Wsc_Model_Serial_Len)); //32
		pData +=  (4+sizeof(Wsc_Model_Serial_Len));
		Len   +=  (4+sizeof(Wsc_Model_Serial_Len));
*/
		/* 12. RF band, shall change based on current channel */
		*((PUSHORT) pData) = cpu2be16(WSC_ID_RF_BAND);
		*((PUSHORT) (pData + 2)) = cpu2be16(0x0001);
		*(pData + 4) = pDevInfo->RfBand;
		...
		if (pAd->P2pCfg.Dpid  != DEV_PASS_ID_NOSPEC)
		{
			...
			*((PUSHORT) pData) = cpu2be16(WSC_ID_DEVICE_PWD_ID);
			*((PUSHORT) (pData + 2)) = cpu2be16(0x0002);
			*((PUSHORT) (pData + 4)) = cpu2be16(pP2PCtrl->Dpid);
			pData += 6;
			Len   += 6;
		}
		...
		/* When PBC has triggered, done or connected with timeout, */
		/* we must change the value of SelReg. */
/*		if ((pDevInfo->SelReg == 1) && (pAd->P2pCfg.Dpid == DEV_PASS_ID_PBC)) */
#ifdef CONFIG_AP_SUPPORT
		if ((pAd->ApCfg.MBSSID[BSS0].WscControl.WscSelReg) && (pP2PCtrl->Dpid == DEV_PASS_ID_PBC))
		{
			if ((pP2PCtrl->P2PConnectState == P2P_ANY_IN_FORMATION_AS_GO) || IS_P2P_REGISTRA(pAd) || P2P_GO_ON(pAd) || (pP2PCtrl->GoIntentIdx == 16))
			{
				/* 14. Selected Registrar */
				*((PUSHORT) pData) = cpu2be16(WSC_ID_SEL_REGISTRAR);
				*((PUSHORT) (pData + 2)) = cpu2be16(0x0001);
/*				*(pData + 4) = pDevInfo->SelReg; */ /* NDIS_WINS */
/*				*(pData + 4) = pAd->StaCfg.WscControl.WscConfigMethods; */ /* STA */
				*(pData + 4) = pAd->ApCfg.MBSSID[BSS0].WscControl.WscSelReg; /* AP */
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("-----> P2pMakeProbeReqIE\n"));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s:: pP2PCtrl.Addr[%02x:%02x:%02x:%02x:%02x:%02x]\n",
					__FUNCTION__, PRINT_MAC(pP2PCtrl->CurrentAddress)));
#endif /* RELEASE_EXCLUDE */
	if (SubType== SUBTYPE_PROBE_RSP)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("SYNC - P2PMakeProbeRsp. Addr2 = %02x:%02x:%02x:%02x:%02x:%02x...\n",
					PRINT_MAC(Addr2)));
		...
		MgtMacHeaderInit(pAd, &ProbeRspHdr, SUBTYPE_PROBE_REQ,
							0, BROADCAST_ADDR,
							pP2PCtrl->CurrentAddress,
							BROADCAST_ADDR);
...
#if 0
	if (IS_P2P_OP(pAd))
		DsChannel = pAd->CommonCfg.Channel;
	else if ((pP2PCtrl->P2PDiscoProvState == P2P_IDLE) || (pP2PCtrl->P2PDiscoProvState == P2P_ENABLE_LISTEN_ONLY))
		DsChannel = pP2PCtrl->ListenChannel;
	else if ((pP2PCtrl->P2PDiscoProvState == P2P_SEARCH) || (pP2PCtrl->P2PDiscoProvState == P2PGO_SEARCH) || (pP2PCtrl->P2PDiscoProvState == P2P_LISTEN))
		DsChannel = pAd->MlmeAux.Channel;
...
#endif
	if (DsChannel == 0)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("SYNC - P2PMakeProbeRsp. DsChannel = is 0 !!!!!\n"));
	...
	OUT	PULONG			pIeLen)
{
	...
	*pIeLen = 0;
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s: PacketType - %d\n", __FUNCTION__, PacketType));
#endif /* RELEASE_EXCLUDE */
	/* 0. P2P fixed IE */
	...
	if (PacketType == SUBTYPE_ASSOC_RSP)
	{
		...
		if (IS_P2P_SUPPORT_EXT_LISTEN(pAd))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pMakeP2pIE (PacketType = %d)  insert SUBID_P2P_EXT_LISTEN_TIMING  .\n", PacketType));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("<----- P2pMakeP2pIE For managed STA. (Len = %ld) \n", Len));
		*(pOutBuf+1) = (Len-2);
		*pIeLen = Len;
		return;
	}
		...
		(PacketType == SUBTYPE_ASSOC_REQ))
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pAd->P2pCfg.P2pManagedParm.APP2pManageability = %x \n",	pAd->P2pCfg.P2pManagedParm.APP2pManageability));
				...
				&& (!P2P_TEST_BIT(pAd->P2pCfg.P2pManagedParm.APP2pManageability, P2PMANAGED_ICS_ENABLE_BIT)))
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Turn off Corss Conenct bit in Assoc Req. %x \n",  (~GRPCAP_CROSS_CONNECT)));
			}
		}
		...
		pData += TempLen;
		/* this is managed infra STA connect to Infra AP. So Add P2P Interface. then this's all. return here. */
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("<-----P2pMakeP2pIE For managed STA. (Len = %ld PacketType = %d.) \n", Len, PacketType));
		*(pOutBuf+1) = (Len-2);
		*pIeLen = Len;
		return;
	}
	...
	if ((PacketType == SUBTYPE_PROBE_RSP) || (PacketType == SUBTYPE_ASSOC_REQ) || (PacketType == SUBTYPE_REASSOC_REQ))
	{
		...
		{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("	P2pMakeP2pIE (PacketType = %d)	insert SUBID_P2P_DEVICE_INFO. DeviceNameLen = %ld.\n", PacketType, pAd->P2pCfg.DeviceNameLen));
		}
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("P2pMakeP2pIE (PacketType = %d)  insert SUBID_P2P_EXT_LISTEN_TIMING  .\n", PacketType));
		TempLen = InsertP2PSubelmtTlv(pAd, SUBID_P2P_EXT_LISTEN_TIMING, NULL, pData);
		Len += TempLen;
		pData += TempLen;
	}
	...
	*(pOutBuf+1) = (Len-2);
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("<----- P2pMakeP2pIE (Len = %ld) \n", Len));
	*pIeLen = Len;
}
...
#if 0	
	if (!NdisEqualMemory(pWpsData+2, WPS_OUI, 4))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s :  No WPS OUI  ..%x %x %x %x %x .\n", __FUNCTION__, *(pWpsData+0),*(pWpsData+1),*(pWpsData+2), *(pWpsData+3), *(pWpsData+4)));
		return;	
	}
#endif		
			...
			case WSC_ID_DEVICE_PWD_ID:		/* 1 */
				if (Dpid !=NULL)
				{
					*Dpid = be2cpu16(*((USHORT *) pData));
					/**Dpid = *((PUSHORT) pData); */
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("%s :  Dpid = %s  .\n", __FUNCTION__, decodeDpid(*Dpid)));
				}
				break;
			case WSC_ID_CONFIG_METHODS:		/* 1 */
				if (ConfigMethod !=NULL)
				{
					*ConfigMethod = be2cpu16(*((PUSHORT) pData));
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,(" Config = %x  ..\n", *ConfigMethod));
				}
				break;
			default:
				/*MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("WscRecvMessageM1 --> Unknown IE 0x%04x\n", WscType));	    */
				break;				
		}
...
#if 0
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pStopGoTimer -  13 sec\n"));
	RTMPSetTimer(pAd, &pAd->P2pCfg.P2pStopGoTimer, 13000);
#endif /*0*/
}
	...
	IN PUCHAR	pDest)
{
	...
	if (pP2PCtrl->GONoASchedule.bValid == TRUE)
	{
		...
		*(pDest+11) = pP2PCtrl->GONoASchedule.Count;
		...
		for (i= 0; i < 24; i++)
		{
			RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0(pAd) + TXWI_SIZE +StartPosition +i, pAd->BeaconBuf[StartPosition+i]); 
		}

		/*
		 * step 6. move BEACON TXD and frame content to on-chip memory
		 */
		pAd->BeaconTxWI.TxWIMPDUByteCnt = StartPosition + pAd->GOBeaconBufNoALen;
		pAd->BeaconTxWI.TxWIPHYMODE = MODE_OFDM;
		ptr = (PUCHAR)&pAd->BeaconTxWI;
		for (i=0; i<TXWI_SIZE; i++)  /* 24-byte TXINFO field */
		{
			RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0(pAd) + i, *ptr);
			ptr ++;
		}
#endif
	}
	else
	{
		...
		*(pDest+10) = pP2PCtrl->CTWindows;
		...
		pAd->BeaconTxWI.TxWIMPDUByteCnt = StartPosition + 11;
		pAd->BeaconTxWI.TxWIPHYMODE = MODE_OFDM;
		ptr = (PUCHAR)&pAd->BeaconTxWI;
		for (i = 0; i < TXWI_SIZE; i++)  /* 24-byte TXINFO field */
		{
	...
	IN  PUCHAR	pIpReqP2ptabindex) 
{
		...
		if (pCapability != NULL)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("P2pUpdateBssBeacon Cap::  = %x  %x. )\n", *(pCapability), *(pCapability+1)));
			pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.P2pCapOffset] = *(pCapability);
			pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.P2pCapOffset+1] = *(pCapability+1);
			/* update BEACON frame content. start right after the 24-byte TXINFO field */
			RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0 + TXWI_SIZE + pP2PCtrl->P2pBcnOffset.P2pCapOffset, pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.P2pCapOffset]); 
			RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0 + TXWI_SIZE + pP2PCtrl->P2pBcnOffset.P2pCapOffset+1, pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.P2pCapOffset+1]); 
		}
	/*	if (pIpReqP2ptabindex != NULL) */
		{
			if (*pIpReqP2ptabindex < MAX_P2P_GROUP_SIZE)
			{
				wcid = pAd->P2pTable.Client[*pIpReqP2ptabindex].MacTabIndex;
				bitmap = 1<< pAd->MacTab.Content[wcid].Aid;
				if (pAd->P2pTable.Client[*pIpReqP2ptabindex].Peerip != 0)
					pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.IpBitmapBcnOffset] &= (~bitmap);
				if (pAd->P2pTable.Client[*pIpReqP2ptabindex].Peerip == 0)
					pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.IpBitmapBcnOffset] |= bitmap;
				RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0 + TXWI_SIZE + pP2PCtrl->P2pBcnOffset.IpBitmapBcnOffset, pAd->BeaconBuf[pP2PCtrl->P2pBcnOffset.IpBitmapBcnOffset]); 
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Update beacon. Client[aid=%d]  Bitmap = %x. offset = %d\n", wcid,  pAd->BeaconBuf[pAd->P2pCfg.P2pBcnOffset.IpBitmapBcnOffset], pP2PCtrl->P2pBcnOffset.IpBitmapBcnOffset));
			}
		}*/
#endif
}
...
{
#if 0
		UCHAR		  DsLen = 1, TimLen = 4, IbssLen = 2, SsidLen;
		...
		UCHAR			P2pIEFixed[6] = {0xdd, 0x12, 0x00, 0x50, 0xf2, 0x09};	/* length will modify later */
		ULONG TmpLen;
		UCHAR		ThisSsid[32];
		UCHAR		SupRateLen;
		RALINKIP_IE 	RaIpIe;
		...
		pPort->PortCfg.SsidLen = pP2PCtrl->SSIDLen;
		SsidLen = pPort->PortCfg.SsidLen;
		RTMPMoveMemory(pPort->PortCfg.Ssid, pP2PCtrl->SSID, 32);
		...
		pAd->ApCfg.CapabilityInfo = CAP_GENERATE(1, 0, 1, 0, 0);
		...
		/* add WMM IE here */
		/*if ((pAd->CommonCfg.bWmmCapable) || WMODE_CAP_N(pAd->ApCfg.PhyMode)) */
		{
		...
		/* Append RSN_IE when  WPA OR WPAPSK,  */
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s:	Append RSN_IE when	Ralink802_11AuthModeWPA2PSK\n", __FUNCTION__));
		}
	
		pAd->P2pCfg.P2pBcnOffset.IpBitmapBcnOffset = FrameLen + 6;
		RaIpIe.ElementID = IE_VENDOR_SPECIFIC;
		RaIpIe.Length = 5;
		RTMPMoveMemory(RaIpIe.OUI, RALINK_OUI, 3);
		...
		RaIpIe.Octet[0] = 0x1e;
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s:  Append RalinkIP_IE \n", __FUNCTION__));
		}
		
		P2pMakeProbeRspWSCIE(pAd, pBeaconFrame + FrameLen, &TmpLen);
		/* Set TimIELocationInBeacon before P2P IE.  */
		/* Because following P2P IE want to put to GOUpateBeacon() function too. */
		FrameLen += TmpLen;
		pAd->ApCfg.TimIELocationInBeacon = FrameLen; 
	
		/* ========================================> */
		/* Save P2P IE Lenght offset. */
		RTMPMoveMemory(pBeaconFrame + FrameLen, &P2pIEFixed[0], 6);
		FrameLen += 6;
		pAd->P2pCfg.P2pCapability[1] |= (GRPCAP_GROUP_FORMING | GRPCAP_OWNER);
		pAd->P2pCfg.P2pBcnOffset.P2pCapOffset = FrameLen + 3;
		TmpLen = InsertP2PSubelmtTlv(pAd, SUBID_P2P_CAP, pAd->P2pCfg.P2pCapability, pBeaconFrame + FrameLen);
		FrameLen += TmpLen;
		/* Device ID is mandatory in beacon. */
		TmpLen = InsertP2PSubelmtTlv(pAd, SUBID_P2P_DEVICE_ID, pAd->PortList[pAd->P2pCfg.PortNumber]->CurrentAddress, pBeaconFrame + FrameLen);
		FrameLen += TmpLen;
		
		BeaconTransmit.word = 0;
		BeaconTransmit.field.MODE = MODE_OFDM; /* Use 6Mbps */
		write_tmac_info(pAd, (UCHAR *)pTxWI, FALSE,
						TRUE, FALSE, FALSE,
						TRUE, 0, BSS0Mcast_WCID, 
						FrameLen, PID_MGMT, 0,
						IFS_HTTXOP, FALSE, BeaconTransmit);
		/*
		 * step 6. move BEACON TXD and frame content to on-chip memory
		 */
		ptr = (PUCHAR)&pAd->BeaconTxWI;
		...
		{
			RTMP_IO_WRITE8(pAd, HW_BEACON_BASE0 + TXWI_SIZE + i, *ptr); 
			ptr ++;
		}
	
		pAd->BeaconBufLen = FrameLen;
		pAd->ApCfg.cap_ie_pos = sizeof(HEADER_802_11) + TIMESTAMP_LEN + 2;
	
	/*==============================================> */
		/* Make fake beacon for indicating connection in GO mode. */
			pAd->ApCfg.AdhocBssid[0] = 0xF0;
			pAd->ApCfg.AdhocBssid[1] = 0x50;
			pAd->ApCfg.AdhocBssid[2] = 0x40;
			pAd->ApCfg.AdhocBssid[3] = 0x30;
			pAd->ApCfg.AdhocBssid[4] = 0x20;
			pAd->ApCfg.AdhocBssid[5] = 0x10;
		MgtMacHeaderInit(pAd, pPort, &BcnHdr, SUBTYPE_BEACON, 0, BROADCAST_ADDR, pAd->ApCfg.AdhocBssid);
		...
		pAd->ApCfg.CapabilityInfo = CAP_GENERATE(0, 1, 0, 0, 0);
	
		pBeaconFrame = pAd->GoBeaconBuf;
		
		SsidLen = pAd->P2pCfg.SSIDLen;
		RTMPMoveMemory(ThisSsid, pAd->P2pCfg.SSID, 32);
		...
		MakeOutgoingFrame(pBeaconFrame, 				 &FrameLen,
						...
						pAd->CommonCfg.SupRateLen,		 tmpSupRate, 
						1,								 &DsIe, 
						1,								 &DsLen, 
						1,								 &pP2PCtrl->GroupOpChannel,
						  1,							   &IbssIe, 
						  1,							   &IbssLen, 
	...
	IN UCHAR	*pRspStatus)
{
	...
	*pRspStatus = P2PSTATUS_SUCCESS;
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - no common channel = %d...\n", *ChannelList));
		...
		&& (bIAmGO == FALSE))
	{
		*pRspStatus = P2PSTATUS_INVALID_PARM;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - MAc addr invalid  .\n"));
		return;
	}
	...
	if (bIAmGO == FALSE)
	{
		...
		{
			*pRspStatus = P2PSTATUS_NO_CHANNEL;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - 2 P2PSTATUS_NO_CHANNEL  .\n"));
			return;
		}
	}
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Ssid1[%d] = %s.  \n",  SsidLen, Ssid));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Ssid2[%d] = %s.  \n",  pAd->P2pTable.PerstEntry[index].Profile.SSID.SsidLength, pAd->P2pTable.PerstEntry[index].Profile.SSID.Ssid));
		*pRspStatus = P2PSTATUS_INVALID_PARM;
		return;
	}
	...
	IN UCHAR	*pRspStatus)
{
	...
	*pRspStatus = P2PSTATUS_SUCCESS;
	...
	if (FALSE == P2pCheckChannelList(pAd, ChannelList))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - no common channel. Channel list is : %d...\n", ChannelList[0]));
		*pRspStatus = P2PSTATUS_NO_CHANNEL;
		return;
	}
	...
	if (OpChannel != 0)
	{
		...
		{
			*pRspStatus = P2PSTATUS_NO_CHANNEL;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - No channel = %d...\n", OpChannel));
			return;
		}
	}
	...
	if ((SsidLen == 0))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, (" P2P - Ssidlen Zero = %d...\n", SsidLen));
		*pRspStatus = P2PSTATUS_INVALID_PARM;
		return;
	}
