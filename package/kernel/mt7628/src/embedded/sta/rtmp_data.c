...
static inline BOOLEAN tx_txbf_handle(RTMP_ADAPTER *pAd, TX_BLK *pTxBlk, BOOLEAN bHTC, UCHAR *buf_ptr)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("--Sounding in AMPDU: TxSndgType=%d, MCS=%d\n",
...
{
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Twakeup Expired... !!!\n"));
#endif /* RELEASE_EXCLUDE */
