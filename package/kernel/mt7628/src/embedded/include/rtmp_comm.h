...
typedef enum{
	...
	DBG_LVL_LOUD	= 5,
	DBG_LVL_NOISY	= 6,
	DBG_LVL_MAX		= DBG_LVL_NOISY,
}DEBUG_LEVEL;

/* Debug Category */
typedef enum{
	DBG_CAT_INIT 	= 0x00000001,	/* initialization/shutdown */
	DBG_CAT_HW		= 0x00000002,	/* MAC/BBP/RF/Chip */
	DBG_CAT_FW		= 0x00000004,	/* FW related command, response, CR that FW care about */
	DBG_CAT_HIF		= 0x00000008,	/* Host interface: usb/sdio/pcie/rbus */
	DBG_CAT_FPGA	= 0x00000010,	/* FPGA Chip verify, DVT */
	DBG_CAT_TEST	= 0x00000020,	/* ATE, QA, UT, FPGA?, TDT, SLT, WHQL, and other TEST */
	DBG_CAT_RA		= 0x00000040,	/* Rate Adaption/Throughput related */
	DBG_CAT_AP		= 0x00000080,	/* AP, MBSS, WDS */
	DBG_CAT_CLIENT	= 0x00000100,	/* STA, ApClient, AdHoc, Mesh */
	DBG_CAT_TX		= 0x00000200,	/* Tx data path */
	DBG_CAT_RX		= 0x00000400,	/* Rx data path */
	DBG_CAT_CFG		= 0x00000800,	/* ioctl/oid/profile/cfg80211/Registry */
	DBG_CAT_MLME	= 0x00001000,	/* 802.11 fundamental connection flow, auth, assoc, disconnect, etc */
	DBG_CAT_PROTO	= 0x00002000,	/* protocol, ex. TDLS */
	DBG_CAT_SEC		= 0x00004000,	/* security/key/WPS/WAPI/PMF/11i related*/
	DBG_CAT_PS		= 0x00008000,	/* power saving/UAPSD */
	DBG_CAT_POWER	= 0x00010000,	/* power Setting, Single Sku, Temperature comp, etc */
	DBG_CAT_COEX	= 0x00020000,	/* BT, BT WiFi Coex, LTE, TVWS*/
	DBG_CAT_P2P		= 0x00040000,	/* P2P, Miracast */
	DBG_CAT_RSV1	= 0x40000000,	/* reserved index for code development */
	DBG_CAT_RSV2	= 0x80000000,	/* reserved index for code development */
...
typedef enum{
#if 0
	DBG_SUBCAT_ 	= 0x00000001,	/*  */
	DBG_SUBCAT_		= 0x00000002,	/*  */
	DBG_SUBCAT_		= 0x00000004,	/*  */
	DBG_SUBCAT_		= 0x00000008,	/*  */
	DBG_SUBCAT_	= 0x00000010,	/*  */
	DBG_SUBCAT_	= 0x00000020,	/*  */
	DBG_SUBCAT_		= 0x00000040,	/*  */
	DBG_SUBCAT_		= 0x00000080,	/*  */
#endif
	DBG_SUBCAT_BNDSTRG	= 0x00000100,	/* Band Steering */
#if 0
	DBG_SUBCAT_		= 0x00000200,	/*  */
	DBG_SUBCAT_		= 0x00000400,	/*  */
	DBG_SUBCAT_		= 0x00000800,	/*  */
	DBG_SUBCAT_	= 0x00001000,	/* */
	DBG_SUBCAT_	= 0x00002000,	/*  */
	DBG_SUBCAT_		= 0x00004000,	/* */
	DBG_SUBCAT_		= 0x00008000,	/*  */
	DBG_SUBCAT_	= 0x00010000,	/*  */
	DBG_SUBCAT_	= 0x00020000,	/* */
	DBG_SUBCAT_		= 0x00040000,	/*  */
	DBG_SUBCAT_	= 0x40000000,	/*  */
	DBG_SUBCAT_	= 0x80000000,	/*  */
#endif
