...
VOID BndStrg_ShowTableInfo(PBND_STRG_CLI_TABLE table);
INT BndStrg_ShowEntries(PBND_STRG_CLI_TABLE table);
INT BndStrg_PrintEntry(PBND_STRG_CLI_ENTRY entry);
INT BndStrg_InsertEntry(PBND_STRG_CLI_TABLE table, PUCHAR pAddr, PBND_STRG_CLI_ENTRY *entry_out);
