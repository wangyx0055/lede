...
#define ADMTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, format,args...)	do{if(atomic_read(&DEBUG_VERBOSE_MODE))	printk( format, ##args);}while(0)
 ...
 * function prototype
 */
VOID RT3XXX_AntDiversity_Init(RTMP_ADAPTER *pAd);
VOID RT3XXX_AntDiversity_Fini(RTMP_ADAPTER *pAd);
