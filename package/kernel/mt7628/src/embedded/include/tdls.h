...
INT
Set_TdlsDiscoveryReq_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
...
INT
Set_TdlsTPKLifeTime_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);

#ifdef TDLS_AUTOLINK_SUPPORT
INT
Set_TdlsAutoLinkProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
...
INT	Set_TdlsSendHwNullFrameProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
...
INT	Set_TdlsManualInsEntry_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
