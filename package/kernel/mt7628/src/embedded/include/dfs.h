...
{																				\
	...
	{																			\
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("0x%08x ", _TableIdx[__k]));					\
...
#define DFS_EVENT_PRINT(_DfsEvent)		\
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ( "EngineId = %u, Timestamp = %u, Width = %u\n",	\
...
{																				\
	...
	{																			\
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("0x%02x ", _TableIdx[k]));						\
...
#ifdef DFS_ATP_SUPPORT
INT Set_DfsAtpStart_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
INT Set_DfsAtpReset_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
INT Set_DfsAtpReport_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif
