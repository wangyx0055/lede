...
VOID AndesMTUsbFwInit(struct _RTMP_ADAPTER *pAd);
INT32 AndesMTUSBKickOutCmdMsg(struct _RTMP_ADAPTER *pAd, struct cmd_msg *msg);
INT32 AndesMTUsbChkCrc(struct _RTMP_ADAPTER *pAd, UINT32 checksum_len);
UINT16 AndesMTUsbGetCrc(struct _RTMP_ADAPTER *pAd);
