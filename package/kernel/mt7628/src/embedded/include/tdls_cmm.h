...
#ifdef RTMP_MAC_USB
#define TDLS_CHANNEL_SWITCH_TIME		20000 /* micro seconds */
#define TDLS_CHANNEL_SWITCH_TIMEOUT		30000 /* micro seconds */
#else
...
{																			\
	...
	/*7636 psm*/
	RTMPSendNullFrame(__pAd, __pAd->CommonCfg.TxRate, TRUE, __pAd->StaCfg.PwrMgmt.Psm);				\
}
#endif /* __TDLS_CMM_H */
