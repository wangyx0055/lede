...
#if 0
#define SDIO_MIN_RESERVED_TC0_RESOURCE    0
#define SDIO_MIN_RESERVED_TC1_RESOURCE    0
#define SDIO_MIN_RESERVED_TC2_RESOURCE    0
#define SDIO_MIN_RESERVED_TC3_RESOURCE    0
#define SDIO_MIN_RESERVED_TC4_RESOURCE    0
#define SDIO_MIN_RESERVED_TC5_RESOURCE    SDIO_TX_PAGE_COUNT_TC5  /* Resource for TC5 is not adjustable */
#define SDIO_MIN_RESERVED_TC6_RESOURCE    SDIO_TX_PAGE_COUNT_TC6
#define SDIO_MIN_RESERVED_TC7_RESOURCE    SDIO_TX_PAGE_COUNT_TC7
#endif
