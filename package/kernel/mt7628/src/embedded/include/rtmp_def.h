...
#ifdef RELEASE_EXCLUDE
/* One-wired solution, WIFI-ACT is pulled low by software */
#endif /* RELEASE_EXCLUDE */
...
#define MBSS_MR_APIDX_SANITY_CHECK(__pAd, apidx) \
    { if ((apidx >= MAX_MBSSID_NUM(__pAd)) || \
		(apidx >= HW_BEACON_MAX_NUM)) { \
          MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s> Error! apidx = %d > MAX_MBSSID_NUM!\n", __FUNCTION__, apidx)); \
	  apidx = MAIN_MBSSID; } }
...
*/
#define BT_SWTICH_ENABLE						1
#define BT_SWTICH_DISABLE						0
#define BT_WIFI_DIRECT							1
#define BT_WIFI_CROSS							0
#else
#undef MAX_NUM_OF_BBP_LATCH
...
#define	AUTO_PROVISION_STATE_MACHINE	30
...
#ifdef CONFIG_STA_SUPPORT
#ifdef STA_EASY_CONFIG_SETUP
#define AUTO_PROVISION_IDLE				0
#define INFRA_AUTO_PROVISION			1
#define ADHOC_AUTO_PROVISION			2
#define MAX_AUTO_PROVISION_STATE		3

#define AUTO_PROVISION_MACHINE_BASE		0
#define MT2_CONN_AP						0
#define MT2_CONN_AUTO_PROVISION_AP		1
#define MT2_START_AUTO_PROVISION_IBSS	2
#define MT2_JOIN_AUTO_PROVISION_IBSS	3
#define MAX_AUTO_PROVISION_MSG			4

#define	AUTO_PROVISION_FUNC_SIZE		(MAX_AUTO_PROVISION_STATE * MAX_AUTO_PROVISION_MSG)
#endif /* STA_EASY_CONFIG_SETUP */
#endif /* CONFIG_STA_SUPPORT */
...
#define WLAN_ScanRequest	0x3
#define WLAN_ScanConfirm	0x4
#define WLAN_AuthRequest	0x5
#define WLAN_AuthConfirm	0x6
#define WLAN_DeAuthRequest	0x7
...
#define fBTSTATUS_BT_BWL                    0x00000100 /* bit8 */
#define fBTSTATUS_BT_BE                     0x00000200
#define fBTSTATUS_BT_SYNC                   0x00000400
#define fBTSTATUS_BT_SNIFF                  0x00000800
#define fBTSTATUS_BT_SCATTER                0x00001000 /* bit12 */
...
#define MCU_SET_ACTIVE_POLLING			0x90	/* If enable, firmware polling GPIO0 to enable/disable MAC TX */
...
#if 0
#define ENTRY_CAT_BSS			0x00010000   -> AP/STA, GO/GC, DLS/TDLS
#define ENTRY_CAT_BSS_STA		0x00011000   -> Infra STA, GC, DLS/TDLS
#define ENTRY_CAT_BSS_STA_INFRA 0x00011100
#define ENTRY_CAT_BSS_STA_GC     0x00011200
#define ENTRY_CAT_BSS_STA_DLS    0x00011400
#define ENTRY_CAT_BSS_STA_TDLS  0x00011800

#define ENTRY_CAT_BSS_AP		0x00012000   -> Infra AP,  GO

#define ENTRY_CAT_IBSS			0x00020000   -> ADHOC
#define ENTRY_CAT_WDS			0x00040000   -> WDS
#define ENTRY_CAT_MESH			0x00080000   -> MP/MS
#endif
