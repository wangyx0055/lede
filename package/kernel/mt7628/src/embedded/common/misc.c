...
*/
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("TxRxThroughputPerSeconds = %ld Bps, %ld KBps, %ldKbps, %ldMbps", 
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("btWifiThr = %d, TxByteCount = %ld, RxByteCount = %ld",
			WifiThroughputLimit,
			TxByteCount,
			RxByteCount));
	...
	IN UCHAR HistorySize)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,(" ---> Check Busy %ld %ld %ld %ld %ld",
		*History,
		*(History+1),
		*(History+2),
		*(History+3),
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("200000, 200000, 200000, 200000, 200000 ==> Inquiry + other Profiles ... BT lagging .. BUSY_5\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_5; 
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("10000, 10000, 20000, 10000, 10000 ==> Multiple Profile... BUSY_4\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_4;	
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("5000, 5000, 12000, 5000, 5000 ==> BT work ... Jabra BT3030 A2DP Playing Music  ... BUSY_3\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_3;	
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("2000, 2000, 12000, 2000, 2000 ==> BT works ... CSR mouse suddenly moves ... BUSY_2\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_2;
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("1,1,10000,1,1 ==> General Profile .. BUSY_1\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_1;
	}	
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("0,0,40,0,0 ==> Inquiry + other Profiles ... BT lagging .. BUSY_5\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_5; 
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("0,0,33,0,0 ==> Inquiry  .. BUSY_5\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_5; 
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("20,20,20,20,20 ==> Multiple Profile... BUSY_4\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_4;	
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("8,8,8,8,8 ==> BT work ... Jabra BT3030 A2DP Playing Music  ... BUSY_3\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_3;
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("0,0,10,0,0 ==> BT works ... CSR mouse suddenly moves ... BUSY_2\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_2;
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("1,1,3,1,1 ==> BT works ... CSR keyboard typing ... BUSY_2\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_2;
	}
	...
	{
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("0,0,1,0,0 ==> BT idle .. BUSY_1\n"));
#endif /* RELEASE_EXCLUDE */
		return BUSY_1;
	}	
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("ALL BT Profile Disconnected .. BUSY_0"));
#endif /* RELEASE_EXCLUDE */
	return BUSY_0;
}
	...
	IN ULONG			NoBusyTimeCount)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("RSSI = %d\n", Rssi));
	...
	if (IS_ENABLE_LNA_MID_GAIN_DOWN_BY_TIMER(pAd))
	{
				...
				if(pAd->BusyDegree <= BUSY_1)
				{
					if (Rssi <= -45)
					{
						...
						if (Rssi > -72)
						{
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CoBT===> ...........Rssi[  -45 < %2d <= -72].. Set R65 to 0x29", Rssi));
						}
						else
						{
							/* -72 ~-100 High LNA */
							...
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CoBT===> ...........Rssi[  %2d <= -72].. Set R65 to 0x2C", Rssi));
						}
					}
					else
					{
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CoBT===> ...........Rssi[ -35 < %2d ].. Set R65 to 0x25", Rssi));
					}
				}
				else
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CoBT===> ...........Rssi[%2d], BusyDegree[%d > 3].. Set R65 to 0x2C", Rssi, pAd->BusyDegree));
				}
			}
			else
#endif /* RT5390 */
		if (pAd->BusyDegree >= BUSY_1)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Lower LNA Middle Gain at HT20 or HT40\n"));
			...
			/* if RSSI is smaller than -80, then set R65 to High Gain to fix long distance issue */
				if (Rssi <= -80)
				{
					...
					if (BbpR65 == 0x29)
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("Set R65 to 0x2C from 0x29 (Highest LNA)\n"));
				...
				else
				{
					...
					if (BbpR65 == 0x2C)
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("Set R65 to 0x29 from 0x2C (Middle LNA)\n"));
		...
		else
		{
			...
			{	
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Lower LNA Middle Gain at HT20 or HT40 (Highest LNA)\n"));
	...
	if (IS_ENABLE_TX_POWER_DOWN_BY_TIMER(pAd))
	{
...
#endif /* RT5390 */
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Lower Tx Power at HT20 or HT40\n"));
		...
		else
		{
			if (NoBusyTimeCount > IDLE_STATE_THRESHOLD)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Higher Tx Power at HT20 or HT40\n"));
		...
		else
		{
			...
			if(IS_ENABLE_BT_RATE_UP_BY_TIMER(pAd))
			{
				if ((IS_RT3090A(pAd) && (pAd->BusyDegree <= BUSY_4)) || 
					((IS_RT5390BC8(pAd) || IS_RT3592BC8(pAd)) && (pAd->BusyDegree <= BUSY_1)))
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CoBT===> ............. ++ Up Tx Rate at HT20 or HT40\n"));
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CoBT===> ............. OneSecRxOkCnt = %d, Last Rx=%d, Tx=%d\n", 
				...
				if (IS_RT5390BC8(pAd) || IS_RT3592BC8(pAd))
				{
					if ((pAd->BusyDegree <= BUSY_1) && (Rssi < -50) && (pAd->RalinkCounters.OneSecReceivedByteCount > (pAd->RalinkCounters.OneSecTransmittedByteCount + 1000)) && (pAd->CommonCfg.Channel <= 14))
					{
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CoBT===> ............. ++!! Enable TX halt BT\n"));
					}
					else
					{
						RTMP_IO_READ32(pAd, MAC_SYS_CTRL , &MACValue);
				...
				else
				{
					if((pAd->BusyDegree <= BUSY_1) && (pAd->RalinkCounters.OneSecRxOkCnt > 40))
					{
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CoBT===> ............. ++!! Enable Rx Wifi Active\n"));
	...
	if (((pAd->BusyDegree >= WIFI_2040_SWITCH_THRESHOLD) && 
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("HT40 --> HT20\n"));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("ACT - Update2040CoexistFrameAndNotify. BSSCoexist2040 = %x. EventANo = %d. \n", pAd->CommonCfg.BSSCoexist2040.word, pAd->CommonCfg.TriggerEventTab.EventANo));
	...
	INOUT CHAR			*pDeltaPwr)
{
		...
		(pAd->CommonCfg.TxPowerPercentage == 0xffffffff))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">> ++ DeltaPwr =%d, DeltaPowerByBbpR1= %d, RSSI = %d\n",
			DeltaPwr, DeltaPowerByBbpR1, Rssi));

		if (Rssi <= -80)
		{	
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">> -1 75%% power dbm\n"));
			DeltaPowerByBbpR1 = 0;
			DeltaPwr -= 1;
		}
		else if ((Rssi <= -50) && (Rssi >= -60))
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">> -7 18%% power dbm\n"));
		}
		else if ((Rssi <= -60) && (Rssi >= -70))
		{
			DeltaPowerByBbpR1 = -6;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">> -6 25%% power dbm\n"));
		}
		else if ((Rssi <= -70) && (Rssi >= -80)) 
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">> -3 50%% dbm\n"));
			DeltaPowerByBbpR1 = 0;
			DeltaPwr -= 3;
		}
...
*/
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("CurrRateIdx=%d, UpRateIdx=%d, DownRateIdx=%d\n",
...
UCHAR TxBaSizeDown(RTMP_ADAPTER *pAd, UCHAR old_basize)
{
		...
		(pAd->bPermitTxBaSizeDown == TRUE))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">>>>> dynamic BAWinSize = %d, profile AMPDU size=%ld\n", 
...
UCHAR TxBaDensityDown(RTMP_ADAPTER *pAd, UCHAR mpdu_density)
{
		...
		(pAd->bPermitTxBaDensityDown == TRUE))
	{
		...
		*/
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">>>>> dynamic BA density= %d, profile AMPDU density=%ld\n", 
...
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BTCoexistenceOn=%d\n", pAd->bMiscOn));
#endif /* RELEASE_EXCLUDE */
	}
...
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BTConfiguration=0x%04lx\n", pAd->ulConfiguration));
#endif /* RELEASE_EXCLUDE */
	}
}
...
#endif /* RELEASE_EXCLUDE */
		PCIePowerSetting = 2;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("before PCIePower Save Level = %d due to single crystall\n", pAd->StaCfg.PSControl.field.rt30xxPowerMode));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("after PCIePower Save Level = 2 due to single crystall\n"));
...
#ifdef RELEASE_EXCLUDE
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set BT Coexistence detect timer\n"));
#endif /* RELEASE_EXCLUDE */
	}

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("nicConfig2 =0x%04x\n", pAd->NicConfig2.word));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("nicConfig3 =0x%04x\n", pAd->NicConfig3.word));
#ifdef RELEASE_EXCLUDE
#ifdef RTMP_USB_SUPPORT
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("BT Coexistence Method = %d(0=>2-wire, 1=>3-wire)\n", pAd->bCoexMethod));
#endif /* RTMP_USB_SUPPORT */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("BT Configuration = %08lx\n", pAd->ulConfiguration));
#endif /* RELEASE_EXCLUDE */
}
	...
	IN PCmdQElmt CMDQelmt)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, (">>>>> data = 0x%08lx, data_switch=0x%08lx", (data & 0x0000FFFF), data_switch));

	/* About 1 second to check busy from Buletooth history active counter */
	if (TimeCount >= CHECK_TIME_INTERVAL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("<--- WATCH TIME"));	
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("BW=%d, bt active per sec=%ld, No Busy Time Count =%ld",
...
#endif /* RELEASE_EXCLUDE */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("Hardware key OFF!!!!"));

				AsicSendCommandToMcu(pAd, MCU_SET_ACTIVE_POLLING, 0xff , 0x01, 0x02, FALSE);	
			}
			BtHardKeyOffTimeCount++;
			pAd->ulActiveCountPastPeriod = 0;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("ulActiveCountPastPeriod >= 250000, force ulActiveCountPastPeriod = 0"));
		}
		else
		{
			if (BtHardKeyOffTimeCount > 0)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("Hardware key ON!!!!"));
	...
	IN PVOID SystemSpecific3)
{
	...
	{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("error RESET, HALT, RADIO_OFF, NIC_NOT_EXIST"));
				return;
	}
...
do
		...
		else
	{
			...
			OPSTATUS_TEST_FLAG(pAd, fOP_STATUS_DOZE))
		{
			if (pAd->bPCIclkOff == TRUE)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("pAd->bPCIclkOff == TRUE\n"));
			}
			if (RTMP_TEST_PSFLAG(pAd, fRTMP_PS_SET_PCI_CLK_OFF_COMMAND))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("fRTMP_PS_SET_PCI_CLK_OFF_COMMAND == TRUE\n"));
			}
			if (RTMP_TEST_PSFLAG(pAd, fRTMP_ADAPTER_IDLE_RADIO_OFF))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("fRTMP_ADAPTER_IDLE_RADIO_OFF == TRUE\n"));
			}
			if (OPSTATUS_TEST_FLAG(pAd, fOP_STATUS_DOZE))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("fOP_STATUS_DOZE == TRUE\n"));
			}
			bPowerSaving = TRUE;
		...
		if (TimeCount >= CHECK_TIME_INTERVAL)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("<--- WATCH TIME\n"));	
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("-->BW=%d, bt active per sec=%ld, No Busy Time Count =%ld, Very Busy Time Count = %ld, PowerSavingTimeCount =%d\n", 
					pAd->CommonCfg.BBPCurrentBW,
					pAd->ulActiveCountPastPeriod,
					NoBusyTimeCount, 
					VeryBusyTimeCount,
...
*/
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("-->VeryBusyTimeCount = %ld, bIssue4020 = %d\n", VeryBusyTimeCount, bIssue4020));
