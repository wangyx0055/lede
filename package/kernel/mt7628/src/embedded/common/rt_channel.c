...
/*
	Ch 36~48, IDOR per Sporton lab:
		AT, BE, CA, CY, DK, EE, JP, LV, MT, NL, SK, CH, GB, US
	Ch 52~64, IDOR per Sporton lab:
		AT, BE, CY, EE, JP, LV, MT, NL, SK, CH, TW, GB
*/
#endif 
...
#if 0 
	// comment:do we support these channel ? 
	{ 182,	10, 23, BOTH, FALSE},	/*4910~4930MHz, Ch182~185,	Max BW: 10 */
									/*4910~4990MHz, Ch182~196,	Max BW: 40 */
									/*4930~4950MHz, Ch186~189,	Max BW: 10 */				
	{  6,	 4, 23, BOTH, FALSE},	/*5030~5045MHz, Ch6~9,	  Max BW: 10 */
	{  6,	 8, 23, BOTH, FALSE},	/*5030~5090MHz, Ch6~16,  Max BW: 40 */
	{  10,	 3, 23, BOTH, FALSE},	/*5050~5060MHz, Ch10~12,Max BW: 10 */
#endif
	{  36,   4, 20, IDOR, FALSE},	/*5170~5250MHz, Ch 36~48, Max BW: 40 */
	{  52,   4, 20, IDOR, TRUE},	/*5250~5330MHz, Ch 52~64, Max BW: 40 */
