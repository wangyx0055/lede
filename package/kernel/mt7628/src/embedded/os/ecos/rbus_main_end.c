				...
				unsigned long key)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("==>rt_ecos_mbss_send()\n"));
				...
				unsigned long key)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("==>rt_ecos_apcli_send()\n"));
				...
				unsigned long key)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("==>rt_ecos_wds_send()\n"));
