...
//Selective Suspend
#define IOCTL_USB_SUSPEND  \
    CTL_CODE( FILE_DEVICE_UNKNOWN, 0xDa9, METHOD_BUFFERED, FILE_ANY_ACCESS )

#define IOCTL_USB_RESUME  \
    CTL_CODE( FILE_DEVICE_UNKNOWN, 0xDaa, METHOD_BUFFERED, FILE_ANY_ACCESS )
