    ...
    OUT PULONG			ByteCount	)
{
	...
	*ByteCount = 0;
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartRX() RX_ACTION_RX_STOP \n"));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartRX() RX_ACTION_RX_START \n"));
...
//		RTMP_Real_IO_WRITE32(pDevExt, RA_INT_MASK, Value  | INT_Bit_ANY_RxDone );
	...
	{// Query statistic counter and repeat conut
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartRX() RX_ACTION_QUERY ||  RX_ACTION_RESET\n"));
	...
	{// RX_ACTION_SNIFF_START
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartRX() RX_ACTION_SNIFF_START\n"));
...
//		RTMP_Real_IO_WRITE32(pDevExt,RA_INT_MASK, Value  | INT_Bit_ANY_RxDone );
	...
	{// RX_ACTION_SNIFF_STOP
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartRX() RX_ACTION_SNIFF_STOP\n"));
...
//	INTSRC_STRUC				IntSource;
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() StartTx\n"));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() StartTx pDevExt->OtherCounters.TxRepeatCount=%X, minlength=%X, pDevExt->RingType=%X\n",pDevExt->OtherCounters.TxRepeatCount, pDevExt->MinLength, pDevExt->RingType));		
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() type=%X\n",type));		
	if ( type == TX_START)
	{
...
//			value = RTMP_Real_IO_READ32(pDevExt, RA_TX_DTX_IDX12);
		...
		{*/
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() read RA_TX_DTX_IDX0 =0x%X\n",value));		
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() read RA_TX_DTX_IDX1 =0x%X\n",value));		
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("1 FirstTxCount = %d\n", FirstTxCount));
		//}
		...
		/*if (pDevExt->RingType == 0x10)
		{
			...
			if(pDevExt->RingType&0x00000010)
			{
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_Mgmt Own[0x%02x] = 1", (pDevExt->CurMgmtTxIndex)%MGMT_RING_SIZE);
				...
				//if(bNeedBreak == 1)
				//{
				//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FirstTxCount need cnt to zero, check value = 0x%x", FirstTxCount);
				//	goto start_transmit;
				//}			
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurMgmtTxIndex = %x\n", pDevExt->CurMgmtTxIndex);
...
//			RTMP_Real_IO_WRITE32(pDevExt, RA_INT_MASK, value | INT_Bit_ANY_TxDone | INT_Bit_ANY_RxDone);	
		...
		{*/		
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TxRepeatCount = %d\n", pDevExt->OtherCounters.TxRepeatCount));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("2 FirstTxCount = %d\n", FirstTxCount));
		//RING_TYPE_AC0
		if(pDevExt->RingType&0x00000001)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FillSingleRingNum = %d\n", FillSingleRingNum));
			for(i=0; i<FillSingleRingNum ; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC0 Own[0x%02x] = 1", (pDevExt->CurAc0TxIndex)%AC0_RING_SIZE));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: pDevExt->FrameType = %d", pDevExt->FrameType));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: TxDescriptor addr = %x", pDevExt->Ac0RingMain[(pDevExt->CurAc0TxIndex)%AC0_RING_SIZE].AllocVa));
				...
				switch(pDevExt->FrameType)
				{
					case QA_COMBO_FRAME_TYPE_User1_Random_length:
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Random_len: SDL0 = %x\n",TxDescriptor->SDL0));
						break;
		...
		if(pDevExt->RingType&0x00000002)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC1 Own[0x%02x] = 1", (pDevExt->CurAc1TxIndex%AC1_RING_SIZE)  ));
		...
		if(pDevExt->RingType&0x00000004)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC2 Own[0x%02x] = 1", (pDevExt->CurAc2TxIndex)%AC2_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000008)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC3 Own[0x%02x] = 1", (pDevExt->CurAc3TxIndex)%AC3_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000010)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC4 Own[0x%02x] = 1", (pDevExt->CurAc4TxIndex)%AC4_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000020)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC5 Own[0x%02x] = 1", (pDevExt->CurAc5TxIndex)%AC5_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000040)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC6 Own[0x%02x] = 1", (pDevExt->CurAc6TxIndex)%AC6_RING_SIZE));
		...
		{	
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC7 Own[0x%02x] = 1", (pDevExt->CurAc7TxIndex)%AC7_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000100)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC8 Own[0x%02x] = 1", (pDevExt->CurAc8TxIndex)%AC8_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000200)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC9 Own[0x%02x] = 1", (pDevExt->CurAc9TxIndex)%AC9_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000400)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC10 Own[0x%02x] = 1", (pDevExt->CurAc10TxIndex)%AC10_RING_SIZE));
		...
		if(pDevExt->RingType&0x00000800)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_AC11 Own[0x%02x] = 1", (pDevExt->CurAc11TxIndex)%AC11_RING_SIZE));
		...
		if(pDevExt->RingType&0x00002000)
		{
			...
			for(i=0; i<FillSingleRingNum; i++)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RING_TYPE_HCCA Own[0x%02x] = 1", (pDevExt->CurHccaTxIndex)%HCCA_RING_SIZE));
...
//werner debug->
		for(i=0;i<=RING_TYPE_HCCA;i++)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Ring %d  ===========================\n",i));
			if(RING_TYPE_AC0==i)
				pTxWI = (PTX_WI_STRUC) pDevExt->Ac0RingMain[pDevExt->CurAc0TxIndex].DmaBuf.AllocVa;
			...
			ptr = (PULONG)pTxWI;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) TXByteCount=0x%08X= %d\n", pTxWI->TXByteCount,pTxWI->TXByteCount));	
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) DW %d 0x%08X\n",j, *(ptr+j)));
			}
			//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) 0 0x%08X\n", *ptr));
			//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) 1 0x%08X\n", *(ptr+1)));
			//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) 2 0x%08X\n", *(ptr+2)));
			//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) 3 0x%08X\n", *(ptr+3)));	
			//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXD(TXWI) TXByteCount=0x%08X= %d\n", pTxWI->TXByteCount,pTxWI->TXByteCount));		
		}
		...
		if(SchReg4&0x00000020)
		{
			...
			{//short format
				...
				if(pLoopbackTxWI->TXByteCount>= 12)
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s TXByteCount <12, error!!!!!!! \n",__FUNCTION__, *ptr));
...
//werner debug<-
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc0TxIndex = %x\n",pDevExt->CurAc0TxIndex));
		
		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX1,pDevExt->CurAc1TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc1TxIndex = %x\n",pDevExt->CurAc1TxIndex));
		
		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX2,pDevExt->CurAc2TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc2TxIndex = %x\n",pDevExt->CurAc2TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX3,pDevExt->CurAc3TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc3TxIndex = %x\n",pDevExt->CurAc3TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX4,pDevExt->CurAc4TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc4TxIndex = %x\n",pDevExt->CurAc4TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX5,pDevExt->CurAc5TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc5TxIndex = %x\n",pDevExt->CurAc5TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX6,pDevExt->CurAc6TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc6TxIndex = %x\n",pDevExt->CurAc6TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX7,pDevExt->CurAc7TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc7TxIndex = %x\n",pDevExt->CurAc7TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX8,pDevExt->CurAc8TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc8TxIndex = %x\n",pDevExt->CurAc8TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX9,pDevExt->CurAc9TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc9TxIndex = %x\n",pDevExt->CurAc9TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX10,pDevExt->CurAc10TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc10TxIndex = %x\n",pDevExt->CurAc10TxIndex));

		RTMP_Real_IO_WRITE32(pDevExt,RA_TX_CTX_IDX11,pDevExt->CurAc11TxIndex );
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurAc11TxIndex = %x\n",pDevExt->CurAc11TxIndex));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() pDevExt->CurHccaTxIndex = %x\n",pDevExt->CurHccaTxIndex));
...
//		RTMP_Real_IO_WRITE32(pDevExt, RA_INT_MASK, value | INT_Bit_ANY_TxDone | INT_Bit_ANY_RxDone);	
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("TXT: RTPCIStartTX() StopTx\n"));
	...
	IN PVOID pContext)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("--> NICIssueReset\n"));
    ...
    OUT PULONG			ByteCount	)
{
	...
	if(Count > 0)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RTPCIStartSniffer ===> PacketBufferSnifferIdx = %d, Count = %d\n",pDevExt->PacketBufferSnifferIdx - 1, Count));
	}
    ...
    OUT PULONG			ByteCount	)
{
    ...
    ptr = (PCHAR)(pIBuffer);
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Beacon TXWI : ===============\n"));
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("pDevExt->virtualaddr : 0x%08x\n", (PUCHAR)pDevExt->virtualaddr));
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("pDevExt->virtualaddr + HW_BEACON_BASE0 : 0x%08x\n", (PUCHAR)pDevExt->virtualaddr + HW_BEACON_BASE0));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Beacon Frame : ===============\n"));
