...
/*					RTMP_OS_NETDEV_GET_DEVNAME(pAd->net_dev), pTask->taskName)); */
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("kill command task failed!\n"));
		}
...
/*		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: kill task(%s) failed!\n", */
/*					RTMP_OS_NETDEV_GET_DEVNAME(pAd->net_dev), pTask->taskName)); */
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("kill timer task failed!\n"));
	}
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("--->WMM1 RTUSBBulkOutDataPacketComplete\n"));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("--->rtusb_pspoll_frame_complete_tasklet\n"));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("--->rtusb_mgmt_dma_done_tasklet\n"));
#endif /* RELEASE_EXCLUDE */
...
/*	pHTTXContext	= (PHT_TX_CONTEXT)pUrb->context; */
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: au4ACQTxNum(%d, %d, %d, %d, %d)\n",
							__FUNCTION__,
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("--->wmm1 ac0_dma_done_tasklet\n"));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("--->ac0_dma_done_tasklet\n"));
#endif /* RELEASE_EXCLUDE */
...
static void rtusb_bcn_dma_done_tasklet(unsigned long data)
{
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("--->rtusb_bcn_dma_done_tasklet\n"));
#endif /* RELEASE_EXCLUDE */
	...
	if (Status != USB_ST_NOERROR)
	{
		...
		if ((!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_RESET_IN_PROGRESS)) &&
			...
			(!RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_BULKOUT_RESET)))
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("Bulk Out BCN Failed, Status=%d!\n", Status));
			RTMP_SET_FLAG(pAd, fRTMP_ADAPTER_BULKOUT_RESET);
			pAd->bulkResetPipeid = (MGMTPIPEIDX | BULKOUT_MGMT_RESET_FLAG);
		}
	}
...
#ifdef RELEASE_EXCLUDE
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pAd->ATECtrl.TxDoneCount == %d\n", pAd->ATECtrl.TxDoneCount));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->pAd = 0x%lx\n", (ULONG)&pNullContext->pAd));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->pUrb = 0x%lx\n", (ULONG)&pNullContext->pUrb));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->TransferBuffer = 0x%lx\n", (ULONG)&pNullContext->TransferBuffer));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->BulkOutPipeId = %d\n", pNullContext->BulkOutPipeId));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->BulkOutSize = %ld\n", pNullContext->BulkOutSize));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->InUse = %d\n", (pNullContext->InUse==TRUE)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->bWaitingBulkOut = %d\n", (pNullContext->bWaitingBulkOut==TRUE)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->IRPPending = %d\n", (pNullContext->IRPPending==TRUE)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pNullContext->LastOne = %d\n", (pNullContext->LastOne==TRUE)));
#endif /* RELEASE_EXCLUDE */
	...
	IN ULONG Context)
{
	...
	*/
	 ...
	 */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,( "<---RTUSBCmdThread\n"));
...
void InitUSBDevice(RT_CMD_USB_INIT *config, VOID *ad_src)
{
	...
	if (ad->UsbVendorReqBuf == NULL) {
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Allocate vendor request temp buffer failed!\n"));
		return;
	}
