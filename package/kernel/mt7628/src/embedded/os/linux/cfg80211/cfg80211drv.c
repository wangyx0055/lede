		...
		BOOLEAN                                          isReg)
{
	...
	DBGPRINT(RT_DEBUG_TRACE, ("[%d] pAd->Cfg80211RegisterProbeReqFrame=%d[%d]\n", 
	...
	VOID						*pData)
{
	...
	if (pKeyInfo->KeyType == RT_CMD_80211_KEY_WEP40 || pKeyInfo->KeyType == RT_CMD_80211_KEY_WEP104)
	{
		...
		DBGPRINT(RT_DEBUG_TRACE, ("RT_CMD_80211_KEY_WEP ==> Id:%d, Type:%d, Len:%d bPair:(%d)\n", 
	...
	{
		DBGPRINT(RT_DEBUG_TRACE, ("Set_WPAPSK_Proc ==> id:%d, type:%d, len:%d\n", 
