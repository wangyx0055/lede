...
Revision History:
    ...
    JRuan Dec 14, 2001      Created

    JRuan Apr 9, 2003       Cleanup
...
typedef enum {
    DOT11_CTRL_SUBTYPE_BLOCK_ACK_REQ = 8, // Block Ack Request
    DOT11_CTRL_SUBTYPE_BLOCK_ACK = 9,  // Block Ack
...
typedef enum {
    ...
    DOT11_DATA_SUBTYPE_QOS_CFACK = 9,       // QoS Data CF ACK
    DOT11_DATA_SUBTYPE_QOS_CFPOLL = 10,     // QoS Data + CF-Poll
    DOT11_DATA_SUBTYPE_QOS_CFACK_CFPOLL = 11, //QoS Data + CF-Ack + CF-Poll
    DOT11_DATA_SUBTYPE_QOS_NULL = 12,       // QOS NULL
...
//
typedef enum {
    DOT11_MGMT_EXTEND_SPECTRUM = 0,        // Spectrum management
    DOT11_MGMT_EXTEND_QOS = 1,             // QOS
    DOT11_MGMT_EXTEND_DLS = 2,             // DLS
    DOT11_MGMT_EXTEND_BA = 3,              // Block Ack
    DOT11_MGMT_EXTEND_HT = 7,              // HT
} DOT11_MGMT_EXTEND_TYPE, *PDOT11_MGMT_EXTEND_TYPE;

typedef enum {
    DOT11_BA_ACTION_ADDBA_REQUEST = 0,     // ADDBA Request
    DOT11_BA_ACTION_ADDBA_RESPONSE = 1,    // ADDBA Response     
    DOT11_BA_ACTION_DELBA = 2,             // DELBA
} DOT11_BA_ACTION_CODE, *PDOT11_BA_ACTION_CODE;
...
typedef struct _DOT11_ACTION_FRAME {
    UCHAR                   Category;
    UCHAR                   Action;
    UCHAR                   Data[1];
} DOT11_ACTION_FRAME, *PDOT11_ACTION_FRAME;

//
// RTS frame header
//
typedef struct DOT11_RTS_HEADER {
    DOT11_FRAME_CTRL        FrameControl;
    USHORT                  DurationID;
    DOT11_MAC_ADDRESS       Address1;
    DOT11_MAC_ADDRESS       Address2;
} DOT11_RTS_HEADER, *PDOT11_RTS_HEADER;
...
#define DOT11_INFO_ELEMENT_ID_CHANNEL_ANNOUNCEMENT  37
#define DOT11_INFO_ELEMENT_ID_ERP                   42
#define DOT11_INFO_ELEMENT_ID_HT_CAPABILITY         45
...
#define DOT11_INFO_ELEMENT_ID_NEW_EXT_CHA_OFFSET    62
#define DOT11_INFO_ELEMENT_ID_CCX_AIRONET_CKIP      133
#define DOT11_INFO_ELEMENT_ID_CCX_TX_POWER          150
...
#define DOT11_MGMT_REASON_RESERVED                      0
...
#define DOT11_MGMT_REASON_DECLINED                      37
//
...
typedef struct _DOT11_ASSOC_REQUEST_FRAME {
    DOT11_CAPABILITY Capability;
