...
extern void mt76x0_band_select(PRTMP_ADAPTER pAd, UCHAR channel);
extern VOID mt76x0_set_rf_ch_freq_prm(PRTMP_ADAPTER pAd, UCHAR Channel);
    ...
    IN PRTMP_ADAPTER pAd)
{
	...
	*/
	...
	if (1 /* Channel != last_channel */)
	{
		MT76x0ATE_Calibration(pAd, Channel, TRUE, TRUE);
	}

	/* must not remove it */
	last_channel = Channel; /* Channel latch */
	RtmpusecDelay(1000);
...
/*	UCHAR Channel = pATEInfo->Channel; */
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s : (TxPower%d=%d)\n", __FUNCTION__, index, TxPower));
	...
	if (pATEInfo->bAutoTxAlc == FALSE)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("bw_power_delta=%d, MAC 0x13B4 is 0x%08x\n", bw_power_delta, MacValue));
	}
#endif /* MT76x0_TSSI_CAL_COMPENSATION */
...
/* 
	...
	==========================================================================
*/
static INT	MT76x0_Set_ATE_TX_BW_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	PATE_INFO pATEInfo = &(pAd->ate);
	UCHAR BBPCurrentBW;
...
/* 
	...
	==========================================================================
*/
static INT	MT76x0_Set_ATE_TX_FREQ_OFFSET_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	PATE_INFO pATEInfo = &(pAd->ate);
...
extern INT16 MT76xx_lin2dBd(IN unsigned short linearValue);
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[0].MCS_Power = %d\n", AteTssiTable.CCK[0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[1].MCS_Power = %d\n", AteTssiTable.CCK[1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[2].MCS_Power = %d\n", AteTssiTable.CCK[2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[3].MCS_Power = %d\n", AteTssiTable.CCK[3].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[0].MCS_Power = %d\n", AteTssiTable.OFDM[0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[1].MCS_Power = %d\n", AteTssiTable.OFDM[1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[2].MCS_Power = %d\n", AteTssiTable.OFDM[2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[3].MCS_Power = %d\n", AteTssiTable.OFDM[3].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[4].MCS_Power = %d\n", AteTssiTable.OFDM[4].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[5].MCS_Power = %d\n", AteTssiTable.OFDM[5].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[6].MCS_Power = %d\n", AteTssiTable.OFDM[6].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[7].MCS_Power = %d\n", AteTssiTable.OFDM[7].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[0].MCS_Power = %d\n", AteTssiTable.STBC[0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[1].MCS_Power = %d\n", AteTssiTable.STBC[1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[2].MCS_Power = %d\n", AteTssiTable.STBC[2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[3].MCS_Power = %d\n", AteTssiTable.STBC[3].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[4].MCS_Power = %d\n", AteTssiTable.STBC[4].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[5].MCS_Power = %d\n", AteTssiTable.STBC[5].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[6].MCS_Power = %d\n", AteTssiTable.STBC[6].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[7].MCS_Power = %d\n", AteTssiTable.STBC[7].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[0].MCS_Power = %d\n", AteTssiTable.HT[0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[1].MCS_Power = %d\n", AteTssiTable.HT[1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[2].MCS_Power = %d\n", AteTssiTable.HT[2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[3].MCS_Power = %d\n", AteTssiTable.HT[3].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[4].MCS_Power = %d\n", AteTssiTable.HT[4].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[5].MCS_Power = %d\n", AteTssiTable.HT[5].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[6].MCS_Power = %d\n", AteTssiTable.HT[6].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[7].MCS_Power = %d\n", AteTssiTable.HT[7].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[8].MCS_Power = %d\n", AteTssiTable.HT[8].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[9].MCS_Power = %d\n", AteTssiTable.HT[9].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[10].MCS_Power = %d\n", AteTssiTable.HT[10].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[11].MCS_Power = %d\n", AteTssiTable.HT[11].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[12].MCS_Power = %d\n", AteTssiTable.HT[12].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[13].MCS_Power = %d\n", AteTssiTable.HT[13].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[14].MCS_Power = %d\n", AteTssiTable.HT[14].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[15].MCS_Power = %d\n", AteTssiTable.HT[15].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][0].MCS_Power = %d\n", AteTssiTable.VHT[0][0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][1].MCS_Power = %d\n", AteTssiTable.VHT[0][1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][2].MCS_Power = %d\n", AteTssiTable.VHT[0][2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][3].MCS_Power = %d\n", AteTssiTable.VHT[0][3].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][4].MCS_Power = %d\n", AteTssiTable.VHT[0][4].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][5].MCS_Power = %d\n", AteTssiTable.VHT[0][5].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][6].MCS_Power = %d\n", AteTssiTable.VHT[0][6].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][7].MCS_Power = %d\n", AteTssiTable.VHT[0][7].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][8].MCS_Power = %d\n", AteTssiTable.VHT[0][8].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][9].MCS_Power = %d\n", AteTssiTable.VHT[0][9].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][0].MCS_Power = %d\n", AteTssiTable.VHT[1][0].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][1].MCS_Power = %d\n", AteTssiTable.VHT[1][1].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][2].MCS_Power = %d\n", AteTssiTable.VHT[1][2].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][3].MCS_Power = %d\n", AteTssiTable.VHT[1][3].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][4].MCS_Power = %d\n", AteTssiTable.VHT[1][4].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][5].MCS_Power = %d\n", AteTssiTable.VHT[1][5].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][6].MCS_Power = %d\n", AteTssiTable.VHT[1][6].MCS_Power));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][7].MCS_Power = %d\n", AteTssiTable.VHT[1][7].MCS_Power));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.MCS32.MCS_Power = %d\n", AteTssiTable.MCS32.MCS_Power));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[0].RF_PA_Mode = %d\n", AteTssiTable.CCK[0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[1].RF_PA_Mode = %d\n", AteTssiTable.CCK[1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[2].RF_PA_Mode = %d\n", AteTssiTable.CCK[2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.CCK[3].RF_PA_Mode = %d\n", AteTssiTable.CCK[3].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[0].RF_PA_Mode = %d\n", AteTssiTable.OFDM[0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[1].RF_PA_Mode = %d\n", AteTssiTable.OFDM[1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[2].RF_PA_Mode = %d\n", AteTssiTable.OFDM[2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[3].RF_PA_Mode = %d\n", AteTssiTable.OFDM[3].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[4].RF_PA_Mode = %d\n", AteTssiTable.OFDM[4].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[5].RF_PA_Mode = %d\n", AteTssiTable.OFDM[5].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[6].RF_PA_Mode = %d\n", AteTssiTable.OFDM[6].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.OFDM[7].RF_PA_Mode = %d\n", AteTssiTable.OFDM[7].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[0].RF_PA_Mode = %d\n", AteTssiTable.STBC[0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[1].RF_PA_Mode = %d\n", AteTssiTable.STBC[1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[2].RF_PA_Mode = %d\n", AteTssiTable.STBC[2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[3].RF_PA_Mode = %d\n", AteTssiTable.STBC[3].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[4].RF_PA_Mode = %d\n", AteTssiTable.STBC[4].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[5].RF_PA_Mode = %d\n", AteTssiTable.STBC[5].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[6].RF_PA_Mode = %d\n", AteTssiTable.STBC[6].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.STBC[7].RF_PA_Mode = %d\n", AteTssiTable.STBC[7].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[0].RF_PA_Mode = %d\n", AteTssiTable.HT[0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[1].RF_PA_Mode = %d\n", AteTssiTable.HT[1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[2].RF_PA_Mode = %d\n", AteTssiTable.HT[2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[3].RF_PA_Mode = %d\n", AteTssiTable.HT[3].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[4].RF_PA_Mode = %d\n", AteTssiTable.HT[4].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[5].RF_PA_Mode = %d\n", AteTssiTable.HT[5].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[6].RF_PA_Mode = %d\n", AteTssiTable.HT[6].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[7].RF_PA_Mode = %d\n", AteTssiTable.HT[7].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[8].RF_PA_Mode = %d\n", AteTssiTable.HT[8].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[9].RF_PA_Mode = %d\n", AteTssiTable.HT[9].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[10].RF_PA_Mode = %d\n", AteTssiTable.HT[10].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[11].RF_PA_Mode = %d\n", AteTssiTable.HT[11].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[12].RF_PA_Mode = %d\n", AteTssiTable.HT[12].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[13].RF_PA_Mode = %d\n", AteTssiTable.HT[13].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[14].RF_PA_Mode = %d\n", AteTssiTable.HT[14].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.HT[15].RF_PA_Mode = %d\n", AteTssiTable.HT[15].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][0].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][1].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][2].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][3].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][3].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][4].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][4].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][5].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][5].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][6].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][6].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[0][7].RF_PA_Mode = %d\n", AteTssiTable.VHT[0][7].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][0].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][0].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][1].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][1].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][2].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][2].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][3].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][3].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][4].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][4].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][5].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][5].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][6].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][6].RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.VHT[1][7].RF_PA_Mode = %d\n", AteTssiTable.VHT[1][7].RF_PA_Mode));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ATE TSSI: AteTssiTable.MCS32.RF_PA_Mode = %d\n", AteTssiTable.MCS32.RF_PA_Mode));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	if (TSSI_Tx_Mode == 0)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> CCK Mode :: TargetPower0 = %d\n", TargetPower0));
	}
	else if (TSSI_Tx_Mode == 1)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> OFDM Mode :: TargetPower0 = %d\n", TargetPower0));
	}
	...
	else
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> HT Mode :: TargetPower0 = %d\n", TargetPower0));
	}
	...
	OUT INT32 *tssi_delta0)
{
	...
	if (pATEInfo->Channel > 14)
	{
		for (idx = 0; idx < 7; idx++)
		{
				...
				|| (pAd->chipCap.tssi_5G_channel_boundary[idx] == 0))
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_5G_channel_boundary[%d] = %d\n", idx, pAd->chipCap.tssi_5G_channel_boundary[idx]));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_slope_5G[%d] = %d\n", idx, pAd->chipCap.tssi_slope_5G[idx]));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_offset_5G[%d] = %d\n", idx, pAd->chipCap.tssi_offset_5G[idx]));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_slope = %d\n", tssi_slope0));
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_offset = %d\n", tssi_offset0));
				break;
			}
		}
		if (idx == 7)
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> 1) tssi_offset0 = %d (0x%x)\n", tssi_offset0, tssi_offset0));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> EstimateDeltaPower\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TargetPower0 = %d\n", TargetPower0));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TSSI_Linear0 = %d\n", TSSI_Linear0));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> Current_TSSI_DC = %d\n", Current_TSSI_DC));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_slope0 = %d\n", tssi_slope0));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_offset0 = %d\n", tssi_offset0));

	/* d. */
	/* Cal delta0 */
	tssi_target = TargetPower0 << 12;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = TargetPower0*4096) = %d\n", tssi_target));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TargetPA_mode0 = %d\n", TargetPA_mode0));

	switch (TargetPA_mode0)
	{
		case 0: 
			tssi_target = tssi_target;
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = tssi_target) = %d\n", tssi_target));
			break;
		case 1: 
			if (pATEInfo->Channel > 14)
			{
				tssi_target = tssi_target + 0;
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = tssi_target + 0) = %d\n", tssi_target));
			}
			else
			{
				tssi_target = tssi_target + 29491; /* 3.6 * 8192 */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = tssi_target + 29491) = %d\n", tssi_target));
			}
			break;
		default: 
			tssi_target = tssi_target +  4424; /* 0.54 * 8192 */
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = tssi_target +  4424) = %d\n", tssi_target));
			break;
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TXBE_R4 = 0x%X\n", BBP_Value));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> bbp_6db_power = %d\n", bbp_6db_power));
	tssi_target = tssi_target + bbp_6db_power;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> (tssi_target = tssi_target + bbp_6db_power) = %d\n", tssi_target));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_target = %f\n", tssi_target / 8192));
	tssi_dc = Current_TSSI_DC;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TSSI_Linear0 = %d\n", TSSI_Linear0)); 
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_dc = %d\n", tssi_dc)); 
	tssi_meas = MT76xx_lin2dBd((TSSI_Linear0 - tssi_dc));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> Linear to dB = %d\n", tssi_meas)); 

	tssi_meas = tssi_meas *tssi_slope0;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> dB x slope = %d\n", tssi_meas));

	if (pATEInfo->Channel > 14)
		tssi_meas += ((tssi_offset0 - 50) << 10); /* 5G: offset s4.3 */
	else
		tssi_meas += (tssi_offset0 << 9); /* 2G: offset s3.4 */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> measure db = %d %f\n", tssi_meas, tssi_meas/8192));

	tssi_delta_tmp = tssi_target - tssi_meas;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> delta db = %d\n", tssi_delta_tmp));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TSSI_Linear0 = %d\n", TSSI_Linear0));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_delta_tmp = %d\n", tssi_delta_tmp));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> TSSI_DELTA_PRE = %d\n", TSSI_DELTA_PRE));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> tssi_delta_tmp = %d\n", tssi_delta_tmp));
	...
	*tssi_delta0 = *tssi_delta0 + tssi_delta_tmp;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("==> *tssi_delta0 = %d\n", *tssi_delta0));
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("(0x13B4) Before compensation 0x%08X\n", MAC_Value));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("(0x13B4) After compensation 0x%08X\n", MAC_Value));
	...
	IN  RTMP_ADAPTER *pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s(): Current_TSSI_DC = %d\n", __FUNCTION__, pAd->chipCap.tssi_current_DC));
}
	...
	IN BOOLEAN bForDcCal)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : CORE_R35 = 0x%X\n", BBP_Value));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : TSSI_Linear0 = (CHAR)(BBP_Value&0xFF) = 0x%X\n"
		, TSSI_Linear0));

	if (pATEInfo->Channel > 14)
	{
		TSSI_Linear0 = TSSI_Linear0 + 128; /* 5G: add total TSSI readings by 128 */
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : TSSI_Linear0 = TSSI_Linear0 + 128 = 0x%X\n"
			, TSSI_Linear0));
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : TSSI_Linear0 = 0x%X\n", TSSI_Linear0));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : INFO_1 = 0x%X\n", INFO_1));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : INFO_2 = 0x%X\n", INFO_2));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Enable9BitIchannelADC : INFO_3 = 0x%X\n", INFO_3));
	...
	IN PRTMP_ADAPTER pAd) 
{
	...
	if ((pATEInfo->Channel > 14) || (BandWidthSel == BW_80))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("channel = %d, bandwidth = %d\n"
				, pATEInfo->Channel, BandWidthSel));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("only support DPD calibration for 2.4G band\n"));
		return;	
	}
        ...
        IN PRTMP_ADAPTER pAd) 
{
	...
	if (IS_MT7630(pAd))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("error - 7630: Channel = %d\n", pATEInfo->Channel));
		return;
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s(): base_power is %d\n", __FUNCTION__, base_power));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Offset = 0x13D4, TxPwr = 0x%08X, Offset = 0x13DC, TxPwr = 0x%08X\n", 
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	if (Mode == 0x30)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s - Calibration Mode: Open loop, closed loop, and amplitude\n", __FUNCTION__));
		/*
	...
	IN BOOLEAN bFullCal)
{
	...
	BOOLEAN bTTR = TRUE; /* pAd->ate.bTestTimeReduction; */
	...
	if (IS_MT7610(pAd))
	{
		if (Channel <= 14)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("error - 7610: Channel = %d\n", Channel));
			return;
		}
	}
	...
	if (IS_MT7630(pAd))
	{
		if (Channel > 14)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("error - 7630: Channel = %d\n", Channel));
			return;
		}
	}

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s - Channel = %d, bPowerOn = %d, bFullCal = %d\n", __FUNCTION__, Channel, bPowerOn, bFullCal));
	...
	*/
	if (bFullCal)
	{
		if (Channel > 14)
		{
			...
			if (Channel < 100)
				_param2 = (bTTR == TRUE) ? 0x7 : 0x0;
			else if (Channel < 140)
				_param2 = (bTTR == TRUE) ? 0x8 : 0x0;
			else
				_param2 = (bTTR == TRUE) ? 0x9 : 0x0;
		}
		else
		{
	...
	*/
	...
	if (bTTR == TRUE)
	{
		RtmpusecDelay(2000); // TODO: check response packet from FW
	}
	else
	{
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx20MPwrCfgGBand[0] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgGBand[0] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgGBand[1] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgGBand[2] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgGBand[3] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx20MPwrCfgABand[0] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgABand[0] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgABand[1] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgABand[2] = 0x%X\n", __FUNCTION__, data));
	...
	*/
	...
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx40MPwrCfgABand[3] = 0x%X\n", __FUNCTION__, data));
...
#endif /* DOT11_VHT_AC */
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("%s: Tx80MPwrCfgABand[0] = 0x%X\n", __FUNCTION__, data));
	...
	IN RTMP_ADAPTER *pAd)
{
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: 0x22 = 0x%x\n", __FUNCTION__, ee_val));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: 0x24 = 0x%x\n", __FUNCTION__, ee_val));
...
#ifdef RTMP_MAC_USB
struct _ATE_CHIP_STRUCT RALINK6570 =
{
	/* functions */
	.ChannelSwitch = NULL,
	.TxPwrHandler = NULL,
