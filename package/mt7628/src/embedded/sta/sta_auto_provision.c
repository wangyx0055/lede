    ...
    IN PVOID SystemSpecific3)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("!!! AutoProvisionScanTimeOutAction !!!\n"));
	...
	if (pAd != NULL)
	{
		...
		if (pAd->Mlme.CntlMachine.CurrState != CNTL_IDLE)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("!!! MLME busy, reset MLME state machine !!!\n"));
		}
						
		ApCount = AutoProvisionTableSort(pAd, BSS_INFRA);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s:: %d Candidates\n", __FUNCTION__, ApCount));
    ...
    IN PVOID SystemSpecific3)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("InfraConnectionTimeout\n"));
    ...
    IN PVOID SystemSpecific3) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("AdhocConnectionTimeout\n"));
