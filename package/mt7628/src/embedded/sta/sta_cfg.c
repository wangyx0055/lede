...
INT	 Set_WscConfMode_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (pAd->StaCfg.BssType == BSS_ADHOC)
	{
		...
		if ( simple_strtol(arg, 0, 10) == 1)
			...
			return FALSE;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF(ra0) Set_WscConfMode_Proc::(IWscConfMode=%d)\n", pIWscInfo->IWscConfMode));
	}
#endif /* IWSC_TEST_SUPPORT */
#endif /* IWSC_SUPPORT */
...
INT	Set_WscGetConf_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if (pAd->StaCfg.BssType == BSS_ADHOC)
	{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Empty Available IPv4 Submask List. Cannot be Registrar\n"));
		...
		if( (dataLen > 0) && (dataLen <= 1024))
		{
			if (pWscControl->WpsVendorExt[index].pData == NULL)
			{
				...
				if (pWscControl->WpsVendorExt[index].pData == NULL)
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_WscVendorExtension_Proc:: Allocate failed!\n"));
					if (WscVendorEx_Str)
						os_free_mem(pAd, WscVendorEx_Str);
					if (WscVnedorEx_Hex)
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("woody2 Set_WscVendorExtension_Proc:: index = %d - (%d)\n", index, dataLen));
		}
		else
		{
			if (pWscControl->WpsVendorExt[index].pData)
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_WscVendorExtension_Proc:: free vendor extension\n"));
			}
		}
	}
	else
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_WscVendorExtension_Proc:: un-support MsgType = 0x%X\n", MsgType));
		if (WscVendorEx_Str)
			os_free_mem(pAd, WscVendorEx_Str);
		if (WscVnedorEx_Hex)
			os_free_mem(pAd, WscVnedorEx_Hex);
...
INT Set_WscPriorityCtrl_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF Set_WpsPriorityCtrl_Proc::(bPriorityCtrl=%d)\n", pAd->StaCfg.bPriorityCtrl));
	return TRUE;
}
...
INT Set_WscPbcExtraScanCount_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF Set_WscPbcExtraScanCount_Proc::(WscPbcExtraScanCount=%d)\n", pAd->StaCfg.WscPbcExtraScanCount));
	return TRUE;
}
#endif /* DPA_T */
...
INT	Set_IWscLimitedUI_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_IWscLimitedUI_Proc::(bLimitedUI=%d)\n",  pAd->StaCfg.IWscInfo.bLimitedUI));
	return TRUE;
}
...
INT	Set_IWscDefaultSecurity_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	if ((TmpValue != 0) && (TmpValue <= 3))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::(IWscDefaultSecurity=%d)\n", __FUNCTION__, pAd->StaCfg.IWscInfo.IWscDefaultSecurity));
		return TRUE;
	}
	else
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::(Value=%d)\n", __FUNCTION__, TmpValue));
		return FALSE;
	}
}
...
INT	Set_IWscOOB_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_IWscOOB_Proc\n"));
	return TRUE;
}
...
INT	Set_IWscSinglePIN_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_IWscSinglePIN_Proc::(bSinglePIN=%d)\n",  pAd->StaCfg.IWscInfo.bSinglePIN));
	return TRUE;
}
#endif /* IWSC_SUPPORT */
...
VOID RTMPAddKey(RTMP_ADAPTER *pAd, PNDIS_802_11_KEY pKey)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("<------ RTMPAddKey\n"));
...
INT Set_AutoProvision_Enable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF Set_AutoProvision_Enable_Proc::(bEnable=%d)\n", pEasyConfig->bEnable));
	return TRUE;
}
...
INT Set_ChangeMode_Enable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF Set_ChangeMode_Enable_Proc::(bChangeMode=%d)\n", pEasyConfig->bChangeMode));
	return TRUE;
}
...
INT Set_WACEnable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_WACEnable_Proc::(bEnableWAC=%d)\n", pEasyConfig->bEnableWAC));
...
INT Set_DoAutoWAC_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set_DoAutoWAC_Proc::(DoAutoWAC=%d)\n", pEasyConfig->DoAutoWAC));
	return TRUE;
}
#endif /* WAC_SUPPORT */
#endif /* STA_EASY_CONFIG_SETUP */
	...
	IN	UCHAR				ScanType)
{
	...
	*/
	if ((pAd->RalinkCounters.LastOneSecTotalTxCount < 20)
		...
		&& (pAd->StaCfg.BssNr < 10))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set:: TxCnt = %d . RxOkCnt = %d.  SsidLen = %d\n",
...
INT Set_WiDiEnable_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IF Set_WiDiEnable_Proc::(bWIDI=%d)\n", pAd->StaCfg.bWIDI));
	return TRUE;
}
#endif
...
/*                pConfig = &Config; */
		...
		case RT_OID_802_11_SET_TDLS_PARAM:
			...
			else
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set::RT_OID_802_11_SET_TDLS_PARAM \n"));
			}
			break;
#endif /* DOT11Z_TDLS_SUPPORT */
		...
		case RT_OID_WSC_AUTO_PROVISION:
            ...
            else
            {
				...
				if (bEnable)
				{
				    ...
				    RTMP_MLME_HANDLER(pAd);
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT_OID_WSC_AUTO_PROVISION\n"));
				}
				else
				{
...
/*            	UCHAR Bssid[MAC_ADDR_LEN] = {0}; */
				...
				MlmeEnqueue(pAd,
							...
							pAd->StaCfg.WscControl.WscBssid, 0);
				RTMP_MLME_HANDLER(pAd);
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT_OID_WSC_AUTO_PROVISION_WITH_SSID, pAd->MlmeAux.Channel = %d\n", pAd->MlmeAux.Channel));
            }
			break;
#endif /* STA_EASY_CONFIG_SETUP */
#endif /* WSC_STA_SUPPORT */
		...
		case OID_802_11_MESH_CHANNEL_BW:
			...
			}
			{
				...
				{
					pAd->CommonCfg.RegTransmitSetting.field.BW = BW_20;
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("40MHz BW in not valid in Legacy mode\n"));
					Status = -EINVAL;
					break;
				}
#ifdef DOT11_N_SUPPORT
				SetCommonHT(pAd);
#endif /* DOT11_N_SUPPORT */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set::OID_802_11_MESH_CHANNEL_BW (=%d)\n", pAd->CommonCfg.RegTransmitSetting.field.BW));
			}
			break;
		...
		case OID_802_11_MESH_CHANNEL_OFFSET:
			...
			}
			{
				...
				if (!WMODE_CAP_N(pAd->CommonCfg.PhyMode))
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Channel offset in not valid in Legacy mode\n"));
					Status = -EINVAL;
					break;
				}
				...
				SetCommonHT(pAd);
#endif /* DOT11_N_SUPPORT */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set::OID_802_11_MESH_CHANNEL_OFFSET (=%d)\n", pAd->CommonCfg.RegTransmitSetting.field.EXTCHA));
			}
			break;
...
#ifdef RELEASE_EXCLUDE
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Set::OID_802_11_MCAST_KEY_INFO\n"));
#endif /* RELEASE_EXCLUDE */
        ...
        case RT_OID_INTEL_WIDI:
			if (pAd->StaCfg.bWIDI)
			{
				...
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set::RT_OID_INTEL_WIDI : len=(%d) not correct!\n", wrq->u.data.length));
					Status = -EINVAL;
					break;
				}
				else
				{
					...
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set::RT_OID_INTEL_WIDI : Invalid msg_type(%d) received!\n", msg.type));
						Status = -EINVAL;
						break;
					}
					NdisZeroMemory(&Ssid, sizeof(NDIS_802_11_SSID));
        ...
        case RT_OID_WSC_GEN_PIN_CODE:
			if (wrq->u.data.length != 1)
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set::RT_OID_WSC_GEN_PIN_CODE : len=(%d) not correct!\n", wrq->u.data.length));
				Status = -EINVAL;
				break;
			}
			else
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set::RT_OID_WSC_GEN_PIN_CODE (=%d)\n", Enable));
			}
	        break;
#ifdef INTEL_WFD_SUPPORT
			...
			else
			{
				...
				if (pWidiP2pEdid)
				{
						...
						(pWidiP2pEdid->type == WIDI_MSG_TYPE_EDID))
					{
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set::RT_OID_INTEL_P2P_EDID - [%d, %d, %d, %d, %d, %d]\n",
							pAd->mfg_code,
							pAd->prod_code,
							pAd->serial_num,
							pAd->cap_flag,
					...
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Set::RT_OID_INTEL_P2P_EDID - Invalid msg_type code received from application!\n"));
						Status  = -EINVAL;
					}
...
ACM_BANDWIDTH_INFO BwInfo, *pInfo;
		...
		case RT_OID_802_11_STREAM_SNR:
			{
				...
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Query::RT_OID_802_11_STR_SNR(0x=%ld, %ld)\n", StreamSnr[0], StreamSnr[1]));
			}
			break;
	...
	case RT_OID_802_11_QUERY_TXBF_TABLE:
        ...
        case OID_GEN_RCV_OK:
#ifdef RELEASE_EXCLUDE
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Query::OID_GEN_RCV_OK \n"));
#endif /* RELEASE_EXCLUDE */
...
#ifdef RELEASE_EXCLUDE
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Query::OID_GEN_RCV_NO_BUFFER \n"));
#endif /* RELEASE_EXCLUDE */
		...
		case RT_OID_WMM_ACM_BandWidth:
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query::RT_OID_WMM_ACM_BandWidth \n"));
			break;
		}
		...
		*/
		case RT_OID_802_11_QUERY_WFD_TDLS_CONNECT_STATUS:
			{
				...
				if (pAd->StaCfg.WfdCfg.PeerPC == WFD_PC_P2P)
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("RT_OID_802_11_QUERY_WFD_TDLS_CONNECT_STATUS::Peer WFD PC is P2P!\n"));
				}
				else if (pAd->StaCfg.WfdCfg.TdlsSecurity == WFD_TDLS_WEAK_SECURITY)
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("RT_OID_802_11_QUERY_WFD_TDLS_CONNECT_STATUS::TDLS weak security!\n"));
				}
				else
				{
					...
					if (bFound == TDLS_LINKED)
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("RT_OID_802_11_QUERY_WFD_TDLS_CONNECT_STATUS:: TDLS Connected!\n"));
				}
				wrq->u.data.length = sizeof(UCHAR);
		...
		case RT_OID_802_11_QUERY_WFD_TDLS_PEER_IP_ADDR:
			{
				...
				for (i=0; i<MAX_NUM_OF_TDLS_ENTRY; i++)
				{
					if ((pAd->StaCfg.TdlsInfo.TDLSEntry[i].Valid) && (pAd->StaCfg.TdlsInfo.TDLSEntry[i].Status == TDLS_MODE_CONNECTED))
					{
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Peer IP Addr = %d.%d.%d.%d\n",
		...
		case OID_AUTO_PROVISION_BSSID_LIST:
            ...
            if (RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_BSS_SCAN_IN_PROGRESS))
            {
            	 ...
            	 */
            	pAd->StaCfg.bSkipAutoScanConn = TRUE;
            	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query::OID_AUTO_PROVISION_BSSID_LIST (Still scanning)\n"));
				return -EAGAIN;
            }
			if (pAd->StaCfg.bImprovedScan)
			{
				 ...
				 * Fast scanning doesn't complete yet.
				 */
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rt_ioctl_giwscan:: Still scanning\n"));
				return -EAGAIN;
			}
#endif
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query::OID_AUTO_PROVISION_BSSID_LIST (%d BSS returned)\n",pAd->ScanTab.BssNr));
			pAd->StaCfg.bSkipAutoScanConn = FALSE;
            /* Claculate total buffer size required */
            BssBufSize = sizeof(ULONG);
		...
		case RT_OID_IWSC_SELF_IPV4:
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query Failed::RT_OID_IWSC_SELF_IPV4(=%d)\n", wrq->u.data.length));
                Status  = -EINVAL;
			}
            else
            {
            	Status = copy_to_user(wrq->u.data.pointer, &pAd->StaCfg.IWscInfo.SelfIpv4Addr, sizeof(UINT32));
            	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query::RT_OID_IWSC_SELF_IPV4(=0x%08x), Status = %d\n",
		...
		case RT_OID_IWSC_REGISTRAR_IPV4:
			if (wrq->u.data.length != sizeof(UINT32))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query Failed::RT_OID_IWSC_REGISTRAR_IPV4(=%d)\n", wrq->u.data.length));
                Status  = -EINVAL;
			}
            else
            {
            	Status = copy_to_user(wrq->u.data.pointer, &pAd->StaCfg.IWscInfo.RegIpv4Addr, sizeof(UINT32));
            	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query::RT_OID_IWSC_REGISTRAR_IPV4(=0x%08x), Status = %d\n",
		...
		case RT_OID_IWSC_SMPBC_ENROLLEE_COUNT:
			...
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Query Failed::RT_OID_IWSC_SMPBC_ENROLLEE_COUNT(=%d)\n", wrq->u.data.length));
                Status  = -EINVAL;
			}
            else
            {
            	Status = copy_to_user(wrq->u.data.pointer, &pAd->StaCfg.IWscInfo.SmpbcEnrolleeCount, sizeof(UINT8));
            	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Query::RT_OID_IWSC_SMPBC_ENROLLEE_COUNT(=0x%08x), Status = %d\n",
...
/*	RTMP_STRING arg[255]; */
	...
	if (wrq->u.data.length > 1) /*No parameters. */
	{
		...
		{ /*Read */
#ifdef RELEASE_EXCLUDE
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Read: this_char=%s, strlen=%zu\n", this_char, strlen(this_char)));
#endif /* RELEASE_EXCLUDE */
		...
		{ /*Write */
#ifdef RELEASE_EXCLUDE
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Write: this_char=%s, strlen(value)=%zu, value=%s\n", this_char, strlen(value), value));
#endif /* RELEASE_EXCLUDE */
...
next:
	if (bIsPrintAllE2P)
	{
		...
		if (IS_ERR(file_w))
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("-->2) %s: Error %ld opening %s\n", __FUNCTION__, -PTR_ERR(file_w), fileName));
		}
		else
		{
	...
	if (wrq->u.data.length > 1) /*No parameters. */
	{
		...
		{ /*Write */
			if ( sscanf(value, "%lx", &(rfValue)) == 1)
			{
				...
				{
#ifdef RELEASE_EXCLUDE
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("bank_Id=%d rfID=%02d, value=0x%lx\n", bank_Id, rfId, rfValue));
#endif /* RELEASE_EXCLUDE */
...
MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Into RTMPIoctlBbp32()!\n"));
	...
	if (wrq->u.data.length > 1) /*No parameters. */
	{
		...
		{
			/*Write */
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("this_char=%s, value=%s\n", this_char, value));
			if ((sscanf(this_char, "%x", &(bbpId)) == 1) && (sscanf(value, "%x", &(bbpValue)) == 1))
			{
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("BBP[0x%04x]:%08x\n", bbpId, bbpValue));
				if ((bbpId <= 0x2fff) && (bbpId >= 0x2000))
				{
					...
					sprintf(extra+strlen(extra), "BBP[0x%04x]:%08x\n", bbpId, regBBP);
					wrq->u.data.length = strlen(extra) + 1; /* 1: size of '\0' */
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("msg=%s\n", extra));
				}
				else
				{
					/*Invalid parametes, so default printk all bbp */
	...
	IN UINT32 size)
{
	...
	if (wrq->u.data.length > 1) /*No parameters. */
	{
		...
		{ /*Write */
			...
			{
#ifdef RELEASE_EXCLUDE
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("bbpID=%02d, value=0x%x\n", bbpId, bbpValue));
#endif /* RELEASE_EXCLUDE */
				if (bbpId <= pAd->chipCap.MaxNumOfBbpId)
				{
#ifdef CONFIG_ATE
...
/* #if defined(SIOCGIWSCAN) || defined(RT_CFG80211_SUPPORT) */
	...
	do{
		...
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("!!! WpaSupplicantScanCount > 3\n"));
			Status = NDIS_STATUS_SUCCESS;
			break;
		}
#endif /* WPA_SUPPLICANT_SUPPORT */
	...
	IN	ULONG					Data)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Mesh do not support rt_ioctl_giwscan \n"));
			return NDIS_STATUS_FAILURE;
	}
