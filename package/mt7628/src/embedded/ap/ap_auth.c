    ...
    IN PMLME_QUEUE_ELEM Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("AUTH_RSP - APPeerDeauthReqAction\n"));
...
static VOID APPeerAuthReqAtIdleAction(RTMP_ADAPTER *pAd, MLME_QUEUE_ELEM *Elem)
{
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("AUTH - APPeerAuthReqAtIdleAction\n"));
#endif /* RELEASE_EXCLUDE */
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s:: GO update not complete, stop Auth Rsp.\n", __FUNCTION__));
		return;
	}
#endif /* P2P_SUPPORT */
	...
	if (pEntry && IS_ENTRY_CLIENT(pEntry))
	{
        ...
        MacTableDeleteEntry(pAd, pEntry->wcid, pEntry->Addr);
        pEntry = NULL;
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("AUTH - Reset(Delete) Mac Table Entry\n"));
#endif
	}
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO,("AUTH - APPeerAuthConfirmAtAuthReqAction\n"));
#endif /* RELEASE_EXCLUDE */
