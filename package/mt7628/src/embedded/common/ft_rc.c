...
{
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ap_ftrc> Initialize FT RIC Module...\n"));
	...
	if (pAd->pFT_RIC_Ctrl_BK == NULL)
	{
		...
		if (pAd->pFT_RIC_Ctrl_BK == NULL)
		{
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("ap_ftrc> Allocate control block fail!\n"));
			return;
		} /* End of if */
...
VOID TYPE_FUNC FT_RIC_Release(
	IN	PRTMP_ADAPTER		pAd)
{
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ap_ftrc> Release FT RIC Module...\n"));
		...
		*/
				...
				switch(*pElmReqDescp)
				{
					case IE_FT_RIC_DESCRIPTOR:
						...
						if (BA_ResourceAllocate(pAd,
											...
											&RspLen) == 0)
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ft_ric> Accept BA.\n"));
					...
					default:
						...
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ft_ric> Accept TSPEC.\n"));
							FlgIsTspecAccepted = TRUE;
						} /* End of if */
#endif /* WMM_ACM_SUPPORT */
						break;
		...
		else
		{
			...
			*/
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ft_ric> Resource request fails!\n"));
		} /* End of if */
