...
{   
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Adhoc_WpaEAPOLStartAction ===> \n"));
	...
	tr_entry = &pAd->MacTab.tr_entry[pEntry->wcid];
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" PortSecured(%d), WpaState(%d), AuthMode(%d), PMKID_CacheIdx(%d) \n",
					tr_entry->PortSecured, pAuthenticator->WpaState, pEntry->AuthMode, pEntry->PMKID_CacheIdx));
...
{	
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Adhoc_WpaEAPOLKeyAction ===>\n"));
	...
	*((USHORT *)&peerKeyInfo) = cpu2le16(*((USHORT *)&peerKeyInfo));
    ...
    do
    {
    	...
    	else if ((pEntry->WepStatus == Ndis802_11AESEnable) && (peerKeyInfo.KeyDescVer != KEY_DESC_AES))
    	{
        	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Key descripter version not match(AES) \n"));
        	break;
    	}
    ...
    IN ULONG			TimeInterval) 
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> Adhoc_WpaStart4WayHS\n"));
    ...
    {
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("[ERROR]WPAStart4WayHS : Not expect calling=%d\n", pAuthenticator->WpaState));
        return;
    }
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("<=== Adhoc_WpaStart4WayHS: send Msg1 of 4-way \n"));
    ...
    IN MLME_QUEUE_ELEM  *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> Adhoc_PeerPairMsg1Action \n"));
...
{   
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> Adhoc_PeerPairMsg2Action \n"));
	...
	Adhoc_AsicGetTxTsc(pAd, BSS0, TxTsc);
    ...
    IN MLME_QUEUE_ELEM  *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("===> Adhoc_PeerPairMsg3Action \n"));
...
{    
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> Adhoc_PeerPairMsg4Action\n"));
    ...
    IN MLME_QUEUE_ELEM  *Elem) 
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("===> Adhoc_PeerGroupMsg1Action \n"));
    ...
    IN MAC_TABLE_ENTRY  *pEntry)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> Adhoc_Wpa4WayComplete\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Adhoc_Wpa4WayComplete - WPA2, AuthMode(%d)=%s, WepStatus(%d)=%s, GroupWepStatus(%d)=%s\n\n", 
    ...
    IN PVOID SystemSpecific3) 
{
    ...
    if ((pEntry) && IS_ENTRY_CLIENT(pEntry))
    {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Adhoc_WPARetryExec---> ReTryCounter=%d, WpaState=%d \n", pAuthenticator->MsgRetryCounter, pAuthenticator->WpaState));
        ...
        switch (pEntry->AuthMode)
        {
            ...
            case Ndis802_11AuthModeWPA2PSK:
                if (pAuthenticator->MsgRetryCounter == 0)
                {
                    ...
                    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Adhoc_WPARetryExec::MSG1 timeout\n"));
					}
                ...
                else if (pAuthenticator->MsgType == EAPOL_PAIR_MSG_1)
                {
                    ...
                    {
                        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Adhoc_WPARetryExec::ReTry MSG1 of 4-way Handshake\n"));
                        Adhoc_WpaStart4WayHS(pAd, pEntry, PEER_MSG1_RETRY_EXEC_INTV);
                    }                
                }
                else if (pAuthenticator->MsgType == EAPOL_PAIR_MSG_3)
                {
					...
					{
                    MlmeDeAuthAction(pAd, pEntry, REASON_4_WAY_TIMEOUT, FALSE);
                    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Adhoc_WPARetryExec::Retry MSG3, TIMEOUT\n"));
                }
                }
                break;
            default:
	...
	*(USHORT *)(pKeyInfo) = cpu2le16(*(USHORT *)(pKeyInfo));
	...
	if (bWPA2)
	{
		...
		if ((MsgType == EAPOL_PAIR_MSG_1) || (MsgType == EAPOL_PAIR_MSG_3))
			pKeyDesc->KeyLength[1] = ((pEntry->WepStatus == Ndis802_11TKIPEnable) ? LEN_TKIP_TK : LEN_AES_TK);
	}
	else
	{
		if (MsgType >= EAPOL_GROUP_MSG_1)
		{
			...
			pKeyDesc->KeyLength[1] = ((GroupKeyWepStatus == Ndis802_11TKIPEnable) ? LEN_TKIP_GTK : LEN_AES_GTK);
		}
		else
		{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("===> ConstructEapolMsg for %s %s\n", ((bWPA2) ? "WPA2" : "WPA"), GetEapolMsgType(MsgType)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("	     Body length = %d \n", CONV_ARRARY_TO_UINT16(pMsg->Body_Len)));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("	     Key length  = %d \n", CONV_ARRARY_TO_UINT16(pKeyDesc->KeyLength)));
}
