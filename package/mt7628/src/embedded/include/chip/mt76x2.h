...
void mt76x2_adjust_per_rate_pwr_delta(struct _RTMP_ADAPTER *ad, UINT8 channel, char delta_pwr);
...
void mt76x2_external_pa_rf_dac_control(struct _RTMP_ADAPTER *ad, UINT8 channel);
...
#ifdef SINGLE_SKU_V2
void mt76x2_single_sku(struct _RTMP_ADAPTER *ad, UINT8 channel);
...
UCHAR mt76x2_get_sku_channel_base_pwr(struct _RTMP_ADAPTER *ad, UINT8 channel);
void mt76x2_update_per_rate_pwr(struct _RTMP_ADAPTER *ad);
UCHAR mt76x2_update_sku_pwr(struct _RTMP_ADAPTER *ad, UINT8 channel);
#endif /* SINGLE_SKU_V2 */
