...
VOID NICInitRT2883MacRegisters(struct _RTMP_ADAPTER *pAd);
VOID NICInitRT2883BbpRegisters(struct _RTMP_ADAPTER *pAd);

VOID RT2883_Init(struct _RTMP_ADAPTER *pAd);

VOID RTMPRT2883ReadTxPwrPerRate(struct _RTMP_ADAPTER *pAd);
VOID RTMPRT2883ReadChannelPwr(struct _RTMP_ADAPTER *pAd);
