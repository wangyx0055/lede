...
typedef struct _WNM_CTRL {
	...
	MT_DL_LIST IPv4ProxyARPList;
	MT_DL_LIST IPv6ProxyARPList;
	MT_DL_LIST BTMPeerList;
	MT_DL_LIST WNMNotifyPeerList;
} WNM_CTRL, *PWNM_CTRL;
 ...
 */
#if 0
INT     Set_WnmMaxIdlePeriod_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg);
#endif
