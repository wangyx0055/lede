...
#ifdef MT_MAC
#ifdef CUT_THROUGH
PNDIS_PACKET cut_through_tx_deq(struct _RTMP_ADAPTER *pAd, INT32 token);
UINT16 cut_through_tx_enq(struct _RTMP_ADAPTER *pAd, PNDIS_PACKET pkt);
INT cut_through_deinit(struct _RTMP_ADAPTER *pAd);
INT cut_through_init(struct _RTMP_ADAPTER *pAd);
#endif /* CUT_THROUGH */
#endif /* MT_MAC */
