	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pNetPktPool",
					__FUNCTION__));
	}
		...
		IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: reach max allocating limitation. CurPoolIdx-%d\n",
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pNetRxBufPool", __FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s No NetRxBuf",
					__FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pNetTxBufPool", __FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pNetBufEntry == NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s No NetTxBuf",
					__FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pTxDPool",
					__FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pTXDEntry == NULL)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s No TXD",
					__FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pRxDPool",
					__FUNCTION__));
	}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pRXDEntry == NULL)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s No RXD",
					__FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (p1stTXBufEntry == NULL)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s No 1st TxBuf",
					__FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pNetRxBufPool",
					__FUNCTION__));
		return;
	}
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s Fail to alloc memory for pAd->eCos_Net_Pkt_Ctrl.pNetTxBufPool",
					__FUNCTION__));
		return;
	}
	...
	IN INT len)
{
	...
	{
/*		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("HdrRoomNotEnough, 0x%x-0x%x", */
	...
	IN ULONG PktLen)
{
	...
	if (pNetPkt == NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Allocate NetBuf failed!\n", __FUNCTION__));
