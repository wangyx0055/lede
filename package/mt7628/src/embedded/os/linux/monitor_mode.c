			  ...
			  IN UINT32 MaxRssi)
{
...
#endif /* MONITOR_FLAG_11N_SNIFFER_SUPPORT */
	{
		...
		(u_int32_t) RTMPMaxRssiOrg(pAd
			, ConvertToRssiOrg(pAd, pRxBlk->rx_signal.raw_rssi[0], RSSI_IDX_0)
			, ConvertToRssiOrg(pAd, pRxBlk->rx_signal.raw_rssi[1], RSSI_IDX_1)
			, ConvertToRssiOrg(pAd, pRxBlk->rx_signal.raw_rssi[2], RSSI_IDX_2));
#endif
