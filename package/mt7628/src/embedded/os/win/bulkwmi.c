...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("USB: BulkUsb_DispatchSysCtrl==>\n"));
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("%s",WMIMinorFunctionString(irpStack->MinorFunction)));
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_DispatchSysCtrl::"));
...
--*/
{
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_QueryWmiRegInfo - begins\n"));
    ...
    *Pdo          = deviceExtension->PhysicalDeviceObject;
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_QueryWmiRegInfo - ends\n"));
...
--*/
{
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_QueryWmiDataBlock - begins\n"));
    ...
    case WMI_BULKUSB_DRIVER_INFORMATION:
        ...
        if (OutBufferSize < size ) {
            ...
            //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("OutBuffer too small\n"));
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_QueryWmiDataBlock - ends\n"));
...
--*/
{
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_SetWmiDataItem - begins\n"));
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_SetWmiDataItem - ends\n"));
...
--*/
{
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_SetWmiDataBlock - begins\n"));
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_SetWmiDataBlock - ends\n"));
