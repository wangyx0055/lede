...
{	
	...
	{		
		...
		{			
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s unknow addr range = %x !!!\n",__FUNCTION__));					
		}	
	}	
	else		
		global_addr = addr;	
...
{
	USHORT i;
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadMacRegisters ===>\n"));
...
NTSTATUS HwHal_ReadEeRegister_u8( IN RTMP_ADAPTER *dx, USHORT Offset, UCHAR* pucData)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadEeRegister_u8()>>>"));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Offset = 0x%04x, pData[0]=0x%02x", Offset, pucData[0]));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadEeRegister_u8()<<<"));
...
NTSTATUS HwHal_WriteEeRegister_u8( IN RTMP_ADAPTER *dx, USHORT Offset, UCHAR* pucData)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteEeRegister_u8()>>>"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Offset = 0x%04x, pData[0]=0x%04x", Offset, pucData[0]));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteEeRegisters()<<<"));
...
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteEeRegisters()>>>\n");
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Offset = 0x%04x, , Length = 0x%04x, pData[0]=0x%04x\n", Offset, Length, pData[0]);
...
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("DeviceIoControl: IOCTL_USBQA_USB_EEPROM_WRITE\n");
...
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadEeRegisters()>>>\n");
...
NTSTATUS HwHal_PCIWriteEeRegisters( IN RTMP_ADAPTER *dx, USHORT Offset, USHORT Length, USHORT* pData)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteEeRegisters()>>>"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteEeRegisters() Offset = %x, Length =%x", Offset, Length));	
	for(i=0; i<Length/2; i++)
	{
...
NTSTATUS HwHal_ReadBbpRegister( IN RTMP_ADAPTER *dx, UCHAR Id, UCHAR* pValue)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadBbpRegister()>>>\n"));
	...
	do
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Bbp Debug1 Value = 0x%02x\n", BbpCsrStruct.field.Value));
	...
	if (i == retry_limit)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Retry Count Exhausted!!!\n"));
		return STATUS_UNSUCCESSFUL;
	}

	//RTMP_IO_READ32(dx, RA_BBP_CSR_CFG, &BbpCsrStruct.Group);
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Bbp Debug2 Value = 0x%02x\n", BbpCsrStruct.field.Value));
...
NTSTATUS HwHal_WriteBbpRegister( IN RTMP_ADAPTER *dx, UCHAR Id, UCHAR Value)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteBbpRegister()>>>\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteBbpRegister() Id = %d, Value = 0x%x\n", Id, Value));
...
NTSTATUS HwHal_WriteRfRegister( IN RTMP_ADAPTER *dx, IN ULONG Value)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteRfRegister()>>>\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("RfWValue=0x%08x\n", Value));
...
{
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_LockChannel()>>>"));
}
...
NTSTATUS HwHal_SetRxAntenna( IN RTMP_ADAPTER *dx, ULONG Antenna)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetRxAntenna()>>>"));
...
NTSTATUS HwHal_SetTxAntenna( IN RTMP_ADAPTER *dx, ULONG Antenna)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetTxAntenna()>>>\n"));

#ifdef RTMP_PCI_SUPPORT
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetTxAntenna()>>> RfType = %d\n", dx->PortCfg.RfType));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetTxAntenna()>>> NumberOfAntenna = %d\n", dx->PortCfg.NumberOfAntenna));
#endif /* RTMP_PCI_SUPPORT */
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetTxAntenna()>>> Antenna = %d\n", Antenna));
...
NTSTATUS HwHal_SetRfAntenna( IN RTMP_ADAPTER *dx, ULONG Antenna)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetRfAntenna()>>>"));
...
{
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_SetFrequencyOffset()>>>"));
...
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Offset = 0x%04x, , Length = 0x%04x, pData[0]=0x%08x\n", Offset, Length, pData[0]);
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_ReadMacRegisters()<<<\n");
...
NTSTATUS USBHwHal_ReadMacRegisters63( IN RTMP_ADAPTER *dx, USHORT HighByte,USHORT LowByte, USHORT Length, ULONG* pData)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s HighByte=0x%08x LowByte=0x%08x,Length =%d\n",__FUNCTION__,HighByte,LowByte,Length));
	...
	if( urb==NULL)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s No URB memory\n",__FUNCTION__));
		return STATUS_INSUFFICIENT_RESOURCES;
	}
	...
	// Call the USB driver
	ntStatus = CallUSBDI( dx, urb, IOCTL_INTERNAL_USB_SUBMIT_URB, 0);
	//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s HighByte=0x%08x LowByte=0x%08x  get pData=%08x\n",__FUNCTION__,HighByte,LowByte,*pData);
	// Check statuses
	if( !NT_SUCCESS(ntStatus) || !USBD_SUCCESS( urb->UrbHeader.Status))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("status %x URB status %x\n", ntStatus, urb->UrbHeader.Status));
...
NTSTATUS USBHwHal_WriteMacRegister66( IN RTMP_ADAPTER *dx, USHORT HighByte,USHORT LowByte, ULONG Value)
{
	...
	//MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s -->\n",__FUNCTION__));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s HighByte=0x%08x LowByte=0x%08x set=0x%x\n",__FUNCTION__,HighByte,LowByte,Value));
...
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HwHal_WriteMacRegisters()>>>\n");
//	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Offset = 0x%04x, , Length = 0x%04x, pData[0]=0x%08x\n", Offset, Length, pData[0]);
...
NTSTATUS RTMP_IO_READ32(IN RTMP_ADAPTER *deviceExtension, ULONG addr, ULONG *Value)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s()Convert to Physical addr 0x%08x\n",__FUNCTION__, PhysicalAddr));
	
	ntStatus = USBHwHal_ReadMacRegister(deviceExtension,PhysicalAddr,Value);
	return ntStatus;
...
NTSTATUS RTMP_IO_WRITE32(IN RTMP_ADAPTER *deviceExtension, ULONG addr, ULONG Value)
{
	...
	ntStatus = USBHwHal_WriteMacRegister(deviceExtension,PhysicalAddr,Value);
	return ntStatus;
}

NTSTATUS RTMP_IO_MULTIREAD(IN RTMP_ADAPTER *pAd, UINT32 addr, UINT32 *pValue, UINT32 Length)
{
	NTSTATUS	ntStatus = STATUS_UNSUCCESSFUL;
	UINT32 PhysicalAddr = 0;
	USHORT HighByte = 0;
	...
	HighByte = (PhysicalAddr&0xFFFF0000)>>16;
	LowByte = PhysicalAddr&0x0000FFFF;
	ntStatus = USBHwHal_ReadMacRegisters63(pAd, HighByte,LowByte, (USHORT)Length, pValue);
