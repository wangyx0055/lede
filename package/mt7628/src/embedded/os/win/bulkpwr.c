...
//  PUNICODE_STRING    tagString;
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("BulkUsb_DispatchPower::"));
    ...
    case IRP_MN_WAIT_WAKE:
        ...
        if(InterlockedExchange(&deviceExtension->FlagWWDispatched, 1)){
            ...
            if(InterlockedExchangePointer((PVOID*)&deviceExtension->WaitWakeIrp,//++ (PVOID*) for x64
                ...
                MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("IRP_MN_WAIT_WAKE::"));
        ...
        if(!NT_SUCCESS(ntStatus)) {
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Lower drivers failed the wait-wake Irp\n"));
        }
...
//        ntStatus = STATUS_PENDING;
    ...
    default:
        ...
        if(!NT_SUCCESS(ntStatus)) {
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Lower drivers failed default power Irp\n"));
        }
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleSystemQueryPower - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Query for system power state S%X\n"
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleSystemQueryPower - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleSystemSetPower - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set request for system power state S%X\n"
                         "Current system power state S%X\n",
                         systemState - 1,
                         deviceExtension->SysPower - 1));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleSystemSetPower - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceQueryPower - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Query for device power state D%X\n"
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceQueryPower::"));
    BulkUsb_IoDecrement(deviceExtension);

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceQueryPower - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SysPoCompletionRoutine - begins\n"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SysPoCompletionRoutine::"));
        BulkUsb_IoDecrement(DeviceExtension);
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SysPoCompletionRoutine - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SendDeviceIrp - begins\n"));
    ...
    if(!powerContext) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Failed to alloc memory for powerContext\n"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SendDeviceIrp::"));
        BulkUsb_IoDecrement(deviceExtension);

    }

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SendDeviceIrp - ends\n"));
}
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("DevPoCompletionRoutine - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("DevPoCompletionRoutine::"));
    BulkUsb_IoDecrement(deviceExtension);

    ExFreePool(powerContext);

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("DevPoCompletionRoutine - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceSetPower - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Set request for device power state D%X\n"
                         "Current device power state D%X\n",
                         newDevState - 1,
                         deviceExtension->DevPower - 1));
    ...
    if(newDevState < oldDevState) {
        ...
        // adding power
        //
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Adding power to the device\n"));
        ...
        if(PowerDeviceD0 == oldDevState && newDevState > oldDevState) {
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Removing power from the device\n"));
            ...
            if(!NT_SUCCESS(ntStatus)) {
                ...
                MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceSetPower::"));
                BulkUsb_IoDecrement(deviceExtension);
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("A SetD0 request\n"));
        ...
        if(!NT_SUCCESS(ntStatus)) {
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Lower drivers failed a power Irp\n"));
        }
...
HandleDeviceSetPower_Exit:
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HandleDeviceSetPower - ends\n"));
	if(PowerDeviceD0 == newDevState)	
		StartRx1(deviceExtension);
    return STATUS_PENDING;
}
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoUpIrp - begins\n"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoUpIrp::"));
        BulkUsb_IoDecrement(DeviceExtension);
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoUpIrp - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SetDeviceFunctional - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SetDeviceFunctional::"));
    BulkUsb_IoDecrement(DeviceExtension);

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("SetDeviceFunctional - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoDnIrp - begins\n"));
    ...
    if(NT_SUCCESS(ntStatus) && irpStack->MinorFunction == IRP_MN_SET_POWER) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("updating cache..\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoDnIrp::"));
    BulkUsb_IoDecrement(DeviceExtension);

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("FinishDevPoDnIrp - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequests - begins\n"));
    ...
    if(context) {
        ...
        if(item) {
            ...
            MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Failed to allocate memory for workitem\n"));
            ExFreePool(context);
            ntStatus = STATUS_INSUFFICIENT_RESOURCES;
        }
    }
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Failed to alloc memory for worker thread context\n"));
        ntStatus = STATUS_INSUFFICIENT_RESOURCES;
    }

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequests - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequestsWorkerRoutine - begins\n"));
    ...
    //
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequestsWorkerRoutine::"));
    BulkUsb_IoDecrement(deviceExtension);
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequestsWorkerRoutine::"));
    BulkUsb_IoDecrement(deviceExtension);
    ...
    if(!NT_SUCCESS(ntStatus)) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("Lower driver fail a power Irp\n"));
    }

    IoFreeWorkItem(context->WorkItem);
    ExFreePool((PVOID)context);

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("HoldIoRequestsWorkerRoutine - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("QueueRequests - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("QueueRequests - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CancelQueued - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CancelQueued - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("IssueWaitWake - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("IssueWaitWake - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CancelWaitWake - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("CancelWaitWake - ends\n"));
}
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("WaitWakeCompletionRoutine - begins\n"));
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("WaitWakeCompletionRoutine - ends\n"));
...
--*/
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("WaitWakeCallback - begins\n"));
    ...
    if(deviceExtension->DevPower == PowerDeviceD0) {
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("device already powered up...\n"));

        return;
    }

    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("WaitWakeCallback::"));
    BulkUsb_IoIncrement(deviceExtension);
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("WaitWakeCallback - ends\n"));
