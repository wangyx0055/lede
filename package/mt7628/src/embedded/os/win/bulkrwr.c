...
--*/
{
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_PipeWithName - begins\n"));

    if(nameLength != 0) {
    
        //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("Filename = %ws nameLength = %d\n", FileName->Buffer, nameLength));
    ...
    //BulkUsb_MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, 3, ("BulkUsb_PipeWithName - ends\n"));
...
--*/
{
   ...
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_DispatchReadWrite - begins\n"));

    if(deviceExtension->DeviceState != USBWorking) {

       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Invalid device state\n"));
    ...
    // is signalled.
    //
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Waiting on the IdleReqPendEvent\n"));
    ...
    if(fileObject && fileObject->FsContext) {
        ...
        if((UsbdPipeTypeBulk != pipeInformation->PipeType) &&
           ...
           MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Usbd pipe type is not bulk or interrupt\n"));
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Invalid handle\n"));

        ntStatus = STATUS_INVALID_HANDLE;
        goto BulkUsb_DispatchReadWrite_Exit;
    }
	rwContext = (PBULKUSB_RW_CONTEXT)ExAllocatePool(NonPagedPool,
                               sizeof(BULKUSB_RW_CONTEXT));

    if(rwContext == NULL) {
        
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Failed to alloc mem for rwContext\n"));
    ...
    if(totalLength > BULKUSB_TEST_BOARD_TRANSFER_BUFFER_SIZE) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Transfer length > circular buffer\n"));
    ...
    if(totalLength == 0) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Transfer data length = 0\n"));
    ...
    if(read) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Read operation\n"));
    }
    else {

        urbFlags |= USBD_TRANSFER_DIRECTION_OUT;
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Write operation\n"));
    }
//
    ...
    if(mdl == NULL) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Failed to alloc mem for mdl\n"));
    ...
    if(urb == NULL) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Failed to alloc mem for urb\n"));
   ...
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_DispatchReadWrite::"));
    ...
    if(!NT_SUCCESS(ntStatus)) {
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("IoCallDriver fails with status %X\n", ntStatus));
        ...
        if((ntStatus != STATUS_CANCELLED) && 
           (ntStatus != STATUS_DEVICE_NOT_CONNECTED)) {
            ...
            ntStatus = BulkUsb_ResetPipe(deviceExtension,
                                     pipeInformation);
    
            if(!NT_SUCCESS(ntStatus)) {

               MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_ResetPipe failed\n"));
		  if(DeviceObject)
                	ntStatus = BulkUsb_ResetDevice(deviceExtension);
            }
        }
        else {

           MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ntStatus is STATUS_CANCELLED or "
   ...
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_DispatchReadWrite - ends\n"));
...
--*/
{
    ...
    UNREFERENCED_PARAMETER(DeviceObject);
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_ReadWriteCompletion - begins\n"));
    ...
    if(NT_SUCCESS(ntStatus)) {
        ...
        if(rwContext) {
            ...
            if(rwContext->Length) {
                ...
                //
               MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Another stage transfer...\n"));
       ...
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ReadWriteCompletion - failed with status = %X\n", ntStatus));
    }
    ...
    if(rwContext) {
        ...
        // dump rwContext
        //
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->Urb             = %p\n", 
                             rwContext->Urb));
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->Mdl             = %p\n", 
                             rwContext->Mdl));
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->Length          = %d\n", 
                             rwContext->Length));
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->Numxfer         = %d\n", 
                             rwContext->Numxfer));
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->VirtualAddress  = %X\n", 
                             rwContext->VirtualAddress));
       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rwContext->DeviceExtension = %p\n", 
                             rwContext->DeviceExtension));

       MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_ReadWriteCompletion::"));
   ...
   MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("BulkUsb_ReadWriteCompletion - ends\n"));
