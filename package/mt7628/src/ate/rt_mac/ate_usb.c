...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("--->ATE_RTUSBBulkOutDataPacket \n"));
#endif /* RELEASE_EXCLUDE */
	...
	IN	PRTMP_ADAPTER	pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("--->ATE_RTUSBCancelPendingBulkInIRP\n"));
	...
	IN PRTMP_ADAPTER	pAd)
{
	...
	*/
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pATEInfo->Mode == %d\npAd->ContinBulkOut == %d\npAd->BulkOutRemained == %d\n",
    ...
    {
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("After CMDTHREAD_RESET_BULK_OUT, continue to bulk out frames !\n"));
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_INFO, ("--->RejectPendingPackets\n"));
#endif /* RELEASE_EXCLUDE */
