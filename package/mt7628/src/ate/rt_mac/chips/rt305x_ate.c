    ...
    IN PRTMP_ADAPTER pAd) 
{
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT3050:SwitchChannel#%d(RFIC=%d, Pwr0=%d, Pwr1=%d, %dT), N=0x%02X, K=0x%02X, R=0x%02X\n",
		Channel, 
		pAd->RfIcType, 
		TxPwer,
		TxPwer2,
    ...
    IN PRTMP_ADAPTER pAd) 
{
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT3052:SwitchChannel#%d(RFIC=%d, Pwr0=%d, Pwr1=%d, %dT), N=0x%02X, K=0x%02X, R=0x%02X\n",
		Channel, 
		pAd->RfIcType, 
		TxPwer,
		TxPwer2,
    ...
    IN PRTMP_ADAPTER pAd)
{
		...
		for (index = 0; index < NUM_OF_3020_CHNL; index++)
		{
			...
			if (Channel == RtmpFreqItems3020[index].Channel)
			{
				...
				else
				{
					...
					if (pATEInfo->TxWI.TXWI_O.PHYMODE == MODE_CCK)
						RFValue = 0x1F;
					else if (pATEInfo->TxWI.TXWI_O.PHYMODE == MODE_OFDM)
						RFValue = 0x18;
					else
	...
	*/
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT3350:SwitchChannel#%d(RFIC=%d, Pwr0=%d, Pwr1=%d, %dT), N=0x%02X, K=0x%02X, R=0x%02X\n",
		Channel, 
		pAd->RfIcType, 
		TxPwer,
		TxPwer2,
...
*/
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Write RF_R12 = 0x%02x\n", RFValue));            
			ATE_RF_IO_WRITE8_BY_REG_ID(pAd, RF_R12, (UCHAR)(RFValue));
