	...
	IN	PRTMP_ADAPTER pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Initialize MAC Registers for E1 !!!\n"));
...
#if 0
		RTMP_IO_WRITE32(pAd, TX0_RF_GAIN_CORRECT, 0x00380008); /* WH, 2012-10-30 */
		RTMP_IO_WRITE32(pAd, TX1_RF_GAIN_CORRECT, 0x00380008); /* WH, 2012-10-30 */
#endif
#if 0
		RTMP_IO_WRITE32(pAd, TX0_RF_GAIN_CORRECT, 0x003A0004); /* WH, 2012-11-22 */
		RTMP_IO_WRITE32(pAd, TX1_RF_GAIN_CORRECT, 0x003A0004); /* WH, 2012-11-22 */
#endif
#if 1
	...
	IN	PRTMP_ADAPTER pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: BBP_R105: BBPR105.field.EnableSIGRemodulation = %d, BBPR105.field.MLDFor2Stream = %d\n",
			__FUNCTION__,
	...
	IN	PRTMP_ADAPTER pAd)
{
	...
	if (pAd->CommonCfg.Chip_VerID > 1)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF Central Registers for E2 !!!\n"));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF Central Registers for E3 !!!\n"));
	...
	if (pAd->CommonCfg.Chip_VerID > 1)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF Channel Registers for E2 !!!\n"));
	...
	if ((pAd->CommonCfg.Chip_VerID > 1) && (pAd->CommonCfg.Chip_E_Number >= 2))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF Channel Registers for E3 !!!\n"));
...
#else
		RT635xWriteRFRegister(pAd, RF_BANK4, RF_R47, 0xEC);
		RT635xWriteRFRegister(pAd, RF_BANK6, RF_R47, 0xEC);
#endif
		...
		RT635xWriteRFRegister(pAd, RF_BANK6, RF_R59, 0x6B);
#else
		RT635xWriteRFRegister(pAd, RF_BANK4, RF_R55, 0xE6);
		RT635xWriteRFRegister(pAd, RF_BANK6, RF_R55, 0xE6);
		RT635xWriteRFRegister(pAd, RF_BANK4, RF_R59, 0xEB);
		RT635xWriteRFRegister(pAd, RF_BANK6, RF_R59, 0xEB);
#endif
	}
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF Channel Registers for DRQFN !!!\n"));
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Reduce Power Consumption Support !!!\n"));
	...
	if (pAd->CommonCfg.Chip_VerID > 1)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF DCCal Registers for E2 !!!\n"));
	...
	if ((pAd->CommonCfg.Chip_VerID > 1) && (pAd->CommonCfg.Chip_E_Number >= 2))
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Initialize RF DCCal Registers for E3 !!!\n"));
#if 1
...
#if 0
	/*  switching 1.2V fib */
	RT635xReadRFRegister(pAd, RF_BANK0, RF_R09, &RFValue);
	RFValue |= 0x20;
	RT635xWriteRFRegister(pAd, RF_BANK0,RF_R09, RFValue);

	RT635xReadRFRegister(pAd, RF_BANK0, RF_R22, &RFValue);
	RFValue |= 0x40;
	RT635xWriteRFRegister(pAd, RF_BANK0,RF_R22, RFValue);

	RT635xReadRFRegister(pAd, RF_BANK4, RF_R05, &RFValue);
	RFValue |= 0x80;
	RT635xWriteRFRegister(pAd, RF_BANK4,RF_R05, RFValue);

	RT635xReadRFRegister(pAd, RF_BANK6, RF_R05, &RFValue);
	RFValue |= 0x80;
	RT635xWriteRFRegister(pAd, RF_BANK6,RF_R05, RFValue);
#endif
	...
	IN UCHAR				OrigR66Value)
{
	...
	if (pAd->LatchRfRegs.Channel <= 14)
		R66 = 0x04 + 2 * pAd->hw_cfg.lan_gain;
	...
	IN RTMP_ADAPTER			*pAd)
{
		...
		(pAd->CommonCfg.RegTransmitSetting.field.EXTCHA == EXTCHA_ABOVE))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ApStartUp : ExtAbove, ChannelWidth=%d, Channel=%d, ExtChanOffset=%d(%d) \n",
			...
			(pAd->CommonCfg.RegTransmitSetting.field.EXTCHA == EXTCHA_BELOW))
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ApStartUp : ExtBlow, ChannelWidth=%d, Channel=%d, ExtChanOffset=%d(%d) \n",
									pAd->CommonCfg.HtCapability.HtCapInfo.ChannelWidth,
									pAd->CommonCfg.Channel,
									pAd->CommonCfg.RegTransmitSetting.field.EXTCHA,
									pAd->CommonCfg.AddHTInfo.AddHtInfo.ExtChanOffset));
...
#ifdef DOT11_N_SUPPORT
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ApStartUp : 20MHz, ChannelWidth=%d, Channel=%d, ExtChanOffset=%d(%d) \n",
									pAd->CommonCfg.HtCapability.HtCapInfo.ChannelWidth,
									pAd->CommonCfg.Channel,
									pAd->CommonCfg.RegTransmitSetting.field.EXTCHA,
									pAd->CommonCfg.AddHTInfo.AddHtInfo.ExtChanOffset));
...
INT RT6352_set_ed_cca(RTMP_ADAPTER *pAd, BOOLEAN enable)
{
	...
	if (enable) {
		...
		bbp_val = 0x0B; /* 0x2e */ // bit 0~7 for high threshold
	...
	IN BOOLEAN bScan) 
{
	...
	*/
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s(): Can't find the Channel#%d \n", __FUNCTION__, Channel));
	}
	...
	for (index = 0; index < NUM_OF_6352_CHNL; index++)
	{
		if (Channel == FreqItems6352[index].Channel)
		{
			...
			if (bScan == FALSE)
			{
				...
				if (k_count == 10000)
				{
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("(%s) Wait MAC Status to MAX  !!!\n", __FUNCTION__));
				}
				...
				if ((pAd->CommonCfg.Chip_VerID > 1) && (pAd->CommonCfg.Chip_E_Number >= 2))
				{
					...
					/* ADC clcok selection */
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("ADC clcok selection for E3 !!!\n"));
#if 0
#ifdef RELEASE_EXCLUDE
					/* 0: DRQFN-148 pin 1: TFBGA-269 ball */
#endif /* RELEASE_EXCLUDE */
...
#endif
					{
						if (Channel > 10)
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Apr clock selection !!!\n"));
						...
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Shielding clock selection !!!\n"));
							RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R30, &BBPValue);
							BBPValue = 0x1F;
							RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R30, BBPValue);
							RT635xWriteRFRegister(pAd, RF_BANK0, RF_R39, 0x80);
					...
					else
					{
						if (Channel > 12)
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Apr clock selection !!!\n"));
							RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R30, &BBPValue);
							BBPValue = 0x40;
							RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R30, BBPValue);
							RT635xWriteRFRegister(pAd, RF_BANK0, RF_R39, 0x00);
						...
						{
							MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Shielding clock selection !!!\n"));
							RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R30, &BBPValue);
							BBPValue = 0x1F;
							RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R30, BBPValue);
							RT635xWriteRFRegister(pAd, RF_BANK0, RF_R39, 0x80);
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("RT6352: SwitchChannel#%d(RF=%d, Pwr0=%d, Pwr1=%d, %dT), Rdiv=0x%02X, N=0x%02X, K=0x%02X, D=0x%02X, Ksd=0x%02X\n",
							Channel,
							pAd->RfIcType, 
							TxPwer,
							TxPwer2,
...
#endif /* RT6352 */
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE,("%s: Stored_RF_B5_R6=%x, and Stored_RF_B5_R7=%x \n", __FUNCTION__,
...
#ifdef ED_CERT
	if (bScan == FALSE) {
		if (strncmp(pAd->CommonCfg.CountryCode, "FR", 2) == 0)
		{
			RT6352_set_ed_cca(pAd, TRUE);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s():Enable ED CCA Check for cert!\n", __FUNCTION__));
		} else {
			RT6352_set_ed_cca(pAd, FALSE);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s():Disable ED CCA Check!\n", __FUNCTION__));
		}
	}
#endif /* ED_CERT */
	...
	IN UCHAR BandWidth)
{
	...
	/* Backup BBP_R66  */
	pAd->CommonCfg.lna_vga_ctl.agc_vga_init_0 = R66;
#ifdef RELEASE_EXCLUDE
...
#ifdef RELEASE_EXCLUDE
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("RTMPAGCInit - Ch=%d, BandWidth=%d, LNA_GAIN=0x%x, set R66 as 0x%x \n",
				pAd->LatchRfRegs.Channel, BandWidth, pAd->hw_cfg.lan_gain, R66));
#endif /* RELEASE_EXCLUDE */
}
	...
	IN CHAR 		org_value)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s: original value is 0x%02x\n", __FUNCTION__, value));
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s: extended value is 0x%02x\n", __FUNCTION__, value));
...
redo:
	...
	for(ant_idx = 0; ant_idx < 2; ant_idx = ant_idx + 1){
		...
		for (index = 0; index < 4; index++)
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("RF_B4R39 %08x\n", RFValue));
			RT635xReadRFRegister(pAd, RF_BANK6, RF_R39, &RFValue);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("RF_B6R39 %08x\n", RFValue));
			...
			switch (index)
			{
				...
				default:
					...
					RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R24, 0x8);
					break;
#endif
			}
			RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R244, &BBPValue);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("BBP_R244 is 0x%02x\n", BBPValue));
			RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R22, &BBPValue);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("BBP_R22 is 0x%02x\n", BBPValue));
#if 0
			BBPValue = 0x50;
			while (BBPValue == 0x50)
			{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("BBP_R47 is 0x%02x\n", BBPValue));
#else
			...
			if(index==2)
			{			
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("BBPTXgain0 %x, BBPTXgain1 %x, loop cnt %d \n", BBPTXGAIN[0], BBPTXGAIN[1], agc_loop_cnt));
			}
#endif /* ADJUST_POWER_CONSUMPTION_SUPPORT */
			...
			if(ant_idx == 0){
				switch (index){
					...
					case 1: 								
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi0_dc_hvga is 0x%08x\n", rt635x_tssi0_dc_hvga));
						break;
					case 2:								
						tssi0_linear = (INT32)BBPR49;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("index %d: tssi0_linear is 0x%08x\n", index, tssi0_linear));
								
						tssi0_db = MT76xx_lin2dBd(tssi0_linear - rt635x_tssi0_dc);
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi0_db is %d\n", tssi0_db));
						break;
					case 3:								
						tssi0_linear = (INT32)BBPR49;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("index %d: tssi0_linear hvga is 0x%08x\n", index, tssi0_linear));
								
#if 1
						tssi0_linear = tssi0_linear - rt635x_tssi0_dc_hvga;
						tssi0_linear = tssi0_linear * 4;								
						rt635x_tssi0_db_hvga = MT76xx_lin2dBd(tssi0_linear) - tssi0_db;
#else
								
						rt635x_tssi0_db_hvga = MT76xx_lin2dBd(tssi0_linear - rt635x_tssi0_dc_hvga) - tssi0_db;
#endif

						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("tssi0_db_hvga is %d\n", rt635x_tssi0_db_hvga));
						break;
				}
			}
			else{
				switch (index){
					...
					case 1:					
						...
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi1_dc_hvga is 0x%08x\n", rt635x_tssi1_dc_hvga));
						break;
					case 2:
						tssi1_linear = (INT32)BBPR49;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("index %d: tssi1_linear is 0x%08x\n", index, tssi1_linear));
						
						tssi1_db = MT76xx_lin2dBd(tssi1_linear - rt635x_tssi1_dc); 			
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi1_db is %d\n", tssi1_db));
						break;
					case 3:				
						tssi1_linear = (INT32)BBPR49;
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("index %d: tssi1_linear hvga is 0x%08x\n", index, tssi1_linear));
						
#if 1
						tssi1_linear = tssi1_linear - rt635x_tssi1_dc_hvga;
						tssi1_linear = tssi1_linear*4;

						rt635x_tssi1_db_hvga = MT76xx_lin2dBd(tssi1_linear) - tssi1_db;
#else
						
						rt635x_tssi1_db_hvga = MT76xx_lin2dBd(tssi1_linear - rt635x_tssi1_dc_hvga) - tssi1_db;
#endif
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi1_db_hvga is %d\n", rt635x_tssi1_db_hvga));						
						break;
				}
			}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Mac 0x13B4 is 0x%08x\n", MacValue));
	...
	if (use_ant == 0){ // All  Tx
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Mac 0x13B0 is 0x%08x\n", MacValue));
	...
	IN PRTMP_ADAPTER 		pAd)
{
	...
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("internal ALC is not enabled in NVM !\n"));
		return;
	}
...
//	    if ((base_power[chain] + cur_comp_power) >= 0)
		...
		{
			pa_mode_00 = 0;
			pa_mode_01 = 8192; /* 1 * 8192 */
			pa_mode_11 = 1638; /* 0.2 * 8192 */
		}
#endif
	pa_mode_used = (pa_mode == 0x00) ? pa_mode_00 :
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi0_dc %x\n", rt635x_tssi0_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi1_dc %x\n", rt635x_tssi1_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi0_dc_hvga %x\n", rt635x_tssi0_dc_hvga));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("rt635x_tssi1_dc_hvga %x\n", rt635x_tssi1_dc_hvga));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi_dc %x\n", tssi_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi_linear %x\n", tssi_read[chain]));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi_slope  %x\n", rt635x_tssi_slope[chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("tssi offset %x\n", rt635x_tssi_offset[ch_group][chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("\npwr is %d \n", pwr));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("mcs_power      %8d\n", mcs_power));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pkt_type_delta %8d\n", pkt_type_delta));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pa mode        %8d\n", pa_mode));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pa mode used   %8d\n", pa_mode_used));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("target_power %d, pwr %d\n", target_power, pwr));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("temp[%d] is 0x%02x\n", chain, temp[chain]));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("pwr_diff is %d\n", pwr_diff[chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("_comp_power is 0x%08x\n", _comp_power));
		if (chain == 0)
		{
			if (_comp_power > 31)
				_comp_power = 31;
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("comp_power[%d] is 0x%08x\n", chain, comp_power[chain]));
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("comp_power[0] is 0x%08x\n", comp_power[0]));
	if (max_stream == 2)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("comp_power[1] is 0x%08x\n", comp_power[1]));
	...
	if( // 2T
		...
		MacValue = MacValue | (comp_power[1] & 0x3f);
#endif

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("\n================================\n"));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Mac 0x13B4 is 0x%08x\n", MacValue));
	RTMP_IO_WRITE32(pAd, TX_ALG_CFG_1, MacValue);	
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Mac 0x13B0 is 0x%08x\n", MacValue));
	RTMP_IO_WRITE32(pAd, TX_ALG_CFG_0, MacValue);
	...
	IN	CHAR percent_delta)
{
	...
	for (chain=0; chain < max_stream; chain++)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rt635x_tssi0_dc %x\n", rt635x_tssi0_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rt635x_tssi1_dc %x\n", rt635x_tssi1_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rt635x_tssi0_dc_hvga %x\n", rt635x_tssi0_dc_hvga));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("rt635x_tssi1_dc_hvga %x\n", rt635x_tssi1_dc_hvga));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("tssi_dc %x\n", tssi_dc));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("tssi_linear %x\n", tssi_read[chain]));
		tssi_m_dc = tssi_read[chain] - tssi_dc;
		tssi_db = MT76xx_lin2dBd(tssi_m_dc);
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("tssi_slope  %x\n", rt635x_tssi_slope[chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("tssi offset %x\n", rt635x_tssi_offset[ch_group][chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("\npwr is %d \n", pwr));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("mcs_power	  %8d\n", mcs_power));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pkt_type_delta %8d\n", pkt_type_delta));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pa mode		  %8d\n", pa_mode));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pa mode used   %8d\n", pa_mode_used));
 
		target_power = base_power[0] + mcs_power;
		target_power = target_power * 4096;
		target_power = target_power + pa_mode_used + pkt_type_delta
						+ bbp_6db_power + rt635x_ant_pwr_offset[chain];
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("target_power %d, pwr %d\n", target_power, pwr));
		pwr_diff[chain] = target_power - pwr;
		...
		/* chain == 0 ? bit[5:0] : bit[13:8] */
		temp[chain] = MacValue & 0x0000003F;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("temp[%d] is 0x%02x\n", chain, temp[chain]));
		_comp_power = (INT32)SignedExtension6To8(temp[chain]);
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("pwr_diff is %d\n", pwr_diff[chain]));
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("_comp_power is 0x%08x\n", _comp_power));
		if (chain == 0)
		{
			if (_comp_power > 31)
				_comp_power = 31;
		...
		comp_power[chain] = _comp_power; 
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("comp_power[%d] is 0x%08x\n", chain, comp_power[chain]));
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("comp_power[0] is 0x%08x\n", comp_power[0]));
	if (max_stream == 2)
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("comp_power[1] is 0x%08x\n", comp_power[1]));
	...
	IN	PRTMP_ADAPTER	pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Txpower per Rate\n"));
...
#endif
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Gpwrdelta = %x .\n", Gpwrdelta));
	...
	for (i=0; i<5; i++)
	{
		...
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_TRACE, ("20MHz BW, 2.4G band-%lx,  Gdata = %lx \n", data, Gdata));
	}
	...
	IN	PRTMP_ADAPTER 		pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Offset =0x13D8, TxPwr = 0x%08X, ", (UINT)ExtraPwrOverTxPwrCfg8));
...
#ifdef SINGLE_SKU_V2
UCHAR RT6352_GetSkuMinPwr(
	IN PRTMP_ADAPTER 	pAd)
{
	if (pAd->CommonCfg.SkuChannel > 11)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s::no such channel\n", __FUNCTION__));
		return 0x20; /* default is 16 dBm */
	}
	else
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::Single-SKU at channel#%d\n", 
...
// TODO: shiang-usw, need to sync with GetSkuRatePwr() in cmm_profile.c, which get from MT7601!!
UCHAR RT6352_GetSkuRatePwr(
	IN PRTMP_ADAPTER 	pAd,
	IN CHAR 				phymode,
	IN UCHAR 			channel)
{
	...
	OUT CHAR *PreDiff)
{
	...
	if (pAd->TxPowerCtrl.bInternalTxALC == TRUE)
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::channel_power =%d, TotalDeltaPower=%d, sku_min_pwr=%d\n", 
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::mac 0x13B0 is 0x%08x\n", __FUNCTION__, mac_value));	
...
#endif /* RTMP_INTERNAL_TX_ALC */
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("target_power=%d, sku_min_pwr=%d\n", target_power, sku_min_pwr));	
		...
		if (pAd->bAutoTxAgcG)
		{
			*PreDiff = (CHAR)diff;
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::diff is 0x%x\n", __FUNCTION__, *PreDiff));
		}
		else
#endif /* RTMP_TEMPERATURE_COMPENSATION */
		{
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::mac 0x13B4 is 0x%08x\n", __FUNCTION__, mac_value));
		}
	}
	...
	IN CHAR 				channelpower)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::mcs_digpwr_diff is %d\n", __FUNCTION__, mcs_digpwr_diff));
		...
		{	
			for (j = 0; j < 8; j += 2)
			{
				...
				switch (0x1314 + (i * 4))
				{
					...
					default: 
						/* Do nothing */
						MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s::unknown register = 0x%x\n", __FUNCTION__, (0x1314 + (i * 4))));
					break;
				}
...
#if 0
				if ((i == 0 || i == 1) && (j == 4 || j == 6))
					sku_rate_pwr = (INT32)GetSkuRatePwr(pAd, i + 1, pAd->CommonCfg.SkuChannel);
				else
					sku_rate_pwr = (INT32)GetSkuRatePwr(pAd, i, pAd->CommonCfg.SkuChannel);
#else
...
#ifdef RELEASE_EXCLUDE
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s::after compensation, offset = 0x%04X, register value = 0x%08lX\n",
					__FUNCTION__, per_rate_entry->MACRegisterOffset, per_rate_entry->RegisterValue));
#endif /* RELEASE_EXCLUDE */
		}
	}
	...
	IN INT32 paValue)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: EEPROM 0xD0 = 0x%x\n", __FUNCTION__, tx_pwr1));

	if ((tx_pwr1 == 0x0) || (tx_pwr1 > max_tx1_pwr) )
	{
		tx_pwr1 = 0x1E;
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: EEPROM 0xD0 Error! Use Default Target Power = 0x%x\n", __FUNCTION__, tx_pwr1));
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("%s: pwr_diff = 0x%x, rate_pwr = 0x%x, rate_pwr1 = 0x%x !!!\n",
					__FUNCTION__, pwr_diff, rate_pwr, rate_pwr1));
#if 0
	if ( rate_pwr > (rate_pwr1 + pwr_diff))
		rate_pwr = (rate_pwr1 + pwr_diff);
#endif
	return rate_pwr;
	...
	OUT PINT32 pTssiReport)
{
	...
	else
	{
		...
		*pTssiReport = (INT32) BBPR49;
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("TSSI report from BBP_R49=0x%x\n", *pTssiReport));
	}
#if 0
	/* recover RF after reading temperature sensor */
	RT635xWriteRFRegister(pAd, RF_BANK0, RF_R02, RFB0R2Value);
#endif
	return TRUE;
}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pAd->Mlme.OneSecPeriodicRound % 4 == 0)
	{
...
#endif /* RTMP_TEMPERATURE_COMPENSATION */
		{
			...
			{			
				...
				else
				{
					...
					MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("Current Temperature from BBP_R49=0x%x\n", pAd->CurrTemperature));
					RT6352_TemperatureCalibration(pAd);
					pAd->CommonCfg.bEnTemperatureTrack = FALSE;
		...
		{  
			...
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("TotalDeltaPower=%d, Mac 0x13B4 is 0x%08x\n", TotalDeltaPower, MacValue));
		}
...
#if 0
	/* reset RF LPF threshold */
	RT635xWriteRFRegister(pAd, RF_BANK5, RF_R06, pAd->CommonCfg.MO_Cfg.Stored_RF_B5_R6);
	RT635xWriteRFRegister(pAd, RF_BANK5, RF_R07, pAd->CommonCfg.MO_Cfg.Stored_RF_B5_R7);
#ifdef RT6352
	if (IS_RT6352(pAd))
	{
		RT635xWriteRFRegister(pAd, RF_BANK7, RF_R06, pAd->CommonCfg.MO_Cfg.Stored_RF_B7_R6);
		RT635xWriteRFRegister(pAd, RF_BANK7, RF_R07, pAd->CommonCfg.MO_Cfg.Stored_RF_B7_R7);
	}
#endif /* RT6352 */
#endif
...
#if 0
	/* narrow down RF LPF */
	RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R65, 0xD);
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pAd->bRef25CVaild == FALSE)
	{
		...
		RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, BBP_R47, bbpval);
		RTMP_BBP_IO_READ8_BY_REG_ID(pAd, BBP_R49, &BBPR49);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s : BBPR49 = 0x%x\n", __FUNCTION__, BBPR49));
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s : TemperatureRef25C = 0x%x\n", __FUNCTION__, pAd->TemperatureRef25C));
	}
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("Current Temperature from BBP_R49=0x%x\n", pAd->CurrTemperature));
}
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (CurrentTemper < -50) // (20 - 25) * 10 = -50
	{
		...
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s:: CurrentTemper < 20 \n", __FUNCTION__));
	}
	else
	{
		if (pAd->bLowTemperatureTrigger)
		{
			if ( CurrentTemper > 50)
			{
				...
				RT635xWriteRFRegister(pAd, RF_BANK6, RF_R10, 0x51);
				pAd->bLowTemperatureTrigger = FALSE;
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s::CurrentTemper > 30\n", __FUNCTION__));
			}
		}
		else
		{
			...
			RT635xWriteRFRegister(pAd, RF_BANK4, RF_R10, 0x51);
			RT635xWriteRFRegister(pAd, RF_BANK6, RF_R10, 0x51);
			MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("%s::CurrentTemper > 20\n", __FUNCTION__));
		}
	}
}
#endif /* RTMP_TEMPERATURE_CALIBRATION */
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("%s: upper_bound = 0x%02X decimal: %d\n",
		__FUNCTION__, upper_bound, upper_bound));
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("%s: lower_bound = 0x%02X decimal: %d\n",
		__FUNCTION__, lower_bound, lower_bound));

	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("*** %s: G Tssi[-7 .. +7] = %d %d %d %d %d %d %d\n - %d - %d %d %d %d %d %d %d, offset=%d, tuning=%d\n",
		__FUNCTION__,
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("%s: G Tssi[-7 .. +7] = %d %d %d %d %d %d %d - %d - %d %d %d %d %d %d %d, offset=%d, tuning=%d\n",
		__FUNCTION__,
		pAd->TssiMinusBoundaryG[7], pAd->TssiMinusBoundaryG[6], pAd->TssiMinusBoundaryG[5],
		pAd->TssiMinusBoundaryG[4], pAd->TssiMinusBoundaryG[3], pAd->TssiMinusBoundaryG[2], pAd->TssiMinusBoundaryG[1],
		pAd->TssiRefG,
	...
	IN BOOLEAN ReInit)
{
	...
	if ((GpioMode & 0x100000) == 0x100000)
	{
		...
		RTMP_SYS_IO_READ32(0xb0000060, &GpioMode);
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("After Change, now GPIO_MODE value is 0x%x\n", GpioMode));
	}
	...
	if (pAd->bExtPA)
	{
		...
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-PA. init MAC \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
	{
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-LNA. \n", __FUNCTION__));
	...
	{
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Enable Ext-PA. \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
	{
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Init Ext-LNA BBP. \n", __FUNCTION__));
	...
	if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
	{
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Init Ext-PA MAC. \n", __FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (pAd->bExtPA)
	{
		DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA. init MAC \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-LNA. \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA. \n", __FUNCTION__));
			...
			RT635xWriteRFRegister(pAd, RF_BANK4, RF_R61, 0x05);
			RT635xWriteRFRegister(pAd, RF_BANK6, RF_R61, 0x05);
#endif /* LOW_DOWN_POWER_JP */
#ifdef LOW_DOWN_POWER_CE
			RT635xWriteRFRegister(pAd, RF_BANK4, RF_R49, 0x05);
			RT635xWriteRFRegister(pAd, RF_BANK6, RF_R49, 0x05);
			RT635xWriteRFRegister(pAd, RF_BANK4, RF_R57, 0x05);
			RT635xWriteRFRegister(pAd, RF_BANK6, RF_R57, 0x05);
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->NicConfig2.field.ExternalLNAForG))
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-LNA BBP. \n", __FUNCTION__));
		...
		if ((pAd->CommonCfg.PKG_ID == 1) && (pAd->bExtPA))
		{
			DBGPRINT_RAW(DBG_CAT_ALL, DBG_LVL_ERROR, ("%s: Restore Ext-PA MAC. \n", __FUNCTION__));
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_TRACE, (" Do ReCalibration !!!\n"));
	...
	if (MTxCycle >= 10000)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Count MAC TX idle to MAX  !!!\n"));
	}
	...
	if (MTxCycle >= 10000)
	{
		MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("Count MAC RX idle to MAX  !!!\n"));
	}
...
INT RT6352_ChipInitCalibrations(RTMP_ADAPTER *pAd)
{
	...
	*/				
	...
	MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,("E2PROM: G Tssi[-7 .. +7] = %d %d %d %d %d %d %d - %d - %d %d %d %d %d %d %d, offset=%d, tuning=%d\n",
		pAd->TssiMinusBoundaryG[7], pAd->TssiMinusBoundaryG[6], pAd->TssiMinusBoundaryG[5],
		pAd->TssiMinusBoundaryG[4], pAd->TssiMinusBoundaryG[3], pAd->TssiMinusBoundaryG[2], pAd->TssiMinusBoundaryG[1],
		pAd->TssiRefG,
		pAd->TssiPlusBoundaryG[1], pAd->TssiPlusBoundaryG[2], pAd->TssiPlusBoundaryG[3], pAd->TssiPlusBoundaryG[4],
