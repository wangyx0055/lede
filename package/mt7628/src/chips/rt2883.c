...
/*
	...
	========================================================================
*/
VOID RTMPRT2883ReadTxPwrPerRate(RTMP_ADAPTER *pAd)
{
	/*ULONG		data; */
...
/*
	...
	========================================================================
*/
VOID RTMPRT2883ReadChannelPwr(RTMP_ADAPTER *pAd)
{
	UCHAR				i, choffset;
...
VOID RT2883_Init(RTMP_ADAPTER *pAd)
{
	// TODO:  fix me!!
