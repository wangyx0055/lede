...
/*
    Carter, I didn't add the below defindefinitions. and they are unused.
*/
#endif
#if 0
//+++Add by Carter
#define MT_TBTTInt			WF_MAC_INT_0
#define MT_PreTBTTInt		WF_MAC_INT_1
#define MT_FifoStaFullInt		WF_MAC_INT_2	/*  fifo statistics full interrupt */
#define MT_AutoWakeupInt	WF_MAC_INT_3	/* AutoWakeupInt interrupt */
#define MT_GPTimeOutInt		WF_MAC_INT_4	/* GPtimeout interrupt */
#define MT_INT_MAC_XX		WF_MAC_INT_5
//+++Add by Carter
#endif
